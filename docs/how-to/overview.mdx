...
Welcome to the "How To" section of the SurrealDB documentation! In this section, you will find step-by-step guides and tutorials on how to perform various tasks and achieve specific goals using SurrealDB.
...
If you are new to SurrealDB, we recommend that you start with the [Getting Started](/docs/getting-started) section of the documentation or the [SurrealQL](/docs/surrealql/overview). This section will provide you with a solid foundation of the core concepts and features of SurrealDB.
...
We hope that these "How To" guides will empower you to make the most of SurrealDB and enhance your development workflow. Let's dive in and start exploring the possibilities together!
