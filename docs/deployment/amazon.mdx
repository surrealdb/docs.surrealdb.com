...
## What is Amazon EKS?
[Amazon Elastic Kubernetes Service (Amazon EKS)](https://docs.aws.amazon.com/eks/) is o install, operate, and maintain your own Kubernetes control plane on Amazon Web Services (AWS).
...
- AWS CLI [installed](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) and [configured](https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-configure.html) with your user's credentails
...
![AWS vloume](../../static/img/aws-volumes.png)