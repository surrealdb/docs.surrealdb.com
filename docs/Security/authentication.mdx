...
- [System users](/docs/Security/authentication#system-users): Created by the SurrealDB administrator and used for managing and consuming the database
- [Scope users](/docs/Security/authentication#scope-users): Used for consuming the database, and they allow custom signup, signin and permissions logic
...
Scopes are defined with the [DEFINE SCOPE](/docs/surrealql/statements/define/scope) statement. A scope is configured with the following config:
...
Go to [DEFINE SCOPE](/docs/surrealql/statements/define/scope) for more information.
...
```sql title="Define tables and fields"
