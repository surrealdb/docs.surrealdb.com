...
<tbody>
  <tr>
    <td><a href="/docs/surrealql/functions/search#score"><code>search::score()</code></a></td>
    <td>Returns the relevance score</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/search#highlight"><code>search::highlight()</code></a></td>
    <td>Highlights the matching keywords</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/search#offsets"><code>search::offsets()</code></a></td>
