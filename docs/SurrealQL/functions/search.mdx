...
<tbody>
  <tr>
    <td><a href="/docs/surrealql/functions/search#score">search::score()</a></td>
    <td>Returns the relevance score</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/search#highlight">search::highlight()</a></td>
    <td>Highlights the matching keywords</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/search#offsets">search::offsets()</a></td>
...
<div className='layout-group'>
<div className='heading'>
    <div id="highlight" className='code'>
