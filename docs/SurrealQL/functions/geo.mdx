...
<tbody>
  <tr>
    <td><a href="/docs/surrealql/functions/geo#area"><code>geo::area()</code></a></td>
    <td>Calculates the area of a geometry</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/geo#bearing"><code>geo::bearing()</code></a></td>
    <td>Calculates the bearing between two geolocation points</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/geo#centroid"><code>geo::centroid()</code></a></td>
    <td>Calculates the centroid of a geometry</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/geo#distance"><code>geo::distance()</code></a></td>
    <td>Calculates the distance between two geolocation points</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/geo#hash-decode"><code>geo::hash::decode()</code></a></td>
    <td>Decodes a geohash into a geometry point</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/geo#hash-encode"><code>geo::hash::encode()</code></a></td>
