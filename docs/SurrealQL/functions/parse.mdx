...
<tbody>
  <tr>
    <td><a href="/docs/surrealql/functions/parse#parse-email-host"><code>parse::email::host()</code></a></td>
    <td>Parses and returns an email host from an email address</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/parse#parse-email-user"><code>parse::email::user()</code></a></td>
    <td>Parses and returns an email username from an email address</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/parse#parse-url-domain"><code>parse::url::domain()</code></a></td>
    <td>Parses and returns the domain from a URL</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/parse#parse-url-fragment"><code>parse::url::fragment()</code></a></td>
    <td>Parses and returns the fragment from a URL</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/parse#parse-url-host"><code>parse::url::host()</code></a></td>
    <td>Parses and returns the hostname from a URL</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/parse#parse-url-path"><code>parse::url::path()</code></a></td>
    <td>Parses and returns the path from a URL</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/parse#parse-url-port"><code>parse::url::port()</code></a></td>
    <td>Parses and returns the port number from a URL</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/parse#parse-url-query"><code>parse::url::query()</code></a></td>
