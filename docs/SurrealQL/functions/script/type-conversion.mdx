...
In addition, a number of special classes are included within the JavaScript functions for the additional types which are not built into JavaScript. These enable the creation of [`duration`](/docs/SurrealQL/Data_Model/casting#duration) values, [`record`](/docs/SurrealQL/Data_Model/casting#record) values, and [`UUID`](/docs/SurrealQL/Data_Model/casting#uuid) values from within JavaScript.
