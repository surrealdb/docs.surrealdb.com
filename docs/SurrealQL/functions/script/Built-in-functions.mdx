...
<tbody>
  <tr>
    <td><a href="/docs/surrealql/functions/script/built-in-functions#fetch"><code>async fetch(resource, options)</code></a></td>
  ...
  <tr>
    <td><a href="/docs/surrealql/functions/script/built-in-functions#query"><code>async query(surql)</code></a></td>
    <td>Run SurrealQL subqueries from within the embedded scripting functions.</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/functions/script/built-in-functions#value"><code>async value(variable)</code></a></td>
