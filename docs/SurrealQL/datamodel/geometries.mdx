...
<tbody>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#point">Point</a></td>
    <td>A geolocation point with latitude and longitude</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#line">Line</a></td>
    <td>A GeoJSON LineString value for storing a geometric path</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#polygon">Polygon</a></td>
    <td>A GeoJSON Polygon value for storing a geometric area</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#multipoint">MultiPoint</a></td>
    <td>A value which contains multiple geometry points</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#multiline">MultiLine</a></td>
    <td>A value which contains multiple geometry lines</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#multipolygon">MultiPolygon</a></td>
    <td>A value which contains multiple geometry polygons</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#collection">Collection</a></td>
