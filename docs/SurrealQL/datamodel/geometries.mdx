...
<tbody>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#point"><code>Point</code></a></td>
    <td>A geolocation point with latitude and longitude</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#line"><code>Line</code></a></td>
    <td>A GeoJSON LineString value for storing a geometric path</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#polygon"><code>Polygon</code></a></td>
    <td>A GeoJSON Polygon value for storing a geometric area</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#multipoint"><code>MultiPoint</code></a></td>
    <td>A value which contains multiple geometry points</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#multiline"><code>MultiLine</code></a></td>
    <td>A value which contains multiple geometry lines</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#multipolygon"><code>MultiPolygon</code></a></td>
    <td>A value which contains multiple geometry polygons</td>
  </tr>
  <tr>
    <td><a href="/docs/surrealql/datamodel/geometries#collection"><code>Collection</code></a></td>
