...
import NodeTableData from '../../../src/components/TableData/NodeData/NodeTableData';
import { data } from '../../../src/components/TableData/NodeData/TableData';
