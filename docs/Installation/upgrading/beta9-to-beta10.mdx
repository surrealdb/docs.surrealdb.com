---
sidebar_position: 1
title: Upgrading from v1.0.0-beta.9 to v1.0.0-beta.10
---
...
### 2. Export your data
[Please follow the export docs to run the export](/docs/CLI%20tool/export_command).
...
For more information, check out the [Authentication guide](/docs/security/authentication), and the [`surreal start`](/docs/CLI%20tool/start_command) and [DEFINE USER](/docs/surrealql/statements/define/user) documentation. 
