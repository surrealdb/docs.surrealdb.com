...
Welcome to the SurrealQL section of the SurrealDB documentation! In this section, you will explore SurrealQL, a powerful database query language that closely resembles traditional SQL but comes with unique differences and improvements.
