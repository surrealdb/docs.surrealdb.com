...
stage:
	...
	aws s3 sync --region eu-west-2 --cache-control "public, max-age=31536000, immutable" --exclude '.DS_Store' --exclude '*.webp' ./dist/docs/_astro s3://www.surrealdb.dev/docs/docs/_astro/
	aws s3 sync --region eu-west-2 --cache-control "public, max-age=31536000, immutable" --exclude '.DS_Store' ./dist/docs/static s3://www.surrealdb.dev/docs/static/
	...
	aws s3 cp --region eu-west-2 --cache-control "public, max-age=86400" ./dist/docs/favicon.ico s3://www.surrealdb.dev/docs/
