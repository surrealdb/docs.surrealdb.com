...
deploy:
	@echo "Deploy..."
	aws s3 sync --region eu-west-2 --cache-control "public, max-age=31536000, immutable" --exclude ".DS_Store" ./builds/docs/assets s3://www.surrealdb.com/docs/assets/
...
stage:
	@echo "Stage..."
	aws s3 sync --region eu-west-2 --cache-control "public, max-age=31536000, immutable" --exclude ".DS_Store" ./builds/docs/assets s3://www.surrealdb.dev/docs/assets/
