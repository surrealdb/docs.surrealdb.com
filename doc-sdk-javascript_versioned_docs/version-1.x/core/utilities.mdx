...
// You can also pass additional bindings
await surreal.query(query, {
    some: "binding"
});
```
...
A method allowing you to write a tagged template string, automatically escaping any variables passed. Returns a [`PreparedQuery`](#preparedquery).
