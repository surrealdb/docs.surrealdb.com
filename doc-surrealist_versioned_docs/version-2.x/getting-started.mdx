...
After reading this guide, you can watch the following video which covers some features of Surrealist that can help you get started. This includes organising connections and connection groups, [recordID](/docs/surrealdb/surrealql/datamodel/ids) inspector, [editor shortcuts](/docs/surrealist/advanced-topics/search-and-shortcuts), surrealist search and useful settings. 
<iframe
	width="100%"
