...
This article will guide you through the process of setting up and using Surrealist. At this point we assume you have already installed Surrealist on your system. If you have not done so yet, please refer to the [installation guide](/docs/surrealist/installation).
...
If you are looking to connect to a locally or remote hosted SurrealDB instance, you can create a new connection by pressing the “New connection” button. This will open the connection dialog where you can enter your database details.

<ThemedImage
  alt="Start screen"
  sources={{
    light: useBaseUrl('img/surrealist-start.png'),
    dark: useBaseUrl('img/surrealist-start.png'),
  }}
/>
...
After opening a connection, you can switch to another connection at any time by pressing the connection name in the top left of the interface. This will open the connection list from which you can choose another connection or create a new one.
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('img/surrealist-sidebar.png'),
    dark: useBaseUrl('img/surrealist-sidebar.png'),
  }}
/>
...
* Choose the **Explorer** view, then click the "Load demo dataset" button in the toolbar if you want to explore some real record data and the relations between them.
...
In addition to the different views, you can also find a button to open [Surrealist Search](/docs/surrealist/advanced-topics/search-and-shortcuts), and a button to open the [settings](/docs/surrealist/concepts/settings-and-customisation). Within the settings
