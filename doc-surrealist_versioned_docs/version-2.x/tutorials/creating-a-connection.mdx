...
If you are looking to simply experiment with Surrealist or have not yet set up a database, you can use the [Sandbox environment](#create-a-new-connection-using-a-sandbox). This environment allows you to test and experiment without installing the SurrealDB database or storing data persistently.
