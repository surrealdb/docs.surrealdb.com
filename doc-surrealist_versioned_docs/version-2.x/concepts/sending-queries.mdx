...
- **Live mode**: will display incoming messages received by any [LIVE SELECT](/docs/surrealql/statements/live_select) queries sent in your request. You can also terminate active live queries here as well.
