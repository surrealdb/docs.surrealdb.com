...
There are two primary ways to use Surrealist: as a desktop app or as a web app. While the desktop app offers more features and flexibility, the web app is more accessable and portable.
...
The fastest way to get started with Surrealist is using the web app available at [surrealist.app](http://surrealist.app). No additional installation is required, and you can start using Surrealist right away.
...
:::note
___NOTE:___ Due to security restrictions it will not always be possible to connect to databases hosted locally on localhost (or 127.0.0.1) using the web app in certain browsers.
