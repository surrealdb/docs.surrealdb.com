...
width="100%"
sources={{
    light: useBaseUrl('img/search-and-hot-key.png'),
    dark: useBaseUrl('img/search-and-hot-key.png'),
    }}
/>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td scope="row" data-label="Description">
                See all saved queries, view the query history and create a new query.
            </td>
        </tr>
        <tr>
            <td scope="row" data-label="Type">
