...
- **Live mode** will display incoming messages received by any [LIVE SELECT](/docs/surrealdb/surrealql/statements/live-select/) queries sent in your request. You can also terminate active live queries here as well.
