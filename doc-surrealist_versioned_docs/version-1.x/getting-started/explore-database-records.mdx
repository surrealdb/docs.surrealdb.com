...
<ThemedImage
  ...
  sources={{
    ...
    dark: useBaseUrl('img/surrealist-explorer-view.png'),
  }}
/>
...
:::note
___NOTE:___ In the Designer view section we will explain more in-depth about what constitutes tables as normal or edge tables.
:::
...
Pressing the ▼ button in the top right of this panel expands an input in which you can enter a [WHERE](/docs/surrealdb/surrealql/statements/select/#filter-queries-using-the-where-clause) clause to filter down the displayed records on certain conditions.
