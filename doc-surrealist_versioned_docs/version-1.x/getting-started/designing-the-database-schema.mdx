...
<ThemedImage
  ...
  sources={{
    ...
    dark: useBaseUrl('img/surrealist-designer-view.png'),
  }}
/>
...
The Designer view is built on top of the powerful [INFO FOR DB](/docs/surrealdb/surrealql/statements/info#database-information) and [INFO FOR TABLE](/docs/surrealdb/surrealql/statements/info#table-information) statements, which you can utilize yourself to programatically extract schema information from the database.