...
You can also delete specific records from the recordID `DELETE author:john` with the [DELETE statement](/docs/surrealql/statements/delete) or, you could delete a record with specific conditions:
