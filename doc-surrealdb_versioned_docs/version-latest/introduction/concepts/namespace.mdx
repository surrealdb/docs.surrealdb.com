...
Once a namespace has been defined, the command below you will get a list of all the namespaces in your SurrealDB instance. We are still using the [`INFO`](/docs/surrealdb/surrealql/statements/info) statement, but we are asking for the info for [`ROOT`](/docs/surrealdb/surrealql/statements/info). The output will include the namespace name and a list of namespace users.
...
Lets go ahead and list info about the SurrealDB instance and also about the current namspace from the [`demo dataset`](docs/surrealdb/surrealql/demo).
