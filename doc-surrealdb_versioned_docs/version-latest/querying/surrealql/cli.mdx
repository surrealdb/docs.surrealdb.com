...
To start a SurrealDB server, run the surreal start command, using the options below. This example servers the database at the default location (http://localhost:8000), with a username and password.
