...
Next, create some data to query. You can use the [SurrealQL query editor](/docs/surrealist/concepts/sending-queries) to create some data. For example, you can create a new record in the `person` table.
