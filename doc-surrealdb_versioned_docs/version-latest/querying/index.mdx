...
The easiest way to get started with SurrealQL is to use [Surrealist](https://surrealist.app/). This interactive environment allows you to experiment with SurrealQL statements and see the results immediately. You can either set up a sandbox instance, a remote or local instance.
...
- **Surrealist (Recommended)**: [Surrealist](https://surrealist.app/) is an interactive environment that allows you to experiment with SurrealQL statements and see the results immediately. It is a great tool for learning about the syntax and features of SurrealQL and for developing your queries and scripts.
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('img/light/gql.png'),
    dark: useBaseUrl('img/gql-icon.png'),
  }}
/>
