...
Checks whether both of two values are [truthy](/docs/surrealdb/surrealql/datamodel/values#values-and-truthiness).
...
Checks whether either of two values are [truthy](/docs/surrealdb/surrealql/datamodel/values#values-and-truthiness).
...
Check whether either of two values are [truthy](/docs/surrealdb/surrealql/datamodel/values#values-and-truthiness) and not `NULL`.
...
Check whether either of two values are [truthy](/docs/surrealdb/surrealql/datamodel/values#values-and-truthiness).
