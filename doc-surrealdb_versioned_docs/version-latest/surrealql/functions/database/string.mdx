...
:::note
___NOTE:___ This function was known as `string::endsWith` in versions of SurrrealDB before 2.0. The behaviour has not changed. 
:::
...
:::note
___NOTE:___ This function was known as `string::startsWith` in versions of SurrrealDB before 2.0. The behaviour has not changed. 
:::
