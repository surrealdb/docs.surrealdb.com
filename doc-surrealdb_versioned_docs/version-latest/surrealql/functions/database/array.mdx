...
When called on an array without any extra arguments, the `array::all` function checks whether all array values are [truthy](/docs/surrealdb/surrealql/datamodel/values#values-and-truthiness).
...
The `array::all` function can also be followed with a value or a [closure](/docs/surrealdb/surrealql/datamodel/closures) to check if all elements conform to a condition.
...
The `array::any` function checks whether any array values are [truthy][truthy](/docs/surrealdb/surrealql/datamodel/values#values-and-truthiness).
...
When called on an array without any extra arguments, the `array::any` function checks whether any array values are [truthy](/docs/surrealdb/surrealql/datamodel/values#values-and-truthiness).
...
The `array::any` function can also be followed with a value or a [closure](/docs/surrealdb/surrealql/datamodel/closures) to check if any elements conform to a condition.
...
The `array::filter` function can also take a [closure](/docs/surrealdb/surrealql/datamodel/closures) for more customized filtering.
...
The `array::filter_index` function can also take a [closure](/docs/surrealdb/surrealql/datamodel/closures) for more customized filtering.
...
The `array::find_index` function can also take a [closure](/docs/surrealdb/surrealql/datamodel/closures) for more customized searching.
...
The `array::map` function allows the user to call an [anonymous function](/docs/surrealdb/surrealql/datamodel/closures) (closure) that is performed on every item in the array before passing it on.
...
For a similar function that allows using a closure on entire values instead of each item in an array, see the [chain](/docs/surrealdb/surrealql/functions/database/value#chain) method.
