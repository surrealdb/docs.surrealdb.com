...
The `rand::id` function generates a 20-characters random id.
...
```surql title="A 20-chars random id"
RETURN rand::id();

"4uqmrmtjhtjeg77et0dl"
```
```surql title="A 10-chars random id"
RETURN rand::id(10);

"f3b6cjh0nt"
```
```surql title="A random id with a length between 5 and 15 chars"
RETURN rand::id(5, 15);
