...
<table>
  ...
  <tbody>
    <tr>
      <td scope="row" data-label="Function"><a href="#recordexists"><code>record::id()</code></a></td>
      <td scope="row" data-label="Description">Checks to see if a Record ID exists</td>
    </tr>
    <tr>
