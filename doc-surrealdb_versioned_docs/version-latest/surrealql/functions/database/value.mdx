...
For a similar function that allows using a closure on each item in an array instead of a value as a whole, see [array::map](/docs/surrealdb/surrealql/functions/database/array#arraymap).
