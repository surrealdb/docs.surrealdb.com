...
As of version 2.0, SurrealDB also allows for the creation of anonymous functions that do not need to be defined on the database. See [the page on closures](/docs/surrealdb/surrealql/datamodel/closures) for more details.