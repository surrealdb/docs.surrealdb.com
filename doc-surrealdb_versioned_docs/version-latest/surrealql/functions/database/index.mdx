...
As of version 2.0, SurrealDB also allows for the creation of anonymous functions that do not need to be defined on the database. For more details, see the page on [the LET statement](../surrealql/statements/let#anonymous-functions) which is used to create them.