...
- [You must select your namespace and database](/docs/surrealdb/surrealql/statements/use) before you can use the `DEFINE PARAM` statement.
...
The `OVERWRITE` clause can be used to define a param and overwrite an existing one if it already exists.
