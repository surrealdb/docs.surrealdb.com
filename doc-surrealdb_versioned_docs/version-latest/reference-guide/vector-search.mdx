...
<ThemedImage
  ...
  className="lead screenshot"
  sources={{
    light: useBaseUrl('img/lead.png'),
    dark: useBaseUrl('img/lead.png'),
  }}
/>
...
<ThemedImage
  ...
  className="lead screenshot"
  sources={{
    light: useBaseUrl('img/VC.png'),
    dark: useBaseUrl('img/VC.png'),
  }}
/>
...
<ThemedImage
  ...
  className="lead screenshot"
  sources={{
    light: useBaseUrl('img/light/distance-metrics.png'),
    dark: useBaseUrl('img/distance-metrics.png'),
  }}
/>
...
:::note 
_Note_: You need to be running SurrealDB version 2.0.0 or higher to use the `vector::distance::knn()` function.
:::
