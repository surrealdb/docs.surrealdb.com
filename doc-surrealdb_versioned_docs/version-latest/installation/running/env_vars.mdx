...
These variables can be set instead of using a flag inside a command.
...
<table>
  <thead>
    <tr>
      ...
      <th scope="col">Argument name in command</th>
  ...
  <tbody>
    <tr>
      ...
      <td scope="row" data-label="Details">Authentication lever to use when connecting.</td>
    </tr>
    <tr>
...
Auth arguments: export, import, sql
