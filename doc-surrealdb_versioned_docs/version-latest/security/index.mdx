...
- To learn about the security features that SurrealDB offers, visit the [Summary (Product)](/docs/surrealdb/2.x/security/summary#product) section.
- To learn about the security of the development process of SurrealDB, visit the [Summary (Process)](/docs/surrealdb/2.x/security/summary#process) section.
- To learn the key authentication concepts in SurrealDB with some examples, consult the [Authentication](/docs/surrealdb/2.x/security/authentication) section.
- To tighten or loosen the security of the SurrealDB server, you should consult the [Capabilities](/docs/surrealdb/2.x/security/capabilities) section.
