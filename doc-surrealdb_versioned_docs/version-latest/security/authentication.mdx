...
The values stored in the session parameter can be accessed through [the `session::*` family of functions](https://surrealdb.com/docs/surrealql/functions/database/session).
