...
SurrealDB provides [Vector Functions](/docs/surrealdb/surrealql/functions/vector) for most of the major numerical computations done on vectors. They include functions for element-wise addition, division and even normalisation. 
