...
![A screenshot showing how a string prefix allows incorrect datetime input to be identified before a query can be run. In this case, the parser is able to inform the user that an underscore at column 14 is the issue.](parse_error_2.png)