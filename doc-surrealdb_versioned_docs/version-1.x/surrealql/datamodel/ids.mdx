...
For more on sorting and filtering complex record IDs, see the respective pages for [objects](/docs/surrealdb/surrealql/datamodel/objects) and [arrays](/docs/surrealdb/surrealql/datamodel/arrays).
