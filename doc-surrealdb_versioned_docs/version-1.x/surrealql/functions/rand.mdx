...
The `rand::time` function generates a random [`datetime`](/docs/surrealdb/surrealql/datamodel/time).
...
rand::time() -> datetime
```
The rand::time function generates a random [`datetime`](/docs/surrealdb/surrealql/datamodel/time), between two unix timestamps.
