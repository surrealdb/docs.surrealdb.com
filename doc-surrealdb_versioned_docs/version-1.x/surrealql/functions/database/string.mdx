...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#stringishtml"><code>string::is::html()</code></a><l className='purple'>Since 1.6.0</l></td>
      <td scope="row" data-label="Description">Checks whether a value is valid HTML</td>
    </tr>
    <tr>
...
## `string::is::html` <l className='purple'>Since 1.6.0</l>

The `string::is::html` function checks whether a value is valid HTML.

```surql title="API DEFINITION"
string::is::html(string) -> bool
```
The following example shows this function, and its output, when used in a [`RETURN`](/docs/surrealdb/surrealql/statements/return) statement:

```surql
RETURN string::is::html("<h1>The ultimate multi-model database</h1>");
