...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#stringisip"><code>string::is::ip()</code></a><l className='purple'>Since 1.6.0</l></td>
      <td scope="row" data-label="Description">Checks whether a value is an IP address</td>
    </tr>
    <tr>
      <td scope="row" data-label="Function"><a href="#stringisipv4"><code>string::is::ipv4()</code></a><l className='purple'>Since 1.6.0</l></td>
      <td scope="row" data-label="Description">Checks whether a value is an IP v4 address</td>
    </tr>
    <tr>
      <td scope="row" data-label="Function"><a href="#stringisipv6"><code>string::is::ipv6()</code></a><l className='purple'>Since 1.6.0</l></td>
...
## `string::is::ip` <l className='purple'>Since 1.6.0</l>
...
## `string::is::ipv4` <l className='purple'>Since 1.6.0</l>
...
## `string::is::ipv6` <l className='purple'>Since 1.6.0</l>
