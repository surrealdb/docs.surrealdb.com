...
:::note
_Note:_ You can only provide TYPE, M and EFC. M0 and LM are automatically computed in SurrealDB with the most appropriate value. If not specified, M AND EFC are set to 12 and 150 respectively.
:::
