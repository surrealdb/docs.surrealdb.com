...
Brute Force currently supports [Euclidean](/docs/surrealdb/surrealql/functions/database/vector#vectordistanceeuclidean), [Cosine](/docs/surrealdb/surrealql/functions/vector#vectorsimilaritycosine), [Manhattan](/docs/surrealdb/surrealql/functions/vector#vectordistancemanhattan) and [Minkowski](/docs/surrealdb/surrealql/functions/vector#vectordistanceminkowski) distance functions.
