...
:::note
_Note_: Before using the `RELATE` statement, create the records you want to relate to. You can do this using the [CREATE statement](/docs/surrealdb/surrealql/statements/create). If the records don't exist, an empty array will be returned.
:::
