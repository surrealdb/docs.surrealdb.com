...
Here are some sample queries you can run on the Surreal Deal Store dataset. We've also included a [Surrealist Mini](https://dev.surrealist.app/mini) below to help you run these queries.
