...
:::note
__NOTE:__ Imports have a size limit of 4 GiB per import to prevent the import process from running out of memory and crashing. Please make sure your import file is under this limit.
:::
