...
The documentation for embedding SurrealDB within Node.js has not yet been released. In the meantime, please refer to the [JavaScript](/docs/surrealdb/integration/sdks/javascript) client SDK documentation to get started with connecting to SurrealDB from Node.js.