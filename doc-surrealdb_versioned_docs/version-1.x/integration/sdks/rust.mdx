...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td scope="row" data-label="Function"><a href="#insert"><code>db.insert(resource).content(data)</code></a></td>
            <td scope="row" data-label="Description">Inserts a record or records in a table</td>
        </tr>
        <tr>
