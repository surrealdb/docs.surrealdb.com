...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td scope="row" data-label="Description">Specifies the namespace and/or database for the current connection</td>
        </tr>
        <tr>
...
This method specifies the namespace and/or database for the current connection
