...
```
- The `namespace` value is used for accessing a specific namespace and all databases within that namespace.
...
```
- The `database` value is used for accessing a specific database within a namespace.
