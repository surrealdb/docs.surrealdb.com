...
To implement Full-Text Search it is important that your data is first defined using SurrealDB [tables](/docs/surrealdb/2.x/surrealql/statements/define/table) and [fields](/docs/surrealdb/2.x/surrealql/statements/define/field). 
