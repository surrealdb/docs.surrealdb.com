...
```
You can define a [Full-Text index](/docs/surrealdb/2.x/surrealql/statements/define/indexes#full-text-search-index) on the `content` field and a [custom analyzer](/docs/surrealdb/2.x/surrealql/statements/define/analyzer). 
```surql
