...
# Deploy on Azure Azure Kubernetes Service (AKS)
...
:::note
<em> COST CONSIDERATIONS: </em>
Provisioning the environment in your Azure account will create resources and there will be cost associated with them.
The cleanup section provides a guide to remove them, preventing further charges.
:::
