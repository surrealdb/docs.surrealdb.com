...
To learn more about creating a record user, refer to the [DEFINE ACCESS ... TYPE RECORD](/docs/surrealdb/2.x/surrealql/statements/define/access/record) documentation.
