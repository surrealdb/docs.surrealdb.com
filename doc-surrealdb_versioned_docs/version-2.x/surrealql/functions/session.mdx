...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#sessionsc"><code>session::sc()</code></a></td>
      <td scope="row" data-label="Description">Returns the current user's authentication scope</td>
    </tr>
  </tbody>
</table>
