...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description">encodes a string to HTML.</td>
    </tr>
    <tr>
      <td scope="row" data-label="Function"><a href="#stringhtmlsanitize"><code>string::html::sanitize()</code></a></td>
      <td scope="row" data-label="Description">removes or escapes any potentially harmful or malicious content within the string</td>
    </tr>
    <tr>
...
The `string::html::encode` function encodes a string to HTML.
...
The `string::html::sanitize` function removes or escapes any potentially harmful or malicious content within the string, such as script tags, inline event handlers, or other forms of executable code.

This function is useful in preventing Cross-Site Scripting (XSS) attacks, where an attacker might try to inject malicious scripts into web pages viewed by other users.
