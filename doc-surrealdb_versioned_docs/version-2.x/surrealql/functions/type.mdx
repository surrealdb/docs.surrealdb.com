...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#typeisnil"><code>type::is::nil()</code></a> <l className='purple'>Since 1.5.0</l></td>
      <td scope="row" data-label="Description">Checks if given value is of type none or null</td>
    </tr>
    <tr>
...
This is the equivalent of using [`<bool>`](/docs/surrealdb/2.x/surrealql/datamodel/casting#bool) to cast a value to a boolean.
...
This is the equivalent of using [`<datetime>`](/docs/surrealdb/2.x/surrealql/datamodel/casting#datetime) to cast a value to a datetime.
...
This is the equivalent of using [`<decimal>`](/docs/surrealdb/2.x/surrealql/datamodel/casting#decimal) to cast a value to a datetime.
...
This is the equivalent of using [`<duration>`](/docs/surrealdb/2.x/surrealql/datamodel/casting#duration) to cast a value to a datetime.
...
12345.0
```
This is the equivalent of using [`<float>`](/docs/surrealdb/2.x/surrealql/datamodel/casting#float) to cast a value to a datetime.
...
12345
```
This is the equivalent of using [`<int>`](/docs/surrealdb/2.x/surrealql/datamodel/casting#int) to cast a value to a datetime.
...
12345
```
This is the equivalent of using [`<number>`](/docs/surrealdb/2.x/surrealql/datamodel/casting#number) to cast a value to a datetime.
...
"12345"
```
This is the equivalent of using [`<string>`](/docs/surrealdb/2.x/surrealql/datamodel/casting#string) to cast a value to a datetime.
...
## `type::is::nil` <l className='purple'>Since 1.5.0</l> {#typeisnil}

The `type::is::nil` function checks if the passed value is of type `NONE` or `null`.

```surql title="API DEFINITION"
type::is::nil(any) -> bool
```
The following example shows this function, and its output, when used in a [`RETURN`](/docs/surrealdb/2.x/surrealql/statements/return) statement:

```surql title="Check NONE value"
RETURN type::is::nil(NONE);

true
```

```surql title="Check null value"
...
## `type::is::none` <l className='purple'>Since 1.1.0</l> {#typeisnone}
