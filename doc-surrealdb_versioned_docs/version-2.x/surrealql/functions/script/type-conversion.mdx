...
In addition, a number of special classes are included within the JavaScript functions for the additional types which are not built into JavaScript. These enable the creation of [`duration`](/docs/surrealdb/2.x/surrealql/datamodel/time#durations-and-datetimes) values, [`record`](/docs/surrealdb/2.x/surrealql/datamodel/ids) ids, and [`UUID`](/docs/surrealdb/2.x/surrealql/datamodel/strings#uuid) values from within JavaScript.
