...
The `USER` command returns information for a user [defined](/docs/surrealdb/2.x/surrealql/statements/define/user) on either the root, namespace, or database level.
...
The `SCOPE` command returns information regarding the [tokens defined](/docs/surrealdb/2.x/surrealql/statements/define/token) under a specific [scope](/docs/surrealdb/2.x/surrealql/statements/define/scope).
