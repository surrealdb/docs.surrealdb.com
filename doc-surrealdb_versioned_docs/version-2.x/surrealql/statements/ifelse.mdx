...
:::note
As [THROW](/docs/surrealdb/2.x/surrealql/statements/throw), [CONTINUE](/docs/surrealdb/2.x/surrealql/statements/continue), and [BREAK](/docs/surrealdb/2.x/surrealql/statements/break) do not return an expression, they must be inside a separate code block inside an `IF ELSE` statement.
:::
