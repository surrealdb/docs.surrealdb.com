...
The [INFO](/docs/surrealdb/2.x/surrealql/statements/info) statement can be used to see which definition statements currently exist in a database connection.
