...
:::note
<em>Warning:</em> This statement is deprecated in favor of [`DEFINE ACCESS ... TYPE JWT`](/docs/surrealdb/2.x/surrealql/statements/define/access/jwt) and [`DEFINE ACCESS ... TYPE RECORD ... WITH JWT`](/docs/surrealdb/2.x/surrealql/statements/define/access/record). Learn more in [define access documentation](/docs/surrealdb/2.x/surrealql/statements/define/access).
:::
