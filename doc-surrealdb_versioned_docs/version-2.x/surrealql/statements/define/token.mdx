...
:::note
<em> Warning: </em> This statement is deprecated in favor of `DEFINE ACCESS ... TYPE JWT` and `DEFINE ACCESS ... TYPE RECORD ... WITH JWT`. Learn more [here](/docs/surrealdb/2.x/surrealql/statements/define/access).
:::
...
### JSON Web Key Set (JWKS) <l className='purple'>Since 1.2.0</l>
