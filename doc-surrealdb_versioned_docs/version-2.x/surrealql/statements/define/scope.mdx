...
:::note
<em> Warning: </em> This statement is deprecated in favor of `DEFINE ACCESS ... TYPE RECORD`. Learn more [here](/docs/surrealdb/2.x/surrealql/statements/define/access).
:::
