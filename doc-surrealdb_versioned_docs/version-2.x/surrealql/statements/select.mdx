...
When processing a large result set with many records, it is possible to use the TEMPFILES keyword to specify that the statement should be processed in temporary files rather than memory.
