...
The [string::is::datetime](/docs/surrealdb/surrealql/functions/string#stringisdatetime) and [time::format](/docs/surrealdb/surrealql/functions/time#timeformat) functions in SurrealQL accept certain text formats for date/time formatting. The possible formats are listed below.
