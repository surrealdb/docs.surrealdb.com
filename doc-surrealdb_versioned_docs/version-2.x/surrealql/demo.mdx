...
To quickly test out SurrealDB and SurrealQL functionality, we've included two demo datasets here in `.surql` files which you can download and [`import`](/docs/surrealdb/2.x/cli/import) into SurrealDB using the CLI
...
The dataset is made up of 12 tables using both [graph relations](/docs/surrealdb/2.x/surrealql/statements/relate) and [record links](/docs/surrealdb/2.x/surrealql/datamodel/records).
