# Step-by-Step Guide: Using the Official GitHub Action for SurrealDB
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td scope="row" data-label="Value">
                <a href="https://surrealdb.com/docs/surrealdb/cli/start#" target="_blank" title="Any valid SurrealDB CLI arguments">Any valid SurrealDB CLI arguments</a>
            </td>
        </tr>
    </tbody>
</table>
