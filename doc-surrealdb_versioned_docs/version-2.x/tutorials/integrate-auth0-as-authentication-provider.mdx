...
To learn about other potential uses for the SurrealDB token functionality, you can read the [`DEFINE TOKEN` documentation page](/docs/surrealdb/2.x/surrealql/statements/define/token).
