...
title: Defining a Schema | Tutorials
...
- [A Command line interface (CLI)](/docs/surrealdb/2.x/cli/sql) for interacting with SurrealDB or a [Surrealist sandbox](/docs/surrealist/getting-started#using-the-sandbox).
