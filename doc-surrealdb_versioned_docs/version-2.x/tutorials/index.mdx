...
title: Tutorials| How to guides| Database tutorial
...
If you are new to SurrealDB, we recommend that you start with the [Getting Started](/docs/surrealdb/2.x/introduction/start) section of the documentation or the [SurrealQL](/docs/surrealdb/2.x/surrealql). This section will provide you with a solid foundation of the core concepts and features of SurrealDB.
...
- [Using Github Actions in SurrealDB](/docs/surrealdb/2.x/tutorials/using-github-actions)
