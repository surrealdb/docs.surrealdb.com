...
The above command start SurrealDB with the default authentication and specifies that the user and password are `root` - Note that this is just for demonstration purposes. You can replace it with any other word.
