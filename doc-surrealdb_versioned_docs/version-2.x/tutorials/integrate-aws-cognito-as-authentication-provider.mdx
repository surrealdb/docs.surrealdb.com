...
To understand how revocation is handled by SurrealDB, read the [JSON Web Key Set documentation](/docs/surrealdb/2.x/surrealql/statements/define/token#json-web-key-set-jwks) under `DEFINE TOKEN`.
