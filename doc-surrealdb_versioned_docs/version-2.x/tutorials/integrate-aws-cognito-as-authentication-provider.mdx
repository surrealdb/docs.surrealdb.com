...
To understand how revocation is handled by SurrealDB, read the [JSON Web Key Set documentation](/docs/surrealdb/2.x/surrealql/statements/define/access/jwt#json-web-key-set-jwks) under `DEFINE ACCESS ... TYPE JWT`.
...
DEFINE TABLE user SCHEMAFULL            
  ...
  WHERE
    -- The access method must match the method that we defined.
    $access = "cognito"
