...
:::note
__Note:__ Use the -dev image variant (e.g., surrealdb/surrealdb:latest-dev) for local development. This version includes a shell and package manager, allowing you to install tools and interact with the container's internals.
:::
