...
As MongoDB is schemaless, only the SurrealQL schemaless approach is shown below. For a schemafull option see the [define table](/docs/surrealdb/2.x/surrealql/statements/define/table) page.

For more SurrealQL examples, see the [create](/docs/surrealdb/2.x/surrealql/statements/create) and [insert](/docs/surrealdb/2.x/surrealql/statements/insert) pages.
...
For more SurrealQL examples, see the [select](/docs/surrealdb/2.x/surrealql/statements/select), [live select](/docs/surrealdb/2.x/surrealql/statements/live) and [return](https://surrealdb.com/docs/surrealql/statements/return) pages.
