...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td scope="row" data-label="Description">Signup a user against a record's SIGNUP method</td>
        </tr>
        <tr>
...
This method allows you to signup a user against a record's `SIGNUP` method
