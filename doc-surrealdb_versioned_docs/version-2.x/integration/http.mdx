...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td scope="row" data-label="Description">Signs-up as a record user to a specific record access method</td>
        </tr>
        <tr>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                The record access method to use for sign up. Also pass any variables used in the signup query
            </td>
        </tr>
    </tbody>
</table>
...
Before you sigup a new [record user](/docs/surrealdb/2.x/security/authentication#record-users), you must first [define a record access method](/docs/surrealdb/2.x/surrealql/statements/define/access/record) for the user. To do so, follow these steps:
