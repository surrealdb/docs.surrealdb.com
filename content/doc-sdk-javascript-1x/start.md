...
In the root of your project, create a `utils` folder and create a `surreal.ts` file. This file will contain the SDK initialization logic which manages the connection to the database using the [`connect`](/docs/1.x/sdk/javascript/methods/connect), [`use`](/docs/1.x/sdk/javascript/methods/use), and [`close`](/docs/1.x/sdk/javascript/methods/close) methods.
...
### Create a new user
Create a new `src` folder and add `create-user.ts` file. This file will contain the logic to create a new user in the database. We will use the [`create`](/docs/1.x/sdk/javascript/methods/create) method to make a new user in the database. 
...
In the `src` folder, add `query-user.ts` file. This file will contain the logic to query a user in the database. We will use the [`select`](/docs/1.x/sdk/javascript/methods/select) method to get all users in the database.
...
```
> [!NOTE]
> You can also specify a specific user to query by using the [`RecordId`](/docs/1.x/sdk/javascript/data-types#recordid) datatype. Learn more about the [`select`](/docs/1.x/sdk/javascript/methods/select) method [in the Data Types section](/docs/1.x/sdk/javascript/data-types).


### Update a user

In the `src` folder, add `update-user.ts` file. This file will contain the logic to update a user in the database. We will use the [`update`](/docs/1.x/sdk/javascript/methods/update) method to update a user in the database. 
...
Learn more about the [`RecordId`](/docs/1.x/sdk/javascript/data-types#recordid) datatype [in the Data Types section](/docs/1.x/sdk/javascript/data-types).
...
In the `src` folder, add `delete-user.ts` file. This file will contain the logic to delete a user in the database. We will use the [`delete`](/docs/1.x/sdk/javascript/methods/delete) method to delete the user. 
...
Now that you have learned the basics of the SurrealDB SDK for JavaScript, you can learn more about the SDK and its methods [in the methods section](/docs/1.x/sdk/javascript/methods) and [data types section](/docs/1.x/sdk/javascript/data-types).