...
<div class="flag-title">
	<img src="@assets/img/icon/light/reactjs.png" darkSrc="@assets/img/icon/dark/reactjs.png" alt="React" style="width: 42px; height: 42px" />
	# React
</div>
...
If you are only interested in accessing [SDK methods](/docs/1.x/sdk/javascript/methods), you can use `useSurrealClient()` to directly obtain a reference to the `Surreal` client instance. In the example below, we use the `.query()` method which allows you write raw SurrealQL queries:
...
- Explore the [JavaScript SDK reference](/docs/1.x/sdk/javascript/methods) for a complete list of available methods and features
- See SurrealDB in action by checking out our React example projects in the [examples section](/docs/1.x/sdk/javascript#example-projects)
