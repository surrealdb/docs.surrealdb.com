...
After you create a new Organisation, you will be automatically added as [the owner of the Organisation](/docs/cloud/getting-started/create-an-organisation#manage-organisation-permissions). As an Organisation owner, you can manage your Organisation instances, team, usage and billing information from the overview page. 
...
<img src="@assets/img/image/cloud/create-organisation.png" alt="Surreal Sidekick" />
...
Depending on your permissions, the overview page will show different sections. More information about the different roles and permissions can be found in the [manage Organisation permissions](/docs/cloud/getting-started/create-an-organisation#manage-organisation-permissions) section.

## Invite members to your Organisation

To invite members to your Organisation, click on the **Team** tab and then the **Invite member** button. This will open a modal where you can invite a new member to your Organisation and the role of the member. Learn more about what each role does in the [manage Organisation permissions](/docs/cloud/getting-started/create-an-organisation#manage-organisation-permissions) section.

<img src="@assets/img/image/cloud/invite-member.png" alt="Surreal Sidekick" />
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>Can pause and delete instances</li>
        </ul>
      </td>
    </tr>
    <tr>
