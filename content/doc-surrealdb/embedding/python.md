...
```
 ...
 For complete documentation, installation instructions, examples, best practices, and troubleshooting, see the [Python SDK embedding guide](/docs/sdk/python/embedding).
