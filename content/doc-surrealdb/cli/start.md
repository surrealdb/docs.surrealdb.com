...
For example, to use [Surrealism](/docs/surrealdb/extensions) extensions, set the `SURREAL_CAPS_ALLOW_EXPERIMENTAL` environment variable to `surrealism` - or pass it in via the `--allow-experimental` flag.
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="/docs/surrealql/statements/define/module">DEFINE MODULE</a></td>
