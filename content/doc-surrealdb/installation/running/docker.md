...
<div class="flag-title">
	<img src="@assets/img/icon/light/docker.png" darkSrc="@assets/img/icon/dark/docker.png" alt="Docker" style="width: 42px; height: 42px" />
	# Run with Docker
</div>
...
For details on the `start` command, and all of the available configuration options and arguments, view the [`start command documentation`](/docs/surrealdb/cli/start).
