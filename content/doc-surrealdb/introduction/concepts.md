...
Now that we have the `acme` namespace in the SurrealDB instance we can switch to use that namespace via the [`USE`](/docs/surrealql/statements/use) statement.
