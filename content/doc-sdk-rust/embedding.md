...
title: Embedding SurrealDB | Rust SDK | Integration
...
<div class="flag-title">
	<img src="@assets/img/icon/light/rust.png" darkSrc="@assets/img/icon/dark/rust.png" alt="Rust" style="width: 42px; height: 42px" />
	# Embedding in Rust
</div>
