...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/2.x/sdk/javascript/api/core/surreal-queryable#live"> <code> db.live(table, callback, diff) </code></a></td>
			<td scope="row" data-label="Description">Initiates a live query</td>
		</tr>
        <tr>
            <td scope="row" data-label="Method"><a href="/docs/2.x/sdk/javascript/api/core/surreal-queryable#liveof"> <code> db.liveOf(queryUuid) </code></a></td>
            <td scope="row" data-label="Description">Subscribes to notifications for an existing live query</td>
        </tr>
        <tr>
            <td scope="row" data-label="Method"><a href="/docs/2.x/sdk/javascript/api/queries/live-promise#kill"> <code> subscription.kill() </code></a></td>
			<td scope="row" data-label="Description">Kills a running live query subscription</td>
		</tr>
	</tbody>
</table>
...
For `CREATE`, `UPDATE` and `DELETE`, the type `Result` is the generic argument passed to [`.live()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#live) or [`.liveOf()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#liveof). <br />
