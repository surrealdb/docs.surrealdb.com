...
The `SurrealQueryable` class is an abstract base class that provides all query execution methods for interacting with SurrealDB. It is the foundation for executing database operations and is extended by [`SurrealSession`](/docs/2.x/sdk/javascript/api/core/surreal-session) and [`SurrealTransaction`](/docs/2.x/sdk/javascript/api/core/surreal-transaction).

**Extended by:** [`SurrealSession`](/docs/2.x/sdk/javascript/api/core/surreal-session), [`SurrealTransaction`](/docs/2.x/sdk/javascript/api/core/surreal-transaction)
...
Access user-defined API endpoints. This property returns a [`SurrealApi`](/docs/2.x/sdk/javascript/api/core/surreal-api) instance for invoking custom database APIs.

You can provide type definitions for type-safe API calls.

**Type:** [`SurrealApi<TPaths>`](/docs/2.x/sdk/javascript/api/core/surreal-api)
...
#### Returns
[`Query<R>`](/docs/2.x/sdk/javascript/api/queries/query) - A query instance that can be configured and executed
...
#### Returns
[`SelectPromise<T>`](/docs/2.x/sdk/javascript/api/queries/select-promise) - A promise with chainable configuration methods
...
#### Returns
[`CreatePromise<T>`](/docs/2.x/sdk/javascript/api/queries/create-promise) - A promise with chainable configuration methods
...
#### Returns
[`InsertPromise<T>`](/docs/2.x/sdk/javascript/api/queries/insert-promise) - A promise with chainable configuration methods
...
#### Returns
[`UpdatePromise<T>`](/docs/2.x/sdk/javascript/api/queries/update-promise) - A promise with chainable configuration methods
...
#### Returns
[`UpsertPromise<T>`](/docs/2.x/sdk/javascript/api/queries/upsert-promise) - A promise with chainable configuration methods
...
#### Returns
[`DeletePromise<T>`](/docs/2.x/sdk/javascript/api/queries/delete-promise) - A promise with chainable configuration methods
...
#### Returns
[`RelatePromise<T>`](/docs/2.x/sdk/javascript/api/queries/relate-promise) - A promise for the relationship operation
...
#### Returns
[`ManagedLivePromise<T>`](/docs/2.x/sdk/javascript/api/queries/live-promise) - A managed live query subscription
...
#### Returns
[`UnmanagedLivePromise`](/docs/2.x/sdk/javascript/api/queries/live-promise) - An unmanaged live query subscription
...
#### Returns
[`RunPromise<T>`](/docs/2.x/sdk/javascript/api/queries/run-promise) - A promise for the function result
...
- [SurrealSession](/docs/2.x/sdk/javascript/api/core/surreal-session) - Session management extending this class
- [SurrealTransaction](/docs/2.x/sdk/javascript/api/core/surreal-transaction) - Transaction support extending this class
- [Query Builders](/docs/2.x/sdk/javascript/api/queries/) - Detailed query builder documentation
- [SelectPromise](/docs/2.x/sdk/javascript/api/queries/select-promise) - SELECT query configuration
- [CreatePromise](/docs/2.x/sdk/javascript/api/queries/create-promise) - CREATE query configuration
