...
**Returned by:** [`SurrealQueryable.live()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#live)
...
**Returned by:** [`SurrealQueryable.liveOf()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#liveof)
...
Each update message conforms to the [`LiveMessage<T>`](/docs/2.x/sdk/javascript/api/types/#livemessage) interface with `action`, `result`, and optional `diff` properties.
...
- [SurrealQueryable.live()](/docs/2.x/sdk/javascript/api/core/surreal-queryable#live) - Create managed live subscription
- [SurrealQueryable.liveOf()](/docs/2.x/sdk/javascript/api/core/surreal-queryable#liveof) - Subscribe to existing live query
