...
> [!NOTE: Tip]
> For conditional deletions, use [`db.query()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#query) with a DELETE statement including a WHERE clause.
...
- [SurrealQueryable.delete()](/docs/2.x/sdk/javascript/api/core/surreal-queryable#delete) - Method that returns DeletePromise
- [UpdatePromise](/docs/2.x/sdk/javascript/api/queries/update-promise) - Update records
- [Query](/docs/2.x/sdk/javascript/api/queries/query) - Raw SurrealQL for conditional deletes
