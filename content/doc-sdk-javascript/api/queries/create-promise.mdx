...
- [SurrealQueryable.create()](/docs/2.x/sdk/javascript/api/core/surreal-queryable#create) - Method that returns CreatePromise
- [InsertPromise](/docs/2.x/sdk/javascript/api/queries/insert-promise) - Bulk insertion
- [UpsertPromise](/docs/2.x/sdk/javascript/api/queries/upsert-promise) - Insert or replace
