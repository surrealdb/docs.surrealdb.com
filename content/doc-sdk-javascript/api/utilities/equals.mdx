...
- [RecordId.equals()](/docs/2.x/sdk/javascript/api/values/record-id#equals) - RecordId-specific comparison
- [DateTime.equals()](/docs/2.x/sdk/javascript/api/values/datetime#equals) - DateTime-specific comparison
