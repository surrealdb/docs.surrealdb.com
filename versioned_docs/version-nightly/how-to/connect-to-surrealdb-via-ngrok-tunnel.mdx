...
- You have [SurrealDB installed](/docs/nightly/installation/overview) and a [fresh instance of SurrealDB running.](/docs/nightly/introduction/start)
...
With the help of the `CREATE` statement, [create a new record](/docs/nightly/surrealql/statements/create). 
