...
- You have a [fresh instance of SurrealDB running](/docs/nightly/introduction/start) with version `1.2.0` or later.

- You can [use a local Docker container](/docs/nightly/installation/running/docker) without volumes for the purposes of this guide.
...
To understand how revocation is handled by SurrealDB, read the [JSON Web Key Set documentation](/docs/nightly/surrealql/statements/define/token#json-web-key-set-jwks) under `DEFINE TOKEN`.
