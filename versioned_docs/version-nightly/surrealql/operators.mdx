...
<tbody>
  ...
  <tr>
    ...
    <td>Checks whether the two operands are within a given distance from each other for a given distance measure. Defaults to euclidean when no distance measure is specified.</td>
  </tr>
</tbody>
</table>
