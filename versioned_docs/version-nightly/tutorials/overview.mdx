...
If you are new to SurrealDB, we recommend that you start with the [Getting Started](/docs/nightly/introduction/start) section of the documentation or the [SurrealQL](/docs/surrealql/overview). This section will provide you with a solid foundation of the core concepts and features of SurrealDB.
...
-  [ Working with SurrealDB over HTTP via Postman](/docs/nightly/tutorials/working-with-surrealdb-over-http-via-postman)