...
If you are new to SurrealDB, we recommend that you start with the [Getting Started](/docs/surrealdb/nightly/introduction/start) section of the documentation or the [SurrealQL](/docs/surrealdb/nightly/surrealql/overview).
...
-  [Full-Text Search](/docs/surrealdb/nightly/reference-guide/full-text-search)