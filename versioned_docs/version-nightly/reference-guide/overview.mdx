...
If you are new to SurrealDB, we recommend that you start with the [Getting Started](/docs/nightly/introduction/start) section of the documentation or the [SurrealQL](/docs/nightly/surrealql/overview).
...
-  [Full-Text Search](/docs/nightly/reference-guide/full-text-search)