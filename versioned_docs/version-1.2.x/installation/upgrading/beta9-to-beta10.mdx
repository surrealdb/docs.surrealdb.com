...
### 2. Export your data
[Please follow the export docs to run the export]/docs/1.2.x/cli/export).
...
This is further documented in the [Capabilities]/docs/1.2.x/security/capabilities) documentation.
...
For more information, check out the [Authentication guide]/docs/1.2.x/security/authentication), and the [`surreal start`]/docs/1.2.x/cli/start) and [DEFINE USER]/docs/1.2.x/surrealql/statements/define/user) documentation. 
