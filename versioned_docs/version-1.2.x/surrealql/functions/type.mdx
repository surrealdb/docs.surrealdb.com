...
This is the equivalent of using [`<bool>`]/docs/1.2.x/surrealql/datamodel/casting#bool) to cast a value to a boolean.
...
This is the equivalent of using [`<datetime>`]/docs/1.2.x/surrealql/datamodel/casting#datetime) to cast a value to a datetime.
...
This is the equivalent of using [`<decimal>`]/docs/1.2.x/surrealql/datamodel/casting#decimal) to cast a value to a datetime.
...
This is the equivalent of using [`<duration>`]/docs/1.2.x/surrealql/datamodel/casting#duration) to cast a value to a datetime.
...
12345.0
```
This is the equivalent of using [`<float>`]/docs/1.2.x/surrealql/datamodel/casting#float) to cast a value to a datetime.
...
12345
```
This is the equivalent of using [`<int>`]/docs/1.2.x/surrealql/datamodel/casting#int) to cast a value to a datetime.
...
12345
```
This is the equivalent of using [`<number>`]/docs/1.2.x/surrealql/datamodel/casting#number) to cast a value to a datetime.
...
"12345"
```
This is the equivalent of using [`<string>`]/docs/1.2.x/surrealql/datamodel/casting#string) to cast a value to a datetime.
