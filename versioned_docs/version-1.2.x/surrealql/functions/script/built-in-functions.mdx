...
Besides basic JavaScript utilities and [classes for SurrealQL types](/docs/1.2.x/surrealql/functions/script/type-conversion), there are a handful of utilities built into the embedded scripting functions.
