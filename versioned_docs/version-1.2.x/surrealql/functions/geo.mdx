...
0.13350018278702186
```
If the argument is not a geometry type, then an [`EMPTY`](/docs/1.2.x/surrealql/datamodel/simple) value will be returned:
...
-31.913259585079818
```
If either argument is not a geolocation point, then an [`EMPTY`](/docs/1.2.x/surrealql/datamodel/simple) value will be returned:
...
```
If either argument is not a geometry type, then an [`EMPTY`](/docs/1.2.x/surrealql/datamodel/simple) value will be returned:
...
```
If the argument is not a geolocation point, then an [`EMPTY`](/docs/1.2.x/surrealql/datamodel/simple) value will be returned:
...
"mpuxk"
```
If the first argument is not a geolocation point, then an [`EMPTY`](/docs/1.2.x/surrealql/datamodel/simple) value will be returned:
