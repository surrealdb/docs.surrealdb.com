...
Edge tables behave like normal tables in terms of [updating]/docs/1.2.x/surrealql/statements/update), [defining a schema]/docs/1.2.x/surrealql/statements/define/table) or [indexes]/docs/1.2.x/surrealql/statements/define/indexes).

[Record link]/docs/1.2.x/surrealql/datamodel/records) are the alternative option when connecting data.
...
By default, the edge table gets created as a schemaless table when you execute the `RELATE` statement. You can however make the table schemafull by either [defining a schema]/docs/1.2.x/surrealql/statements/define/table) before or after executing the RELATE statement.

A common use case is to make sure only unique relationships get created. You can do that by [defining an index]/docs/1.2.x/surrealql/statements/define/indexes).
...
Let's look at how the above gets queried, for more examples see the [SELECT docs]/docs/1.2.x/surrealql/statements/select).
...
## Using [`LET`]/docs/1.2.x/surrealql/statements/let) parameters in RELATE statements

You can also use [parameters]/docs/1.2.x/surrealql/parameters) to specify the record IDs.
...
## Using [`RETURN`]/docs/1.2.x/surrealql/statements/return) clause
