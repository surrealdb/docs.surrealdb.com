...
<table>
    ...
    <tbody>
        <tr>
            <td scope="col" scope="row" data-label="Arguments">
                <code>endpoint</code>
                <l className='yellow'>REQUIRED</l>
            </td>
            <td scope="col" scope="row" data-label="Description">
...
<table>
    ...
    <tbody>
        <tr>
            <td scope="col" scope="row" data-label="Properties">
                <code>cancellationToken</code>
                <l className='grey'>OPTIONAL</l>
            </td>
            <td scope="col" scope="row" data-label="Description">
...
<table>
    ...
    <tbody>
        <tr>
            <td scope="col" scope="row" data-label="Keys">
                <code>Endpoint</code>
                <l className='yellow'>REQUIRED</l>
            </td>
            <td scope="col" scope="row" data-label="Description">
            ...
            <td scope="col" scope="row" data-label="Aliases">
                <code>Server</code>
            </td>
        </tr>
        <tr>
