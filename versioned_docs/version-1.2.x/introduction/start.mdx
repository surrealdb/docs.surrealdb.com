...
You can also delete specific records `DELETE author:david` using the [DELETE statement](/docs/surrealdb/surrealql/statements/delete). You could also delete a record with specific conditions:
```surql
