...
### Create
As MongoDB is schemaless, only the SurrealQL schemaless approach is shown below. For a schemafull option see the [define table](/docs/1.2.x/surrealql/statements/define/table) page.

For more SurrealQL examples, see the [create](/docs/1.2.x/surrealql/statements/create) and [insert](/docs/1.2.x/surrealql/statements/insert) pages.
