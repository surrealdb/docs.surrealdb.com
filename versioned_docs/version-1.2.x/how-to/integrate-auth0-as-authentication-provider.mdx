...
- You have a [fresh instance of SurrealDB running.](/docs/1.2.x/introduction/start)
...
To learn about other potential uses for the SurrealDB token functionality, you can read the [`DEFINE TOKEN` documentation page](/docs/1.2.x/surrealql/statements/define/token).
