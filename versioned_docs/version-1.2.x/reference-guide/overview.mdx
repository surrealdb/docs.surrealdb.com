...
If you are new to SurrealDB, we recommend that you start with the [Getting Started](/docs/1.2.x/introduction/start) section of the documentation or the [SurrealQL](/docs/1.2.x/surrealql/overview).
...
-  [Full-Text Search](/docs/1.2.x/1.2.x/reference-guide/full-text-search)