...
## Functions
SurrealDB offers [built-in functions]/docs/1.2.x/surrealql/functions/array) to perform common operations like string manipulation, math, etc. Users can also define [their own functions]/docs/1.2.x/surrealql/statements/define/function) with custom logic.
