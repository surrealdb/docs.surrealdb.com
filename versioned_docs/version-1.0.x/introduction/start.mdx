...
__BEFORE YOU START :__ Make sure you’ve [installed SurrealDB](/docs/surrealdb/1.0.x/installation/overview/) — it should only take a second!
...
You can also delete specific records `DELETE author:david` using the [DELETE statement](/docs/surrealdb/1.0.x/surrealql/statements/delete). You could also delete a record with specific conditions:
```surql
