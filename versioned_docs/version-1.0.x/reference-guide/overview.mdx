...
If you are new to SurrealDB, we recommend that you start with the [Getting Started](/docs/surrealdb/1.0.x/introduction/start) section of the documentation or the [SurrealQL](/docs/surrealdb/1.0.x/surrealql/overview).
...
-  [Full-Text Search](/docs/surrealdb/1.0.x/reference-guide/full-text-search)