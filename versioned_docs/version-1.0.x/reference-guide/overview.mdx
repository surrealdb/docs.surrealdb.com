...
If you are new to SurrealDB, we recommend that you start with the [Getting Started](/docs/introduction/start) section of the documentation or the [SurrealQL](/docs/surrealql/overview).
