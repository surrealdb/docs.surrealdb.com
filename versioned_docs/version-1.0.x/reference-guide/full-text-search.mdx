...
Your text field won't be "full text searchable" unless you define a [full-text index](https://docs.surrealdb.com/docs/1.0.x/surrealql/statements/define/indexes/) using the search keyword.
