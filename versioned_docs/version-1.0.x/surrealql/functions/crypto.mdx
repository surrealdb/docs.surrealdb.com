...
:::note
  <em>Note:</em> At this moment there is no way to customize the parameters for this function. This applies to: memory, iterations and parallelism.
:::
...
:::note
  <em>Note:</em> At this moment there is no way to customize the work factor for bcrypt.
:::
...
:::note
  <em>Note:</em> At this moment there is no way to customize the number of iterations for pbkdf2.
:::
...
:::note
  <em>Note:</em> At this moment there is no way to customize the parameters for this function. This applies to: cost parameter, block size and parallelism.
:::
