...
The `UPDATE` statement can be used to update or modify records in the database.However, it can not be used to create graph relationships. For that, use the [`RELATE`](/docs/1.0.x/surrealql/statements/relate) statement.
