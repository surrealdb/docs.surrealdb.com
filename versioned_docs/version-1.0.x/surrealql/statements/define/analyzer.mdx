...
Examples on application of analyzers to indexes can be found in the documenation on [`DEFINE INDEX`](/docs/1.0.x/surrealql/statements/define/indexes) statement
