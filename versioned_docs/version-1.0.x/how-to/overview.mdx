...
-  [Integrate Auth0 as an Authentication provider](/docs/1.0.x/how-to/integrate-auth0-as-authentication-provider)
-  [Integrate AWS Cognito as an Authentication Provider](/docs/1.0.x/how-to/integrate-aws-cognito-as-authentication-provider)
-  [Connect to SurrealDB via Ngrok](/docs/1.0.x/how-to/connect-to-surrealdb-via-ngrok-tunnel)