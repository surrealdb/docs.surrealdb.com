...
The documentation for embedding SurrealDB within Python has not yet been released. In the meantime, please refer to the [Python client SDK](/docs/surrealdb/1.x/integration/sdks/python) documentation to get started with connecting to SurrealDB from Python.