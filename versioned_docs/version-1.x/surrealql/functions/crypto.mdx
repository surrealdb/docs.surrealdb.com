...
:::note
  ___NOTE:___ At this time, there is no way to customize the parameters for this function. This applies to: memory, iterations and parallelism.
:::
...
:::note
  ___NOTE:___ At this time, there is no way to customize the work factor for bcrypt.
:::
...
:::note
  ___NOTE:___ At this time, there is no way to customize the number of iterations for pbkdf2.
:::
...
:::note
  ___NOTE:___ At this time, there is no way to customize the parameters for this function. This applies to: cost parameter, block size and parallelism.
:::
