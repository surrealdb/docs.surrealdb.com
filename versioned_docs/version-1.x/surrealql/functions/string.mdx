...
```
The following example shows this function, and its output, when used in a [`RETURN`](/docs/surrealdb/1.x/surrealql/statements/return) statement:
...
true
```
[View all format options](/docs/surrealdb/1.x/surrealql/datamodel/formatters)
