...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <tr>
    <td scope="row" data-label="Operator"><a href="#knn-knn-since-130"><code> &lt;|4|&gt; </code> or <code>&lt;|3,HAMMING| &gt;</code></a> <l className='purple'>Since 1.3.0</l></td>
...
## `#KNN` {#KNN} <l className='purple'>Since 1.3.0</l>
