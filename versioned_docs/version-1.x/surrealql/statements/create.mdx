...
:::note
__Note:__ This statement can not be used to create graph relationships. For that, use the [`RELATE`](/docs/surrealdb/1.x/surrealql/statements/relate) statement.
:::
...
:::note
__Note:__ You can also assign the recordID to be [randomly generated](/docs/surrealdb/1.x/surrealql/datamodel/ids#generating-record-ids) 
:::
...
It is also possible to specify the ID of the record you want to create using a string or any of the supported formats for [record IDs](/docs/surrealdb/1.x/surrealql/datamodel/ids).
...
- [Getting started guide](/docs/surrealdb/1.x/introduction/start)
- [Select statement](/docs/surrealdb/1.x/surrealql/statements/select)
- [Update statement](/docs/surrealdb/1.x/surrealql/statements/update)
- [Insert statement](/docs/surrealdb/1.x/surrealql/statements/insert)
- [Delete statement](/docs/surrealdb/1.x/surrealql/statements/delete)
- [Relate statement](/docs/surrealdb/1.x/surrealql/statements/relate)
