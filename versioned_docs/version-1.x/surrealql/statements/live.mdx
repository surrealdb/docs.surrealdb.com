...
You can also use this UUID to [KILL (stop)](/docs/surrealdb/1.x/surrealql/statements/kill) the Live Query.

The protocol will then send messages that are of a Notification format.
You can find an example of such a message in the [Live Query WebSocket protocol](/docs/surrealdb/1.x/integration/websocket#live) description.
