...
:::note
__Note:__This statement can not be used to create graph relationships. For that, use the [`RELATE`](/docs/surrealdb/1.x/surrealql/statements/relate) statement.
:::
