...
In the example below, the query searches for points closest to the vector [2,3,4,5] and uses the [vector functions](/docs/surrealdb/surrealql/functions/vector) to calculate the distance between the two points. 

Mtree currently supports [Euclidean](/docs/surrealdb/surrealql/functions/vector#vectordistanceeuclidean), [Cosine](/docs/surrealdb/surrealql/functions/vector#vectorsimilaritycosine), [Manhattan](/docs/surrealdb/surrealql/functions/vector#vectordistancemanhattan) and [Minkowski](/docs/surrealdb/surrealql/functions/vector#vectordistanceminkowski) distance functions.  By default, When no vector function is specified, it chooses Euclidean for the distance function. 
