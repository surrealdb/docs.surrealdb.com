...
- You have a [fresh instance of SurrealDB running.](/docs/surrealdb/1.x/introduction/start)
...
To learn about other potential uses for the SurrealDB token functionality, you can read the [`DEFINE TOKEN` documentation page](/docs/surrealdb/1.x/surrealql/statements/define/token).
