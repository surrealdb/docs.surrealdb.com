...
As MongoDB is schemaless, only the SurrealQL schemaless approach is shown below. For a schemafull option see the [define table](/docs/surrealdb/1.x/surrealql/statements/define/table) page.
