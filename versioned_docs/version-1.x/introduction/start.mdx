...
surreal version
```
To start your database, run the start command specific to your machine. The current stable version of SurrealDB is <Version />
...
Using SurrealQL, you can query data from your SurrealDB database. While this is not a requirement for getting started, it is helpful to familiarise yourself with some commands.There are a few different ways to use SurrealQL, including using the Surrealist or using the SurrealDB CLI.
