...
- [`namespace`](/docs/surrealdb/1.x/surrealql/statements/define/namespace)
- [`databases`](/docs/surrealdb/1.x/surrealql/statements/define/database)
- [`table`](/docs/surrealdb/1.x/surrealql/statements/define/table)
- [`fields`](/docs/surrealdb/1.x/surrealql/statements/define/field)

You cannot define [`records`](/docs/surrealdb/1.x/surrealql/datamodel/ids), you can only [create](/docs/surrealdb/1.x/surrealql/statements/create), read, [update](/docs/surrealdb/1.x/surrealql/statements/update) and [delete](/docs/surrealdb/1.x/surrealql/statements/delete) them.
