...
### 2. Export your data
[Please follow the export docs to run the export](/docs/surrealdb/1.1.x/cli/export).
...
This is further documented in the [Capabilities](/docs/surrealdb/1.1.x/security/capabilities) documentation.
...
For more information, check out the [Authentication guide](/docs/surrealdb/1.1.x/security/authentication), and the [`surreal start`](/docs/surrealdb/1.1.x/cli/start) and [DEFINE USER](/docs/surrealdb/1.1.x/surrealql/statements/define/user) documentation. 
