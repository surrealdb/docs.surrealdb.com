...
The previous command will bootstrap the server with the provided initial credentials, you can now remove those args and rely on [DEFINE USER](/docs/1.1.x/surrealql/statements/define/user) to change the password or create more users.
