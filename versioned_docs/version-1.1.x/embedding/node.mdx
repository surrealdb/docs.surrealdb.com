...
The documentation for embedding SurrealDB within Node.js has not yet been released. In the meantime, please refer to the [Node.js](/docs/integration/sdks/nodejs) client SDK documentation to get started with connecting to SurrealDB from Node.js.