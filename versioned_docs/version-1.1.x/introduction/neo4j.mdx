...
### Create
As Neo4j is schemafull, only the SurrealQL schemafull approach is shown below. For a schemafull option see the [define table](/docs/surrealdb/1.1.x/surrealql/statements/define/table) page.

For more SurrealQL examples, see the [create](/docs/surrealdb/1.1.x/surrealql/statements/create), [insert](/docs/surrealdb/1.1.x/surrealql/statements/insert) and [relate](/docs/surrealdb/1.1.x/surrealql/statements/relate) pages.
