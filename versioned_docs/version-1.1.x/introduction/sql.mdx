...
### Create
As relational databases are schemafull, only the SurrealQL schemafull approach is shown below. For a schemafull option see the [define table](/docs/surrealdb/1.1.x/surrealql/statements/define/table) page.
...
### Read
For more SurrealQL examples, see the [select](/docs/surrealdb/1.1.x/surrealql/statements/select), [live select](/docs/surrealdb/1.1.x/surrealql/statements/live-select) and [return](/docs/surrealdb/1.1.x/surrealql/statements/return) pages.
