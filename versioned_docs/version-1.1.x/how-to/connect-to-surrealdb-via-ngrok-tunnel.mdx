...
1. **Start SurrealDB Instance**
    ...
    Open your command line or terminal and run the following command to [start SurrealDB](/docs.surrealdb.com/docs/introduction/start/).
...
4. **Verify the Connection**
    ...
    And let's [query the data](/docs.surrealdb.com/docs/surrealql/statements/select) from the record now. 
