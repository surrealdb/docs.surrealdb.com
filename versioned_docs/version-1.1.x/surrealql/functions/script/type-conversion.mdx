...
In addition, a number of special classes are included within the JavaScript functions for the additional types which are not built into JavaScript. These enable the creation of [`duration`](/docs/surrealdb/1.1.x/surrealql/datamodel/casting#duration) values, [`record`](/docs/surrealdb/1.1.x/surrealql/datamodel/casting#record) values, and [`UUID`](/docs/surrealdb/1.1.x/surrealql/datamodel/casting#uuid) values from within JavaScript.
