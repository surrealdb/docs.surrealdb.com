...
Indexes can also impact the performance of write operations ([INSERT](docs/1.1.x/surrealql/statements/insert/), [UPDATE](/docs/surrealql/statements/update), [DELETE](/docs/surrealql/statements/delete)) since the index needs to be updated accordingly. Therefore, it's essential to balance the need for read performance with write performance.