...
The created index can be tested using the `INFO` query.
```surql

INFO FOR TABLE user;
```
The [INFO query](/docs/surrealql/statements/info/) will help you understand what indexes are defined in your `TABLE`.
