...
- [You must select your namespace and/or database](/docs/surrealdb/1.1.x/surrealql/statements/use) before you can use the `DEFINE DATABASE` statement for database or namespace tokens.
