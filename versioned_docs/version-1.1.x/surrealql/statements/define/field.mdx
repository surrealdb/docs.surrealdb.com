...
- [You must select your namespace and database](/docs/surrealdb/1.1.x/surrealql/statements/use) before you can use the `DEFINE FIELD` statement.
...
The `DEFINE FIELD` statement allows you to set the data type of a field. For a full list of supported data types, see [Data types](/docs/surrealdb/1.1.x/surrealql/datamodel/overview).
