...
- [You must select your namespace and database](/docs/1.1.x/surrealql/statements/use) before you can use the `DEFINE ANALYZER` statement.
...
For example, if you had the text **"helloWorld"**, the blank tokenizer would create two tokens, **["hello", "World"]**. Below is an example of how to use the camel tokenizer:
...
For example, if you had the text **"123abc!XYZ"**, the blank tokenizer would create two tokens, **["123", "abc", "!", "XYZ"]**. Below is an example of how to use the class tokenizer:
...
For example, if you had the text **"Hello, World!"**, the blank tokenizer would create two tokens, **["Hello", ",", "World", "!"]**. Below is an example of how to use the punct tokenizer:
...
Examples on application of analyzers to indexes can be found in the documenation on [`DEFINE INDEX`](/docs/1.1.x/surrealql/statements/define/indexes) statement
