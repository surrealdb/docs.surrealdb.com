...
- [You must select your namespace and database](/docs/surrealdb/1.1.x/surrealql/statements/use) before you can use the `DEFINE ANALYZER` statement.
...
Examples on application of analyzers to indexes can be found in the documenation on [`DEFINE INDEX`](/docs/surrealdb/1.1.x/surrealql/statements/define/indexes) statement
