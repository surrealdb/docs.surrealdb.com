...
For example, if you had the text **"123abc!XYZ"**, the class tokenizer would create two tokens, **["123", "abc", "!", "XYZ"]**. Below is an example of how to use the class tokenizer:
...
This example creates an analyzer that tokenizes text based on the class of characters and then applies the lowercase ascii and  filter to the tokens.
