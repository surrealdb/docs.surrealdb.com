...
- To select the level where you want to create the user, [you may need to select a namespace and/or database](/docs/1.1.x/surrealql/statements/use) before you can use the `DEFINE USER` statement for database or namespace tokens.
