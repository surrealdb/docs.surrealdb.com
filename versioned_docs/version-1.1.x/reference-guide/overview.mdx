...
If you are new to SurrealDB, we recommend that you start with the [Getting Started](/docs/surrealdb/1.1.x/introduction/start) section of the documentation or the [SurrealQL](/docs/surrealdb/1.1.x/surrealql/overview).
...
-  [Full-Text Search](/docs/surrealdb/1.1.x/reference-guide/full-text-search)