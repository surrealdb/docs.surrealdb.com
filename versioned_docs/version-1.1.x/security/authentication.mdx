...
- [System users](/docs/1.1.x/security/authentication#system-users): Created by the SurrealDB administrator and used for managing and consuming the database
- [Scope users](/docs/1.1.x/security/authentication#scope-users): Used for consuming the database, and they allow custom signup, signin and permissions logic
...
Users may belong to different levels (root, namespace or database) and have different roles assigned to limit what they can do to the system. Users are defined with the [DEFINE USER](/docs/1.1.x/surrealql/statements/define/user) statement.
...
Go to [DEFINE USER](/docs/1.1.x/surrealql/statements/define/user) for more information.
...
Scopes are defined with the [DEFINE SCOPE](/docs/1.1.x/surrealql/statements/define/scope) statement. A scope is configured with the following config:
...
Go to [DEFINE SCOPE](/docs/1.1.x/surrealql/statements/define/scope) for more information.
