...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td scope="row" data-label="Description">Runs a set of [SurrealQL statements](/docs/surrealdb/surrealql) against the database</td>
        </tr>
        <tr>
...
<table>
    ...
    <tbody>
		...
		<tr>
            <td scope="row" data-label="Function"><a href="/docs/sdk/php/core/methods/invalidate"> <code>$db->invalidate()</code></a></td>
            <td scope="row" data-label="Description">Invalidates the authentication for the current connection</td>
        </tr>
        <tr>
            <td scope="row" data-label="Function"><a href="/docs/sdk/php/core/methods/authenticate"> <code>$db->authenticate(token)</code></a></td>
