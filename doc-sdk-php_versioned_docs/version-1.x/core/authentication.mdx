...
<Tabs groupId="php-signin">
  <TabItem value="root" label="Root" default>
	...
	<TabItem value="scope" label="Scope">
		Authenticate using a specific [Scope](/docs/surrealdb/surrealql/statements/define/scope) within a database.
		```php
		$token = $db->signin([
			"email" => "user@email.com",
			"pass" => "root",
		...
		Authenticate using a specific [access method](/docs/surrealdb/surrealql/statements/define/access) within a database.
		```php
		$token = $db->signin([
			"email" => "user@email.com",
			"pass" => "root",
