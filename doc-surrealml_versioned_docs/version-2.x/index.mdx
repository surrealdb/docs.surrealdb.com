...
once the package is installed, then there is nothing stopping us from training and saving our first model using sklearn (if something did go wrong, please contact us as it shouldn’t happen).
