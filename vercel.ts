...
function sdkRedirects(): Redirect[] {
	...
	const out: Redirect[] = [
		{ source: "/docs/sdk/:sdk", destination: "/languages/:sdk", statusCode: 302 },
		{ source: "/docs/sdk/:sdk/:path*", destination: "/languages/:sdk/:path*", statusCode: 302 },
		{ source: "/sdk/:sdk", destination: "/languages/:sdk", statusCode: 302 },
		{ source: "/sdk/:sdk/:path*", destination: "/languages/:sdk/:path*", statusCode: 302 },
	];
