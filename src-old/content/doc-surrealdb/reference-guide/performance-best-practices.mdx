...
Read more about running SurrealDB as a [single-node server](/docs/surrealdb/installation/running/rocksdb) or [multi-node cluster](/docs/surrealdb/installation/running/tikv).
