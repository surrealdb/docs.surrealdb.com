...
- [Run a single-node, in-memory server](/docs/surrealdb/installation/running/memory) with optional persistence and versioning (SurrealMX)
- [Run a single-node, on-disk server](/docs/surrealdb/installation/running/rocksdb) (RocksDB)
- [Run a single-node, on-disk server](/docs/surrealdb/installation/running/surrealkv) with optional versioning (SurrealKV)
- [Run a multi-node, scalable cluster](/docs/surrealdb/installation/running/tikv) (TiKV)
