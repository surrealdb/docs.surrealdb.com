...
title: Java | SDK | API Reference | Errors
...
Thrown when a SurrealQL [`THROW`](/docs/surrealql/statements/throw) statement is executed. Extends `ServerException`. No additional methods.
...
- [Error handling](/docs/sdk/java/concepts/error-handling) — Error handling concepts and patterns
- [SurrealQL THROW](/docs/surrealql/statements/throw) — Throwing custom errors from queries
