...
title: Java | SDK | API Reference | Datetime
description: SurrealDB datetime values map to Java's ZonedDateTime class.
---

# Datetime {#datetime}

SurrealDB [`datetime`](/docs/surrealql/datamodel/datetimes) values map to Java's `java.time.ZonedDateTime`. The SDK handles conversion automatically when deserializing query results into [`Value`](/docs/sdk/java/api/values/value) objects or POJOs.
...
- [SurrealQL datetimes](/docs/surrealql/datamodel/datetimes) — Datetime types in SurrealDB
