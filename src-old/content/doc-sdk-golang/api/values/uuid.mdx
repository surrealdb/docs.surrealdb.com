...
sidebar_position: 3
sidebar_label: UUID
title: Golang | SDK | API Reference | UUID
...
- [Live queries](/docs/sdk/golang/concepts/live-queries) for live query UUIDs
- [Session](/docs/sdk/golang/api/core/session#id) for session UUIDs
- [Transaction](/docs/sdk/golang/api/core/transaction#id) for transaction UUIDs
- [Value types](/docs/sdk/golang/concepts/value-types) for the full type mapping
- [SurrealQL UUID type](/docs/surrealql/datamodel/uuid) for the underlying data model
