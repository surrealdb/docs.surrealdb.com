...
sidebar_position: 2
sidebar_label: Table
title: Golang | SDK | API Reference | Table
...
- [RecordID](/docs/sdk/golang/api/values/record-id) for targeting specific records
- [Data manipulation](/docs/sdk/golang/concepts/data-manipulation) for using tables in CRUD operations
