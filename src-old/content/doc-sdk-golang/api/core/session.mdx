...
title: Golang | SDK | API Reference | Session
...
`Session` satisfies the [`sendable`](/docs/sdk/golang/api/types#sendable) constraint, so all generic functions like [`Query`](/docs/sdk/golang/api/core/db#query), [`Select`](/docs/sdk/golang/api/core/db#select), [`Create`](/docs/sdk/golang/api/core/db#create), etc. accept `*Session` directly.
...
Returns [`ErrSessionClosed`](/docs/sdk/golang/api/errors#sentinel-errors) if the session has already been detached.
...
**Returns:** [`(*Tokens, error)`](/docs/sdk/golang/api/types#tokens)
...
**Returns:** [`(*VersionData, error)`](/docs/sdk/golang/api/types#versiondata)
...
- [DB](/docs/sdk/golang/api/core/db) for the main client reference
- [Transaction](/docs/sdk/golang/api/core/transaction) for session-scoped transactions
- [Multiple sessions](/docs/sdk/golang/concepts/multiple-sessions) for session usage patterns
- [Errors](/docs/sdk/golang/api/errors) for `ErrSessionClosed` and `ErrSessionsNotSupported`
