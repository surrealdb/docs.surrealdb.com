...
- [`GROUP`](/docs/surrealql/clauses/group-by): Group the results by a set of fields.
- [`LIMIT`](/docs/surrealql/clauses/limit): Limit the number of results.
- [`OMIT`](/docs/surrealql/clauses/omit): Omit related records.
- [`ORDER`](/docs/surrealql/clauses/order-by): Specify the sort order of the results.
- [`SPLIT`](/docs/surrealql/clauses/split): Split the results into a set of subqueries.
- [`START`](/docs/surrealql/clauses/start): Return the results of a query starting from a certain point.
