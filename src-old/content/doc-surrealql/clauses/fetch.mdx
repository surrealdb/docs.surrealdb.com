...
The `FETCH` clause predates and is functionally identical to the [`ALL`](/docs/surrealql/datamodel/idioms#all-elements) idiom which is used by appending a `.*` to a related record.
