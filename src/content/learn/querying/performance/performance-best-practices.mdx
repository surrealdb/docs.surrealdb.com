...
Read more about [SurrealDB architecture](/docs/architecture) and [deployment models](/docs/build/deployment).
...
Read more about running SurrealDB as a [single-node server](/docs/self-hosted/file-backed) or [multi-node cluster](/docs/self-hosted/multi-node).
