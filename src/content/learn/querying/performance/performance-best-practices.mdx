...
Read more about the [architecture of SurrealDB and the supported storage engines.](/docs/start/architecture)
...
Read more about running SurrealDB as a [single-node server](/docs/start/self-hosted/file-backed) or [multi-node cluster](/docs/start/self-hosted/tikv).
...
Read more about [running SurrealDB embedded in Rust.](/docs/build/embedding/rust)
