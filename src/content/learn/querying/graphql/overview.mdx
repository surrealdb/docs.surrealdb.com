...
position: 1
title: GraphQL
description: "Query SurrealDB with GraphQL over HTTP or RPC."
priority: 1
---

# GraphQL

SurrealDB supports [GraphQL](https://graphql.org/) through the [`/graphql`](/docs/reference/rest-api/http-protocol#graphql) endpoint, which can be accessed via [SurrealDB Studio](https://studio.surrealdb.com/), GraphiQL, Postman, or any other GraphQL client.
...
- [Sample queries](/docs/learn/querying/graphql/sample-queries) - queries to run against a GraphQL-enabled database
