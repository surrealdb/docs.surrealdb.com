...
SurrealDB supports [GraphQL](https://graphql.org/) through the [`/graphql`](/docs/reference/rest-api/http-protocol#graphql) endpoint, which can be accessed via [SurrealDB Studio](https://app.surrealdb.com/), GraphiQL, Postman, or any other GraphQL client.
