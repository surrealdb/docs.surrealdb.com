...
In SurrealDB, you can use GraphQL to query your data in Surrealist, a user-friendly interface specifically designed for SurrealDB. Other options include GraphiQL or Postman via the [`/graphql`](/docs/reference/rest-api/http-protocol#graphql) endpoint.
