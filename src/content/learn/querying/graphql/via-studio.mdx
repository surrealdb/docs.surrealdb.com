...
Additionally, you can [start serving from SurrealDB Studio](/docs/explore/studio), which also enables GraphQL automatically, starting a server on `http://localhost:8000` by default for a root user with username and password `root`.
