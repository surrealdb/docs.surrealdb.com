...
Before you can start writing queries, you need to set the [namespace and database](/docs/concepts#namespaces-and-databases) you want to use. For example, you can set the namespace to `test` and the database to `test`. This will set the namespace and database for the current connection.
