...
Beyond this, the only way to persist values beyond the current session is to use [an SDK](/docs/languages/javascript) or [an extension](/docs/learn/extensions/plugins/overview).
