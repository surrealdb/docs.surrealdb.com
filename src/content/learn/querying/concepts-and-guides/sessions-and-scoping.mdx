...
The name `main` is used as the default name for the current namespace and database [when starting SurrealDB](/docs/reference/cli/surrealdb-cli/sql#default-namespace-and-database).
