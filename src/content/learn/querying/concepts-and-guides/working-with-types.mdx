...
For general information on these data types, see the [data types](/docs/reference/query-language/language-primitives/data-types/index) page in the query language documentation.
