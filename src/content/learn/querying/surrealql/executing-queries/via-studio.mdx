...
description: "In this section, you will explore SurrealQL queries using SurrealDB Studio, the official query editor for SurrealDB. SurrealDB Studio is a powerful tool that allows you to write, execute, and visualise SurrealQL queries in real-time."
---
...
If you are using a connection (local or remote), you need to set the [namespace and database](/docs/learn/data-models/architecture#namespaces-and-databases) for the connection before you can start writing queries.
...
To learn more about SurrealQL and how to write queries using SurrealDB Studio, check out the [SurrealDB Studio documentation](/docs/explore/studio).
