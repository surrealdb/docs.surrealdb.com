...
Learn more about other [HTTP Endpoints](/docs/reference/rest-api/http-protocol) available in SurrealDB. For a more detailed tutorial on using Postman with SurrealDB, refer to the [working with SurrealDB over HTTP via Postman tutorial](/docs/explore/tutorials/tutorials/http-via-postman).
