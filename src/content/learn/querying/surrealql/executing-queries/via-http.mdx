...
position: 5
title: Via HTTP
description: "description: In this section, you will explore querying SurrealDB using HTTP. The HTTP API is designed to be simple and intuitive, with a RESTful interface that provides a consistent way to interact with the database."
---

# SurrealQL via HTTP

SurrealDB provides a powerful [HTTP API](/docs/reference/rest-api/http-protocol) that allows you to interact with the database programmatically. This API can be used to perform a wide range of database operations, from querying data to modifying records and managing database structures.
...
Learn more about other [HTTP Endpoints](/docs/reference/rest-api/http-protocol) available in SurrealDB. For a more detailed tutorial on using Postman with SurrealDB, refer to the [working with SurrealDB over HTTP via Postman tutorial](/docs/tutorials/working-with-surrealdb-over-http-via-postman).
