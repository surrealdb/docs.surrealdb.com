...
SurrealDB provides a [RESTful HTTP API](/docs/reference/rest-api/http-protocol) for interacting with the database programmatically. This is useful when you need to integrate SurrealDB into existing HTTP-based workflows, scripts, or environments where an SDK is not available.
