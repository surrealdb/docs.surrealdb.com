...
Open a second terminal and connect with [`surreal sql`](/docs/reference/cli/surrealdb-cli/commands/sql). You can stay in the interactive REPL, or pipe a one-shot query.
