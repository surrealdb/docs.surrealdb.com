...
In this section, you will explore writing [SurrealQL](/docs/reference/query-language) queries using [Surrealist](https://app.surrealdb.com/query), the official query editor for SurrealDB. Surrealist is a powerful tool that allows you to write, execute, and visualize SurrealQL queries in real-time.
...
If you are using a connection (local or remote), you need to set the [namespace and database](/docs/start/concepts#namespaces-and-databases) for the connection before you can start writing queries.
