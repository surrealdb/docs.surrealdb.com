...
SurrealDB supports multiple query interfaces: [SurrealQL](/docs/learn/querying/surrealql/what-is-surrealql) for full-featured database queries, [GraphQL](/docs/learn/querying/graphql/overview) for schema-driven access, and any of the [available SDKs](/docs/languages) for language-native integration.
