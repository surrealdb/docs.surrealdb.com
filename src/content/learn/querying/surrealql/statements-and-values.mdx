...
SurrealDB has a variety of statements that let you configure and query a database. This page covers the different types of statements that are available.
...
As every data type is a subset of value, any value can be compared with another one.
