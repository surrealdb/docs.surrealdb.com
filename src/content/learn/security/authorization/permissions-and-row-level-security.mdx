...
These clauses apply to [record users](/docs/learn/security/authentication/users#record-users) and to [guests](/docs/learn/security/authorization/capabilities#guest-access) when guest access is enabled. [System users](/docs/learn/security/authentication/users#system-users) are not restricted by table or field `PERMISSIONS`, using roles instead.
