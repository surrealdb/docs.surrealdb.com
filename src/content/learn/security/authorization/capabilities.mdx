...
> [!IMPORTANT]
> Capabilities are configured per instance from **Instance settings** in [SurrealDB Studio](https://app.surrealdb.com). See [Configure an instance](/docs/manage/instances/configure) for the available settings.
