...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                Allow the usage of one or more experimental features. Possible values are `files`, `surrealism`, `gql`, and `mutable_permissions`, separated by a comma. See <a href="/docs/reference/cli/surrealdb-cli/commands/start#experimental-capabilities">experimental capabilities</a> for which tag enables each feature. From 3.3.0 a server enables `mutable_permissions` on its own; name it in <code>--deny-experimental</code> to turn it off.
            </td>
            <td scope="row" data-label="Default">
                None
            </td>
