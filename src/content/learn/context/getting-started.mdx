...
description: "Use Spectron agent memory in Surrealist: what each view is for, the ingest-to-integrate flow, and how to connect your code."
---
...
To create your first context, click on **Create context**, give it a name, and select a region where it will be deployed.
...
Once your chat is done, try moving back one page and then click on **Memories**, which will take you to a page where you can inspect the memory graph that has been created by your conversation with the agent.

## Adding knowledge

The next window is the **Knowledge** window, which allows us to move beyond conversation-based information to uploading knowledge in a variety of forms. Inside this page you will see a vast number of options you can choose from:
