...
For general information on these data types, see the [data types](/docs/reference/query-language/datamodel) page in the query language documentation.
