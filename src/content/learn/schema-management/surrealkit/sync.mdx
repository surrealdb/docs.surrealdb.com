...
Do not use this flag routinely on shared databases. Consider switching to [Rollouts](/docs/learn/schema-management/surrealkit/rollouts) for any database that more than one person or service writes to.
