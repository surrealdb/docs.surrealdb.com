...
```bash
surrealkit rollout start 20260302153045__add_customer_indexes --user root --pass secret
```
...
```bash
surrealkit rollout lint 20260302153045__add_customer_indexes --user root --pass secret
```
