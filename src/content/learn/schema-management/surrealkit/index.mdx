...
**cargo binstall** (recommended, no compilation required):
...
Prebuilt binaries for Linux (x86\_64 / aarch64), macOS (x86\_64 / aarch64), and Windows (x86\_64) are available on the [GitHub releases page](https://github.com/surrealdb/surrealkit/releases).
