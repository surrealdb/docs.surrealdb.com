...
These snippets are starting points that are realistic enough to learn from, short enough to paste into Surrealist or a migration script and then reshape. They mix **tables**, **relations**, **computed** fields, **events**, and **indexes** the way a real app might.
...
Have a schema of your own (~50 lines) that would help others? Open a PR against [this file in the docs repo](https://github.com/surrealdb/docs.surrealdb.com/blob/main/src/content/learn/schema-management/schema-design/sample-industry-schemas.mdx) and we can credit you. You can also [get in touch](/contact) if you need a sample for an industry that is not listed yet.
...
Astronomical observation tracking system with instrument management and data collection. Features geospatial telescope locations, flexible observation metadata, and scientific data URL management. Demonstrates [point data types](/docs/reference/query-language/language-primitives/data-types/geometries#point), complex temporal relationships, and scientific data organization patterns.
...
Military mission management system with unit tracking and operational logging. Features hierarchical command structure, real-time status updates, and comprehensive audit trails. Demonstrates complex organizational modeling, [geospatial tracking](/docs/reference/query-language/language-primitives/data-types/geometries#point), and mission-critical data management patterns.
