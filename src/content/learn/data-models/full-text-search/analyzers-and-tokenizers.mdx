---
position: 2
title: Analyzers and tokenisers
description: "Learn how analyzers turn raw text into searchable tokens: tokenisers, filters, and testing with search::analyze before you build an index."
---

# Analyzers and tokenisers
...
Start with the simplest split, whitespace-only tokenisation:
