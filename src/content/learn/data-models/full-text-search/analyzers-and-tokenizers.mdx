...
Use [`search::analyze()`](/docs/reference/query-language/functions/database-functions/search#searchanalyze) to print the token array an analyzer would produce, which is ideal for experimentation.
