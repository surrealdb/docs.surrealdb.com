...
- **Query language**: SurrealQL blends SQL-like syntax with searching syntax (the [`@@` matching operator](/docs/reference/query-language/language-primitives/operators#matches-a-idmatchesa) for FTS queries, advanced indexing features, and so on).
