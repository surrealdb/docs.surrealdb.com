...
Surrealist’s [Explorer view](/docs/explore/surrealist) lets you step through records and relations one hop at a time, useful for building intuition for queries like `SELECT ->wrote->comment FROM user`.
