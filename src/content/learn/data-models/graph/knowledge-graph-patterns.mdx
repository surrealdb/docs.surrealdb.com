...
* graph relations as edges, created with [`RELATE`](/docs/reference/query-language/statements/relate)
...
You can see these patterns applied in real-world schemas in our [sample industry schemas](/docs/learn/schema-management/schema-design/sample-industry-schemas) page.