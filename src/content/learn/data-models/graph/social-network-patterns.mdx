...
Social products are a classic graph use case: **people** (or accounts) are nodes, and **follows**, **likes**, **friendships**, and **messages** are edges, often with timestamps or weights on the edge record.
...
If each interaction is its own edge record, **aggregate** to find the strongest ties:
