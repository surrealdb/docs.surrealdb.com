...
The simplest way to search through your vector embeddings and data in SurrealDB is the [brute force approach](/docs/reference/query-language/statements/define/indexes#brute-force-method).
...
Vector indexes provide this kind of approximate search.
