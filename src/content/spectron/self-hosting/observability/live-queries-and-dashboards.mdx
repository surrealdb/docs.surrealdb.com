...
[Surrealist](https://surrealdb.com/surrealist) is the SurrealDB Cloud dashboard. For **Spectron on Cloud**, use Surrealist to create contexts and mint **API keys** — see [Spectron on SurrealDB Cloud](/docs/spectron/quickstarts/surrealdb-cloud). That is separate from this operator-focused observability page.
