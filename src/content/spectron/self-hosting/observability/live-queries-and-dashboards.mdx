...
[Surrealist](https://surrealdb.com/surrealist) is the SurrealDB Cloud dashboard. For **Spectron on Cloud**, use Surrealist to create contexts, manage Spectron billing, and mint **API keys** — see [Surrealist dashboard quickstart](/docs/spectron/quickstarts/surrealist-dashboard). That is separate from this operator-focused observability page.
