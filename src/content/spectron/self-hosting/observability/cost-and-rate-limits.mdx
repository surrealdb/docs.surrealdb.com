...
Reserve a stronger model for synthesis or elaboration when quality matters more than latency. See [Models per stage](/docs/spectron/agent-memory/tuning/models-per-stage).
...
| Watch the **tier mix** on traces | Many **`full_context`** (tier 4) answers mean cost or query quality needs tuning — see [cost tiers](/docs/spectron/architecture/coherence-retrieval-and-tiers) |
