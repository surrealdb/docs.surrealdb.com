...
| **`decision_trace`** | Every reconciliation (turn ingest, document extraction, reflection writes, …) | Extraction input, confidence, trust, per-row outcomes, acting principal, optional **on-behalf-of** target, session scope |
