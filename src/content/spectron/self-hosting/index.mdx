...
| Option | Best for |
|---|---|
| [Docker Compose](/spectron/self-hosting/deployment/docker) | Local development, small teams, low-traffic deployments |
| [Kubernetes](/spectron/self-hosting/deployment/kubernetes) | Production workloads, high availability, autoscaling |
| [Bare metal (systemd)](/spectron/self-hosting/deployment/bare-metal) | Single-server deployments, edge, or constrained environments |
...
See [Architecture overview](/spectron/self-hosting/deployment/architecture-overview) for how these components fit together.

## Sections in this guide

| Section | Contents |
|---|---|
| [Deployment](/spectron/self-hosting/deployment/architecture-overview) | Architecture, Docker, Kubernetes, bare metal, storage |
| [Security](/spectron/self-hosting/security/authentication) | Authentication, principals, scope, multi-tenancy |
| [Observability](/spectron/self-hosting/observability/tracing) | Tracing, audit trails, cost tracking, live queries |
| [Operations](/spectron/self-hosting/operations/contexts) | Context management, migrations, upgrades |
