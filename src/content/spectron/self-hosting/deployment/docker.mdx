...
services:
  ...
  spectron:
    ...
    environment:
      ...
      SPECTRON_OBJECT_STORE_URL: file:///var/spectron/objects
    volumes:
      - spectron-objects:/var/spectron/objects
    ports:
      - "4000:4000"
    healthcheck:
...
- Replace `file:///var/spectron/objects` with an S3 or GCS URL so object storage is not tied to the container's local filesystem.
...
See [Kubernetes](/spectron/self-hosting/deployment/kubernetes) for a production-grade deployment guide.
