...
- [Storage and scaling](/spectron/self-hosting/deployment/storage-and-scaling) — object store configuration and scaling advice
- [Authentication](/spectron/self-hosting/security/authentication) — creating and managing API keys
- [Observability](/spectron/self-hosting/observability/tracing) — monitoring your deployment
