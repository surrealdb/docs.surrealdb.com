...
- Layer 0: knowledge nodes, embedding vectors, document metadata
- Layer 1: entities, attributes, relations, memory categories
- Sessions and turns
- API keys (hashed)
...
The object store holds the original bytes of every document ingested into Layer 0: PDFs, DOCX files, plain text, and other uploaded content.
