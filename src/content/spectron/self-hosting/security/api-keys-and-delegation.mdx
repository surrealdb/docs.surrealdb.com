...
Surrealist's in-dashboard Playground/Memories/Knowledge views will use brokered tokens when wired; today the live integration path is **API keys** + your context **host**.
