...
- [Authentication](/spectron/self-hosting/security/authentication) — creating and rotating keys
- [Scope as a security boundary](/spectron/self-hosting/security/scope-as-security-boundary) — how scope floors are enforced
- [Multi-tenancy](/spectron/self-hosting/security/multi-tenancy) — patterns for isolating tenants
