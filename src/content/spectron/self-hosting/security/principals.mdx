...
- Modify Context configuration (models, providers, token limits).
...
[
  {
    ...
    "name": "planner-agent",
    "grants": [
      { "path": "org/acme", "verbs": ["memory:read"] },
      { "path": "org/acme/agent/planner", "verbs": ["memory:write"] }
    ]
  },
  {
    "id": "key_01hx",
    "name": "ops-supervisor",
    "grants": [
      { "path": "org/acme", "verbs": ["memory:read", "memory:forget"] }
    ]
  }
]
```
