...
The Spectron client ships inside the [SurrealDB Kotlin SDK](/docs/reference/kotlin) — there is no separate artifact. It is independent of the SurrealDB RPC engine and speaks Spectron's HTTP API directly.
