...
Poll `GET /v1/{context_id}/knowledge/{id}` to check document status. See [Uploading documents](/spectron/knowledge/ingestion/uploading-documents) for retry guidance.
