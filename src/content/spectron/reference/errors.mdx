...
Poll `GET /api/v1/{context_id}/documents/{id}` to check document status. See [Uploading documents](/docs/spectron/knowledge/ingestion/uploading-documents) for retry guidance.
