...
See [Key policy](/docs/spectron/reference/configuration#key-policy).
...
See [Permissions and delegation](/docs/spectron/mental-model/contexts-and-scope#permissions-and-delegation).
