...
The precedence rule: **Authoritative** (curated) content takes precedence over **Experiential** assertions when they conflict. Disagreements are surfaced via **`uncertainty`** records and conflict indicators in state/profile responses — curated records are not silently overwritten. See [Authority when pillars meet](/docs/spectron/memory/reasoning-model/authority-hierarchy).
