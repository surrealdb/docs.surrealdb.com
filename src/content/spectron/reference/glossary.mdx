...
The precedence rule: **Authoritative** (curated) content takes precedence over **Experiential** assertions when they conflict. Experiential attributes may carry a **`contradicts_l0`** flag when they conflict with curated knowledge. See [Authority when pillars meet](/docs/spectron/memory/reasoning-model/authority-hierarchy).
