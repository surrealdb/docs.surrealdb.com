...
|---|---|---|
| `SPECTRON_MODEL_EXTRACTION` | `gpt-4o-mini` | LLM for Layer 1 extraction (Stage 1 fast pass) |
...
| `retention_days` | integer (optional) | Automatic expiry for `context`-category Layer 1 data. `null` = no automatic expiry. |
