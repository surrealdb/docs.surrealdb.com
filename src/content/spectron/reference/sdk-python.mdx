...
| Item | Value |
| --- | --- |
| PyPI package | [`surrealdb`](https://pypi.org/project/surrealdb/) (Spectron client bundled) |
| Planned standalone name | `surrealdb` (applied for; not published yet) |
...
The bare PyPI name **`spectron`** is owned by another project. Do not `pip install spectron` for SurrealDB Spectron.
