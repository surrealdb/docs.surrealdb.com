...
Synthesise patterns or insights from existing memory. Can optionally persist the reflection as new Layer 1 attributes.
...
Search the authoritative Layer 0 knowledge base. Returns ranked document chunks with source references.
