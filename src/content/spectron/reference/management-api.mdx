...
Document ingestion requires a management key or an agent key with explicit upload capability. See [Uploading documents](/docs/spectron/knowledge/ingestion/uploading-documents) for the full upload API.
...
Ontology endpoints (entity type definitions, attribute key declarations, and relation label declarations) are management-only. See [Ontology grounding](/docs/spectron/memory/tuning/ontology-grounding) for details.
