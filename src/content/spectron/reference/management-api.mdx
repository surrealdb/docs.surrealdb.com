...
> **Breaking change (v3 preview):** legacy verb names (`read`, `write`, `forget`, …) are rejected on new Contexts. Existing deployments must re-bootstrap or migrate grant maps.
