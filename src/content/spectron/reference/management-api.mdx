...
Data-plane keys are always **bound to a principal**. Mint them under that principal; unbound keys require `reject_unbound_keys: false` and are discouraged for production.
