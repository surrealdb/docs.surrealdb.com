...
Corrections accumulate and are never deleted. The full supersession chain for any attribute is always queryable, which means the audit trail for any fact is complete and irrevocable. See [Temporal validity](/docs/spectron/memory/reasoning-model/temporal-validity) and [Reconciliation and supersession](/docs/spectron/memory/reasoning-model/reconciliation-and-supersession) for the detailed model.
