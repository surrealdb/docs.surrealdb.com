...
Experiential mentions can link to authoritative **knowledge** records (for example resolving “AirPods Pro” in chat to the same product as your catalogue) via **`resolves_to`**. See [Cross-layer linking](/docs/spectron/knowledge/retrieval/cross-layer-linking).
