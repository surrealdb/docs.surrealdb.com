...
|---|---|---|
| `trace_id` | string | Correlates this call with **trace** rows in the substrate (`decision_trace`, `retrieval_trace`, or `response_trace` depending on the tool). Use for debugging and audit walks. |
