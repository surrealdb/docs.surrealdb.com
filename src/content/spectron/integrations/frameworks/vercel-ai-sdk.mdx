...
> **Later-phase integration.** The `spectron-ai-sdk` package is planned for a future release and is not yet available. This page describes the intended integration design. Check the [Spectron changelog](/spectron/reference) for availability updates.
...
- [JavaScript SDK](/spectron/integrations/sdks/javascript-and-typescript) — using Spectron directly with the TypeScript SDK
- [Chat sessions](/spectron/memory/sessions/chat-sessions) — understanding how Spectron manages conversation sessions
- [Adding turns](/spectron/memory/sessions/adding-turns) — the manual turn-recording API
