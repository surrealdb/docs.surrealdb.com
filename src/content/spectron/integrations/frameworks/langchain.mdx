...
If your application calls Spectron explicitly (not only through LangChain’s memory interface), use **`surrealdb`** directly. See [Python SDK](/docs/spectron/integrations/sdks/python).
