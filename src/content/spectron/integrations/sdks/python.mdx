...
- A dict shorthand: `scope={"org": "acme", "user": "alice"}` (serialised as `org=acme`, `user=alice` segments)

Prefer explicit slash paths when your grants use hierarchical paths.
