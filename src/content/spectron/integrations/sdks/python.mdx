...
The published package is **`surrealdb-spectron`** — a generated OpenAPI client wrapped with an ergonomic façade. It targets the unified API (`/api/v1/{context_id}/facts`, `/query`, `/documents`, …).
