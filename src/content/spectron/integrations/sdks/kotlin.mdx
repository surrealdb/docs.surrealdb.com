...
Add the Kotlin SDK to your project as described in the [installation guide](/docs/languages/kotlin/installation):
...
- [SurrealDB Kotlin SDK](/docs/languages/kotlin/index) for the database client in the same package
