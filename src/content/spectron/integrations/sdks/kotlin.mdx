...
All failures throw a subclass of `SpectronException`. See the [Kotlin SDK reference](/docs/spectron/reference/sdk-kotlin#errors) for the full exception to status mapping, and [error responses](/docs/spectron/reference/errors) for the shared RFC 7807 format.
