...
The TypeScript client accepts a path string, an array of paths, a `Record<string, string>` map, or `[key, value]` tuples — all normalised to the wire form. Prefer slash paths when your grants are hierarchical.
