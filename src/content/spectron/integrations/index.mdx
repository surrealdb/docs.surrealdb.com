...
- **Zapier**: connect Spectron over MCP with Zapier's MCP Client and use its tools as Zap actions.

→ [n8n](/docs/spectron/integrations/automation/n8n) · [Zo Computer](/docs/spectron/integrations/automation/zo-computer) · [Zapier](/docs/spectron/integrations/automation/zapier)
