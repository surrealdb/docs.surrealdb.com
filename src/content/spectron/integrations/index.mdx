...
The [`surrealdb.kotlin`](https://github.com/surrealdb/surrealdb.kotlin) repository provides the **SurrealDB database driver** (query, auth, live queries). It does not include a Spectron memory client — use REST or the Python, TypeScript, or Swift SDKs.
