...
| **“This should not exist for the agent.”** | **Forget** (soft by default) | “Forget everything about my old job.” Matched beliefs expire from current retrieval; see [Forgetting memories](/docs/spectron/agent-memory/operations/forget). |
...
Cross-provenance clashes are different — an uploaded policy versus a user assertion — and surface as **`uncertainty`** instead of a clean supersession. See [Authority when pillars meet](/docs/spectron/agent-memory/reasoning/authority-hierarchy).
...
- [Forgetting memories](/docs/spectron/agent-memory/operations/forget)
