...
Calibration stores **`attribute.confidence`** (reconciler posterior) **separately** from `source.trust`. See [Surface, models, and security](/docs/spectron/architecture/surface-security-and-models) for the model-hook story.
