...
The result is a memory layer where correctness can be demonstrated, not just assumed. See [The accuracy promise](/docs/spectron/welcome/accuracy-promise) for how this is achieved in practice.
