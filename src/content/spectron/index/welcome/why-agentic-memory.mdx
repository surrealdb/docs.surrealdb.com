...
| No provenance | Every record carries a **`source`** object (kind, ref, spans, trust, derivation); [Provenance and traceability](/docs/spectron/mental-model/provenance-and-traceability) |
...
The result is a memory layer operators and users can **trust**: correctness can be demonstrated, not just assumed. See [The accuracy promise](/docs/spectron/welcome/accuracy-promise) for how that works in practice.
