...
Spectron is **not** a vector database, a chat-log archive, a hand-authored knowledge graph, a context-window manager, a full agent runtime, or an observability SaaS. [Principles and goals](/docs/spectron/architecture/principles-and-goals) states what Spectron refuses to be and the design goals those boundaries protect.
