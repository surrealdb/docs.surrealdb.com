...
Field-level detail: [Temporal validity](/docs/spectron/agent-memory/reasoning/temporal-validity) and [Reconciliation and supersession](/docs/spectron/agent-memory/reasoning/reconciliation-and-supersession).
