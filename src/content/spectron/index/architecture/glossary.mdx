...
**Collective (pillar)** — Shared memory when multiple principals corroborate the same fact; promotion to wider scope is policy-gated (on the roadmap).
...
**Source.trust** — Prior belief in how authoritative the source stream is (document vs casual turn).
