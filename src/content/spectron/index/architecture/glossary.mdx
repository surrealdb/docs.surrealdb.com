...
**Collective (pillar)** — Shared memory when multiple principals corroborate the same fact; independent assertions keep separate provenance today. Automated promotion to wider scope is policy-gated (**not yet enabled** in early preview).
