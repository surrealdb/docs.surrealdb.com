...
Each guarantee is **queryable state** (traces, configuration, provenance) — not marketing copy alone.
...
CLI: `spectron entities show`, `spectron recall "…" --json`, `spectron inspect trace:…`. See [Self-hosting observability](/docs/spectron/self-hosting/observability/tracing).
