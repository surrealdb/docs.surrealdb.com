...
> [!NOTE]
> Spectron contexts are created in **[SurrealDB Studio](https://app.surrealdb.com)** (organisation → **Contexts**). See [Spectron on SurrealDB Cloud](/docs/spectron/quickstarts/surrealdb-cloud) for context setup and API keys. This page assumes you already have a **context host**, **context id**, and **API key** from the **API keys** view.
...
For a click-by-click version of this step, plus the Playground, Documents, and Memory views, see [Create your first context](/docs/spectron/quickstarts/surrealdb-cloud#create-your-first-context).
