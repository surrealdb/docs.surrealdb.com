...
Generated clients are published as **`surrealdb`** (Python) and **`@surrealdb/spectron`** (TypeScript). See [Integrations](/docs/spectron/integrations) and the [REST API](/docs/spectron/reference/rest-api) for the full surface.
