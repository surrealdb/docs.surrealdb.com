...
> [!NOTE]
> **Transient errors and Activity.** If a turn fails with a server error and you resend the message, the failed attempt may still appear in **Activity** alongside the successful retry. That is expected during preview — the session transcript records what was submitted even when synthesis did not complete.
