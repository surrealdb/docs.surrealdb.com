...
{
  "identity": [
        { "label": "repo", "attributes": { "name": "my-repo",
        "language": "TypeScript", "framework": "React" } }
  ],
  "knowledge": [
        { "label": "state_management",
        "attributes": { "choice": "Tanstack Query",
        "reason": "devtools" } },
        { "label": "error_handling",
        "attributes": { "pattern": "Result<T, Error>",
        "exceptions": "never" } }
  ],
  "context": [
        { "label": "active_migration",
        "attributes": { "task": "analytics_migration",
        "progress": "80%", "blocker": "auth_service" } }
  ]
}
```
...
Tool: memory_recall
Arguments: { "query": "error handling patterns", "scope": \
  ["project/my-repo"] }
