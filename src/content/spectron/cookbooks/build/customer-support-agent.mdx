...
When a customer says "your return policy is actually 60 days", Spectron stores their belief under the **Experiential** pillar with a **`contradicts_l0`** flag rather than updating the curated policy under the **Authoritative** pillar.
