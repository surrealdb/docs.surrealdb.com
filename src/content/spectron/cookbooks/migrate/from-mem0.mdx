...
**Layer 0 knowledge**: Mem0 treats all memory equally. Spectron separates authoritative knowledge (Layer 0, ingested from documents) from conversational memory (Layer 1). Layer 0 always wins in case of conflict.
