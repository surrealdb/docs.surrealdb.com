...
| Retire a scope folder in the vocabulary only | **`scope:delete`** (tombstone the scope node) | Tombstone is soft — distinct from erasing facts; see [Contexts and scope](/docs/spectron/mental-model/contexts-and-scope#tombstone-vs-erase) |
...
- [Permissions and delegation](/docs/spectron/mental-model/contexts-and-scope#permissions-and-delegation) — **`memory:forget`** grants
