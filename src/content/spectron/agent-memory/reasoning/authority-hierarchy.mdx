...
**Authoritative** means *curated by you for retrieval* — not *guaranteed true*. When you upload humour, parody, or deliberately false material (for example a satirical encyclopedia article), Spectron still indexes and retrieves it like any other document. At synthesis time the response model can recognise obvious parody and **refuse to treat it as factual**, especially when you ask what the **documents** say versus a general-knowledge question.
