...
| Warehouse sync (future) | [Connectors](/docs/spectron/knowledge/connectors/overview) → `/documents` or `/facts/batch` |
...
See [Cross-layer linking](/docs/spectron/knowledge/retrieval/cross-layer-linking).
