...
Spectron can ingest more than text. Images, audio recordings, and video files are all first-class document types in Layer 0. Depending on the ingestion profile you select, Spectron applies OCR, speech-to-text transcription, and visual embedding to extract retrievable content from non-textual sources.
