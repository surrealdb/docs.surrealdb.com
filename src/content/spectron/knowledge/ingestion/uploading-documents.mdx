...
Under **`TextOnly`**, multimodal uploads may be accepted but image/audio/video processing stages are skipped. See [Multimodal content](/docs/spectron/knowledge/ingestion/multimodal-content) for profile details.
