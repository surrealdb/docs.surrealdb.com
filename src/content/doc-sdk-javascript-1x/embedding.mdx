...
```bash
npm install surrealdb@1.3.2 @surrealdb/node@1.4.1  # For Node.js server environments
# or
npm install surrealdb@1.3.2 @surrealdb/wasm@1.4.1  # For browser environments
```
...
```bash
npm install surrealdb@1.3.2 @surrealdb/wasm@1.3.2
```
...
```bash
npm install surrealdb@1.3.2 @surrealdb/node@1.3.2
```
...
```bash
npm install surrealdb@1.3.2 @surrealdb/node@1.3.2  # For Node.js
# or
npm install surrealdb@1.3.2 @surrealdb/wasm@1.3.2  # For browser
```
