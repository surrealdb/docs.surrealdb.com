...
<div class="flag-title">
	<img src="@ui/brandNodeJs" alt="Node.js" style="width: 42px; height: 42px" />
	# Node.js engine
</div>
...
<tabs synckey="installation">
  <tabitem label="npm">
    ```bash
    npm install --save @surrealdb/node@1.3.2
    ```
  </tabitem>
  <tabitem label="yarn">
    ```bash
    yarn add @surrealdb/node@1.3.2
    ```
  </tabitem>
  <tabitem label="pnpm">
    ```bash
    pnpm install @surrealdb/node@1.3.2
    ```
  </tabitem>
</tabs>
