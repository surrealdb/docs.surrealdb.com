...
<div class="flag-title">
	<img src="@ui/brandWebAssembly" alt="WebAssembly" style="width: 42px; height: 42px" />
	# WebAssembly engine
</div>
...
<tabs synckey="installation">
  <tabitem label="npm">
    ```bash
    npm install --save @surrealdb/wasm@1.3.2
    ```
  </tabitem>
  <tabitem label="yarn">
    ```bash
    yarn add @surrealdb/wasm@1.3.2
    ```
  </tabitem>
  <tabitem label="pnpm">
    ```bash
    pnpm install @surrealdb/wasm@1.3.2
    ```
  </tabitem>
</tabs>
