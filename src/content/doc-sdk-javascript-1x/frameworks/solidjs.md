...
<div class="flag-title">
	<img src="~/assets/img/icon/light/solidjs.png" darkSrc="~/assets/img/icon/dark/solidjs.png" alt="SolidJS" style="width: 42px; height: 42px" />
	# SolidJS
</div>
...
- See SurrealDB in action by checking out our SolidJS example projects in the [examples section](/docs/1.x/sdk/javascript#example-projects)
