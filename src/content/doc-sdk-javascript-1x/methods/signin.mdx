...
You can invalidate the authentication for the current connection using the [`invalidate()` method](/docs/1.x/sdk/javascript/methods/invalidate). Learn more about [handling authentication](/docs/1.x/sdk/javascript/core/handling-authentication).  