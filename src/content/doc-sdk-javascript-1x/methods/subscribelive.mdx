...
For `CREATE`, `UPDATE` and `DELETE`, the type `Result` is the generic argument passed to [`.live()`](/docs/1.x/sdk/javascript/methods/live) or [`.subscribeLive()`](/docs/1.x/sdk/javascript/methods/subscribelive). <br />
