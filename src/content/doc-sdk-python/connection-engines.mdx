...
# Connection Engines
There are 2 available connection engines you can use to connect to SurrealDb backend. It can be via Websocket or HTTP. The connection types are simply determined by the url scheme provided in
the connection url.
