...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Method"><a href="#subscribe_live"> <code> db.subscribe\_live(query\_uuid) </code></a></td>
      <td scope="row" data-label="Description">Returns a queue that receives notification messages from a running live query</td>
    </tr>

    <tr>
      <td scope="row" data-label="Method"><a href="#kill"> <code> db.kill(query\_uuid) </code></a></td>
