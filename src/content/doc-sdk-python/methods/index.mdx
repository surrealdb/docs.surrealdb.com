...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/sdk/python/methods/connect"> <code> db.connect(url, options) </code></a></td>
		...
		<tr>
            <td scope="row" data-label="Method"><a href="/docs/sdk/python/methods/let"> <code>db.let(key,val)</code></a></td>
