...
from surrealdb.data.types.geometry import GeometryLine, GeometryPoint
import json
...
```python title="Signature"
from surrealdb.data.types.geometry import GeometryPolygon, GeometryLine
...
```python title="Signature"
from surrealdb.data.types.geometry import GeometryMultiPoint, GeometryPoint
...
```python title="Signature"
from surrealdb.data.types.geometry import GeometryMultiLine, GeometryLine
...
```python title="Signature"
from surrealdb.data.types.geometry import GeometryMultiPolygon, GeometryPolygon
...
```python title="Signature"
from surrealdb.data.types.geometry import GeometryCollection, Geometry
