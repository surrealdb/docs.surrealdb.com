...
After [installing the SDK](/docs/sdk/dotnet/setup), you can initialize a new instance of a SurrealDB client.
...
>Just note that in some contexts, calling this method behore hand can improve performance by avoiding cold starts.
