...
<table>
    ...
    <tbody>
		...
		<tr>
            <td scope="row" data-label="Method"><a href="/docs/sdk/dotnet/core/methods/invalidate"> <code>db.Invalidate()</code></a></td>
            <td scope="row" data-label="Description">Invalidates the authentication for the current connection</td>
        </tr>
        <tr>
            <td scope="row" data-label="Method"><a href="/docs/sdk/dotnet/core/methods/authenticate"> <code>db.Authenticate(token)</code></a></td>
