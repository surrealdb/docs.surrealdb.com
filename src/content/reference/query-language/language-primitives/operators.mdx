...
The `and` operator checks whether both of two values are [truthy](/docs/reference/query-language/language-primitives/data-types/values#values-and-truthiness).
...
The `or` operator checks whether either of two values are [truthy](/docs/reference/query-language/language-primitives/data-types/values#values-and-truthiness).
...
The `null coalescing operator` checks whether either of two values are [truthy](/docs/reference/query-language/language-primitives/data-types/values#values-and-truthiness) and not `NONE` or `NULL`.
...
The `truthy coalescing operator` checks whether either of two values are [truthy](/docs/reference/query-language/language-primitives/data-types/values#values-and-truthiness).
