...
SurrealDB supports GeoJSON, including `Point`, `LineString`, `Polygon`, `MultiPoint`, `MultiLineString`, `MultiPolygon`, and `Collection` values. SurrealQL automatically detects GeoJSON objects converting them into a single data type.
...
* Points are defined according to the GeoJSON spec, which specifies longitude before latitude. Many sites - including Google Maps - provide location data in the opposite order, so be sure to confirm that any data being used to create a `Point` is in the order `(longitude, latitude)`, and not the other way around.
...
[[test.results]]
value = "[{ boundary: { type: 'Polygon', coordinates: [[[-0.38314819f, 51.37692386f], [0.1785278f, 51.37692386f], [0.1785278f, 51.6146057f], [-0.38314819f, 51.6146057f], [-0.38314819f, 51.37692386f]]] }, id: city:london }]"
...
[[test.results]]
value = "[{ id: person:tobie, locations: { type: 'MultiPoint', coordinates: [[10f, 11.2f], [10.5f, 11.9f]] } }]"
...
[[test.results]]
value = "[{ id: travel:yellowstone, routes: { type: 'MultiLineString', coordinates: [[[10f, 11.2f], [10.5f, 11.9f]], [[11f, 12.2f], [11.5f, 12.9f], [12f, 13f]]] } }]"
*/
...
[[test.results]]
value = "[{ id: university:oxford, locations: { type: 'MultiPolygon', coordinates: [[[[10f, 11.2f], [10.5f, 11.9f], [10.8f, 12f], [10f, 11.2f]]], [[[9f, 11.2f], [10.5f, 11.9f], [10.3f, 13f], [9f, 11.2f]]]] } }]"
...
[[test.results]]
value = "[{ buildings: { type: 'GeometryCollection', geometries: [{ type: 'MultiPoint', coordinates: [[10f, 11.2f], [10.5f, 11.9f]] }, { type: 'Polygon', coordinates: [[[-0.38314819f, 51.37692386f], [0.1785278f, 51.37692386f], [0.1785278f, 51.6146057f], [-0.38314819f, 51.6146057f], [-0.38314819f, 51.37692386f]]] }, { type: 'MultiPolygon', coordinates: [[[[10f, 11.2f], [10.5f, 11.9f], [10.8f, 12f], [10f, 11.2f]]], [[[9f, 11.2f], [10.5f, 11.9f], [10.3f, 13f], [9f, 11.2f]]]] }] }, id: university:oxford }]"
...
* [SurrealQL operators](/docs/reference/query-language/language-primitives/operators)
