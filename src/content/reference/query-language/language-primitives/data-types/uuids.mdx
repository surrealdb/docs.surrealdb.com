...
position: 19
title: UUIDs
description: "UUID values in SurrealQL represent UUID v4 and v7 values."
---

# UUIDs

UUIDs represent UUID v4 and v7 values. They can be obtained via either the:
- [`rand::uuid::*` functions](/docs/reference/query-language/functions/database-functions/rand#randuuidv4)
- [casted from strings](/docs/reference/query-language/language-primitives/casting#uuid)
- or via [string prefixes](/docs/reference/query-language/language-primitives/data-types/strings#uuid-literal-values-with-the-u-prefix)
