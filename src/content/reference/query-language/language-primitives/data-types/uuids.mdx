...
- [casted from strings](/docs/reference/query-language/language-primitives/data-types/casting#uuid)
- or via [string prefixes](/docs/reference/query-language/language-primitives/data-types/strings#uuid)
