...
The maximum possible duration can be accessed via the const [`duration::max`](/docs/reference/query-language/functions/database-functions/duration#durationmax), above which a duration cannot be formed.
