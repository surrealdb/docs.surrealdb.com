...
* [time](/docs/reference/query-language/functions/database-functions/time) functions, which enable extracting, altering, rounding, and grouping datetimes into specific time intervals