...
> [!NOTE]
> SurrealDB does not eagerly convert a string into a record. An [implicit `r` prefix or cast](/docs/reference/query-language/language-primitives/data-types/casting#casting-vs-affixes) is required instead.
