...
As a record is essentially an object with a required [`id` field](/docs/reference/query-language/language-primitives/data-types/record-ids) that can be created, updated, or deleted, they can be worked with in almost exactly the same way as a standalone object.
...
* [Object functions](/docs/reference/query-language/functions/database-functions/object)
* [Destructuring nested objects](/docs/reference/query-language/language-primitives/idioms#destructuring)