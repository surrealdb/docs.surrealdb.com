...
To return the greatest value of a set, use `[$]` (since 3.2.0) or the [`set::last()`](/docs/reference/query-language/functions/database-functions/set#setlast) function.
...
A set can be added to another set or array, resulting in a single set consisting of the items of the first followed by those of the second.
