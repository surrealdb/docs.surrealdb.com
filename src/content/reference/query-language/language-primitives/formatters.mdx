...
The [string::is_datetime](/docs/reference/query-language/functions/database-functions/string#stringis_datetime) and [time::format](/docs/reference/query-language/functions/database-functions/time#timeformat) functions in SurrealQL accept certain text formats for date/time formatting. The possible formats are listed below.
