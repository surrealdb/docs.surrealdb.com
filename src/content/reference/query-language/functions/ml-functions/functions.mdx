...
Seeing as the ML is integrated into our surql, we can infer entire fields using the ml function. We can demonstrate this with a simple
...
We can then get all the records with the imputed price prediction with the surql below:
