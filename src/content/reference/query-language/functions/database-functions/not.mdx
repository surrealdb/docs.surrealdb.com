...
The `not` function reverses the truthiness of a value. It is functionally identical to `!`, the [NOT](/docs/reference/query-language/language-primitives/operators#not) operator.
