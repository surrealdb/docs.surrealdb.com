...
Example of `.is_empty()` being used in a [`DEFINE FIELD`](/docs/reference/query-language/statements/define/field#asserting-rules-on-fields) statement to disallow empty objects:
