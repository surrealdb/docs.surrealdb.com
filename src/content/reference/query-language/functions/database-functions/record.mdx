...
> [!NOTE]
> Record functions before SurrealDB 2.0 were located inside the module [meta](/docs/reference/query-language/functions/database-functions/meta). Their behaviour has not changed.
