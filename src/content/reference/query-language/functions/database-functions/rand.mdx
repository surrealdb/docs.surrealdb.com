...
If two numbers are provided, the function generates a random [`float`](/docs/reference/query-language/language-primitives/data-types/numbers#floating-point-numbers) between them (inclusive of the bounds). The first argument is the **minimum** and the second is the **maximum**.
