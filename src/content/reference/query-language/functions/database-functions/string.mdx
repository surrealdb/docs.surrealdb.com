...
If you want to join an array of strings use [`array::join`](/docs/reference/query-language/functions/database-functions/array#arrayjoin).
...
With [`regexes`](/docs/reference/query-language/language-primitives/data-types/regex) added as a data type in version 2.3, the second argument can also be a regex instead of a string.
