...
API functions are passed in as middleware inside a [`DEFINE API`](/docs/reference/query-language/statements/define/api) or [`DEFINE CONFIG API`](/docs/reference/query-language/statements/define/config) statement and called a request is received.
...
For more details on how this works, see [this section](/docs/reference/query-language/functions/database-functions/api#structure-of-api-functions) of the page.
