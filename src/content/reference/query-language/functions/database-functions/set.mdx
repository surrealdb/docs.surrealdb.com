...
When called on a set without any extra arguments, the `set::all` function checks whether all set values are [truthy](/docs/reference/query-language/language-primitives/data-types/values#values-and-truthiness).
...
The `set::any` function checks whether any set values are [truthy](/docs/reference/query-language/language-primitives/data-types/values#values-and-truthiness).
...
When called on a set without any extra arguments, the `set::any` function checks whether any set values are [truthy](/docs/reference/query-language/language-primitives/data-types/values#values-and-truthiness).
...
The `set::find` function is most useful when a [closure](/docs/reference/query-language/language-primitives/data-types/closures) is passed in, which allows for customized searching.
...
If you want to only count [truthy](/docs/reference/query-language/language-primitives/data-types/values#values-and-truthiness) values, then use the [count()](/docs/reference/query-language/functions/database-functions/count) function.
...
The `set::map` function allows the user to call an [anonymous function](/docs/reference/query-language/language-primitives/data-types/closures) (closure) that is performed on every item in the set before passing it on.
...
If you need an initial value to pass in before the other items are operated on, use the [`set::fold`](/docs/reference/query-language/functions/database-functions/set#setfold) function instead.
