...
Several function families transform values across representation boundaries (JSON, CBOR, tokens, runtime query strings). See [Representations and codecs](/docs/learn/querying/concepts-and-guides/representations-and-codecs) for when to use each.
...
<table>
	...
	<tr>
		...
		<tr>
			...
			<td scope="row" data-label="Description and Example">
				Functions and constants for converting between numeric values
				and duration data.
		...
		<tr>
			<td scope="row" data-label="Function">
				<a href="/docs/reference/query-language/functions/database-functions/eval">
					<code>Eval</code>
				</a>
			</td>
			<td scope="row" data-label="Description and Example">
				Evaluate a SurrealQL or ISO GQL (Cypher Query Language) query string at runtime inside the
...
A few functions can be used not just on their own but with a [`GROUP BY`](/docs/reference/query-language/clauses/group) clause including as part of a [pre-computed table view](/docs/reference/query-language/statements/define/table#pre-computed-table-views).

These functions are:

* [`count()`](/docs/reference/query-language/functions/database-functions/count)
* [`math::max()`](/docs/reference/query-language/functions/database-functions/math#mathmax)
* [`math::min()`](/docs/reference/query-language/functions/database-functions/math#mathmin)
* [`math::sum()`](/docs/reference/query-language/functions/database-functions/math#mathsum)
* [`math::mean()`](/docs/reference/query-language/functions/database-functions/math#mathmean)
* [`math::stddev()`](/docs/reference/query-language/functions/database-functions/math#mathstddev)
* [`math::variance()`](/docs/reference/query-language/functions/database-functions/math#mathvariance)
* [`time::max()`](/docs/reference/query-language/functions/database-functions/time#timemax)
...
You can also write your own functions in Rust that can be compiled to WASM modules, linked to, and called from the database. For more on how extensions are built and run, see [Extensions](/docs/learn/extensions).