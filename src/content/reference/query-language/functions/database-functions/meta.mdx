...
> [!NOTE]
> These functions are deprecated. Prefer SurrealDB's [record](/docs/reference/query-language/functions/database-functions/record) functions instead.
...
The equivalent [`record::tb`](/docs/reference/query-language/functions/database-functions/record#recordtb) function can also be called using the path `record::table`.
