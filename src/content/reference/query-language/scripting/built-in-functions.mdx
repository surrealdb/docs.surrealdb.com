...
Besides basic JavaScript utilities and [classes for SurrealQL types](/docs/reference/query-language/functions/script/type-conversion), there are a handful of utilities built into the embedded scripting functions.
