...
Besides basic JavaScript utilities and [classes for SurrealQL types](/docs/reference/query-language/scripting/type-conversion), there are a handful of utilities built into the embedded scripting functions.
