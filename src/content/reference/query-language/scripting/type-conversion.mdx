...
In addition, a number of special classes are included within the JavaScript functions for the additional types which are not built into JavaScript. These enable the creation of [`duration`](/docs/reference/query-language/language-primitives/data-types/datetimes#durations-and-datetimes) values, [`record`](/docs/reference/query-language/language-primitives/data-types/record-ids) ids, and [`UUID`](/docs/reference/query-language/language-primitives/data-types/strings#uuid-literal-values-with-the-u-prefix) values from within JavaScript.
