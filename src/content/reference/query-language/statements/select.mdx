...
Two of the most powerful features in SurrealDB are [record links](/docs/reference/query-language/language-primitives/record-links) and [graph connections](/docs/reference/query-language/statements/relate).
