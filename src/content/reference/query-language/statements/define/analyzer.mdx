...
Using the `FUNCTION` clause allows a [user-defined function](/docs/reference/query-language/statements/define/function) to be executed on the initial input. The function must take and return a `string`.
