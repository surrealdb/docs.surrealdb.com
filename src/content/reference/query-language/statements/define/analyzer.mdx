...
The output of an analyzer can be experimented with by using the [`search::analyze()`](/docs/reference/query-language/functions/database-functions/search#searchhighlight) function.
