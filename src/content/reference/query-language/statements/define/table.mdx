...
> [!NOTE]
> Since `v2.0.0`, schemafull tables are implicitly type [`NORMAL`](/docs/reference/query-language/statements/define/table#table-with-specialized-type-clause) tables by default.
