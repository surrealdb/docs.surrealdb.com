...
An API endpoint can be tested using the [`api::invoke` function](/docs/reference/query-language/functions/database-functions/api), which takes either the path as a single string or the path along with a request body. It can also be tested via [CURL or other means by directly using the endpoint](/docs/reference/rest-api/http-protocol) along with the namespace and database in the headers.
...
[[test.results]]
value = """{ body: { some: 'data' }, headers: { "x-surreal-request-id": '40b38d42-bc7e-4162-ad67-041a1e64c626' }, request_id: '40b38d42-bc7e-4162-ad67-041a1e64c626', status: 200 }"""

[[test.results]]
value = """{ body: { some: 'data' }, headers: { "x-surreal-request-id": 'c1c53fd1-c865-4d4a-a9bd-1936b944982c' }, request_id: 'c1c53fd1-c865-4d4a-a9bd-1936b944982c', status: 200 }"""

[[test.results]]
value = """{ body: { some: 'data' }, headers: { "x-surreal-request-id": '7ae4b3bb-fc38-437e-9695-f658f48aee76' }, request_id: '7ae4b3bb-fc38-437e-9695-f658f48aee76', status: 200 }"""
...
A custom middleware function is defined in the same way as any other [user-defined function](/docs/reference/query-language/statements/define/function).
