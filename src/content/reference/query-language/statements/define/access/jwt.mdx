...
- You must be authenticated as a [system user](/docs/learn/security/authentication/authentication#system-users) at the same level or higher than the level to which you want to provide JWT access.
