...
A `FOR` loop can also be made out of a [range](/docs/reference/query-language/language-primitives/data-types/ranges) of integers.
...
In this case, the [`array::fold`](/docs/reference/query-language/functions/database-functions/array#arrayfold) and [`array::reduce`](/docs/reference/query-language/functions/database-functions/array#arrayreduce) functions can often be used to accomplish the intended behaviour.
