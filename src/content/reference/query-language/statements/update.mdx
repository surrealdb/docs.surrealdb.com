...
Let's look at some examples of how to use the `UPDATE` statement. First we'll create two `person` records with the [`CREATE`](/docs/reference/query-language/statements/create) statement so that the examples will produce a meaningful output.
