...
* [`ALTER`](/docs/reference/query-language/statements/alter/overview) statements to alter certain resources,
...
* [`IF` and `ELSE`](/docs/reference/query-language/statements/if-else) to describe what to do depending on a condition,
