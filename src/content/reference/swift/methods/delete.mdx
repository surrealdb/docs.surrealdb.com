...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                A [predicate](/docs/reference/swift/concepts/predicates) selecting which records to delete.
            </td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Arguments">
            ...
            <td colspan="2" scope="row" data-label="Description">
                A [`SurrealRecordID`](/docs/reference/swift/data-types#surrealrecordid) to delete a single record.
            </td>
        </tr>
    </tbody>
</table>
