...
You can also resume a session by supplying a token through a [`SessionContext`](/docs/reference/swift/concepts/authentication#resuming-a-session) when constructing the client.
