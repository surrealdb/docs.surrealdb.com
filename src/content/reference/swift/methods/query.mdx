...
Runs a query built with the [query DSL](/docs/reference/swift/concepts/query-dsl), either a query macro such as `#select` or a `SurrealDSL` builder call.
...
For arbitrary SurrealQL, see [`queryRaw`](/docs/reference/swift/methods/query-raw).
