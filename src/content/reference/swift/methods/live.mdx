...
> [!IMPORTANT]
> Live queries require the [WebSocket client](/docs/reference/swift/concepts/connecting#websocket-client).
...
See [Live queries](/docs/reference/swift/concepts/live-queries) for a full walkthrough, and [`kill`](/docs/reference/swift/methods/kill) to stop a subscription.
