...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                A [predicate](/docs/reference/swift/concepts/predicates) restricting which records are returned.
            </td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Arguments">
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                Select a single record by its [`SurrealRecordID`](/docs/reference/swift/data-types#surrealrecordid) instead of a table.
            </td>
        </tr>
    </tbody>
</table>
