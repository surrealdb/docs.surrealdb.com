...
<Boxes>
	<IconBox title="Installation" description="Install the SDK and add it to your project." href="/docs/reference/swift/installation" />
	<IconBox title="Getting started guide" description="Connect to SurrealDB and run your first queries." href="/docs/languages/swift" />
</Boxes>

## Learn

<Boxes>
	<IconBox title="Concepts" description="Guides for connecting, authenticating, querying, and working with data." href="/docs/reference/swift/concepts/connecting" />
	<IconBox title="API Reference" description="Complete reference for the SDK's methods, types, and errors." href="/docs/reference/swift/methods" />
</Boxes>
