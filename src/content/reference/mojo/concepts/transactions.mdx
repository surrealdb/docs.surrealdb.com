...
See the method reference for [`transaction_multi`](/docs/reference/mojo/methods/transaction-multi) and [`begin_transaction`](/docs/reference/mojo/methods/begin-transaction).
