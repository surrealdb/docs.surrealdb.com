...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="2" scope="row">
        <a href="/docs/reference/dotnet/data-types#none">
          <code>None</code>
        </a>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="2" scope="row">
        <a href="/docs/reference/dotnet/data-types#range">
          <code>Range</code>
        </a>
      </td>
    </tr>
    <tr>
      ...
      <td colspan="2" scope="row">
        <a href="/docs/reference/dotnet/data-types#surrealfile">
    ...
    <tr>
      ...
      <td colspan="2" scope="row">
        <a href="/docs/reference/dotnet/data-types#recordid">
          <code>RecordId</code>
        </a>
      </td>
    </tr>
...
File references are returned when working with [file uploads](/docs/reference/query-language/language-primitives/data-types/files) and contain metadata about the stored file.
...
This can be helpful when the `RecordId` is used in a generic context, for when you store the `Id` as an Object or an Array for example.
...
Because the default type of an `Id` in SurrealDB is `string`, you can choose to use the default provided type `RecordIdOfString`.
