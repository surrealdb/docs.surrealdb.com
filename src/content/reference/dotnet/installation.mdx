...
<VersionBlock
  sdk=".net"
  lang="xml"
  code='<PackageReference Include="SurrealDb.Net" Version="{{version}}" />'
/>
...
The de facto initialisation method is to create and [consume a SurrealDbClient created manually](/docs/reference/dotnet/core/create-a-new-connection).
Most .NET projects provide a way to configure services using [Dependency Injection](/docs/reference/dotnet/core/dependency-injection), which is the recommended way to use the SDK in your application.
