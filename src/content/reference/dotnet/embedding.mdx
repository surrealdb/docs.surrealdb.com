...
Due to the [separation of the storage and compute](/docs/learn/data-models/architecture) layers, SurrealDB can be run in embedded mode, from within a number of different language environments.
...
Learn more about [Dependency Injection with SurrealDB in .NET](/docs/reference/dotnet/core/dependency-injection) in the SDK documentation.


Once the memory provider is configured, you can use the .NET SDK the same way you would with a remote database.
Please refer to the [.NET client SDK](/docs/reference/dotnet) documentation to get started with SurrealDB for .NET.
...
Please refer to the [.NET client SDK](/docs/reference/dotnet) documentation to get started.
