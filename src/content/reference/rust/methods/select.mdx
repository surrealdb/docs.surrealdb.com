...
* [Live queries (`select().live()`)](/docs/reference/rust/methods/select-live); alternatively [`query()`](/docs/reference/rust/methods/query#live-select-stream) with `LIVE SELECT` and [`.stream()`](https://docs.rs/surrealdb/latest/surrealdb/struct.IndexedResults.html#method.stream)
