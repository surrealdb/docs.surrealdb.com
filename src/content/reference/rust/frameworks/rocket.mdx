...
You can also use the [Start serving](/docs/explore/surrealist) button on [Surrealist](/docs/explore/surrealist) to do the same if you have it installed locally.
...
With the database running, we will now connect to the database "main" located in the namespace "main". You can connect to it by [creating a connection](/docs/explore/surrealist) inside Surrealist, or by using the following command to start an interactive shell.
