...
- [Getting started](/docs/languages/javascript)
- [Connecting to SurrealDB](/docs/reference/javascript/concepts/connecting-to-surrealdb)
- [Authentication](/docs/reference/javascript/concepts/authentication)
