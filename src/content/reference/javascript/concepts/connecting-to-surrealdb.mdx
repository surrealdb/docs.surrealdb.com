...
When connecting as a [system user](/docs/learn/security/authentication/authentication#system-users) or [token](/docs/learn/security/authentication/authentication#token), you can directly pass your credentials to the `authentication` option.
