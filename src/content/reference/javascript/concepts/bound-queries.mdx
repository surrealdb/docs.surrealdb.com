...
The [expressions API](/docs/reference/javascript/api/utilities/expr) provides functions for building dynamic conditions in a type-safe way. Expressions integrate with both `surql` and query builder methods like `.where()`.
...
- [expr API reference](/docs/reference/javascript/api/utilities/expr) for the full expressions API
- [Executing queries](/docs/reference/javascript/concepts/executing-queries) for running queries against the database
