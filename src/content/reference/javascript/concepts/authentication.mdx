...
SurrealDB supports multiple levels of authentication, from [system users](/docs/learn/security/authentication/users#system-users) to fine-grained [record-level access](/docs/learn/security/authentication/users#record-users). The JavaScript SDK provides methods for signing up and signing in users, managing tokens, and automatically restoring sessions on reconnect.
...
- [Authentication in SurrealDB](/docs/learn/security/authentication/users) for how authentication works at the database level
