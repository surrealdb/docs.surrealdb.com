...
- [Connecting to SurrealDB](/docs/reference/javascript/concepts/connecting-to-surrealdb) for engine configuration
- [Error handling](/docs/reference/javascript/concepts/error-handling) for handling SDK errors
