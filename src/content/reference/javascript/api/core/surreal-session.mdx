...
The `SurrealSession` class represents a scoped contextual session attached to a SurrealDB connection. It provides authentication, session configuration, and inherits all query execution methods from [`SurrealQueryable`](/docs/reference/javascript/api/core/surreal-queryable).
...
**Extends:** [`SurrealQueryable`](/docs/reference/javascript/api/core/surreal-queryable)

**Extended by:** [`Surreal`](/docs/reference/javascript/api/core/surreal)

**Source:** [api/session.ts](https://github.com/surrealdb/surrealdb.js/blob/main/packages/sdk/src/api/session.ts)

## Constructor

The constructor is typically not called directly. Use [`Surreal.newSession()`](/docs/reference/javascript/api/core/surreal#newsession) or [`forkSession()`](#forksession) to create new sessions.
...
**Type:** [`Uuid`](/docs/reference/javascript/api/values/uuid) `| undefined`
...
#### Returns
[`Promise<SurrealSession>`](/docs/reference/javascript/api/core/surreal-session) - A new session instance
...
Call [`commit()`](/docs/reference/javascript/api/core/surreal-transaction#commit) on the transaction to apply changes, or [`cancel()`](/docs/reference/javascript/api/core/surreal-transaction#cancel) to discard them.
...
#### Returns
`Promise<SurrealTransaction>` - A new [`SurrealTransaction`](/docs/reference/javascript/api/core/surreal-transaction) instance
...
> [!NOTE]
> When this method is called, the `authentication` property passed to [`connect()`](/docs/reference/javascript/api/core/surreal#connect) will be ignored. You are responsible for handling session invalidation by listening to the [`auth`](#event-auth) event.
...
As `SurrealSession` extends [`SurrealQueryable`](/docs/reference/javascript/api/core/surreal-queryable), it inherits all query execution methods:
...
- [`liveOf()`](/docs/reference/javascript/api/core/surreal-queryable#liveof) - Subscribe to existing live queries
- [`run()`](/docs/reference/javascript/api/core/surreal-queryable#run) - Execute functions
- [`auth()`](/docs/reference/javascript/api/core/surreal-queryable#auth) - Get authenticated record user
- [`api()`](/docs/reference/javascript/api/core/surreal-queryable#api) - Access user-defined APIs
...
- [Surreal](/docs/reference/javascript/api/core/surreal) - Main connection class
