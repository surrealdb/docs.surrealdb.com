...
SurrealApi allows you to access custom API endpoints defined in your SurrealDB database. The class supports type-safe API definitions, which type-check request and response bodies at compile time.
...
API instances are created through the [`api`](/docs/reference/javascript/api/core/surreal-queryable#api) property on [`Surreal`](/docs/reference/javascript/api/core/surreal), [`SurrealSession`](/docs/reference/javascript/api/core/surreal-session), or [`SurrealTransaction`](/docs/reference/javascript/api/core/surreal-transaction):
...
Configure a header for all requests sent by this API instance. This is useful for setting common headers like authentication tokens or content types.
...
#### Returns
[`ApiPromise<unknown>`](/docs/reference/javascript/api/queries/api-promise) - A promise for the API response
...
#### Returns
[`ApiPromise<void, ResponseBody>`](/docs/reference/javascript/api/queries/api-promise) - A promise for the GET response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/reference/javascript/api/queries/api-promise) - A promise for the POST response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/reference/javascript/api/queries/api-promise) - A promise for the PUT response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/reference/javascript/api/queries/api-promise) - A promise for the DELETE response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/reference/javascript/api/queries/api-promise) - A promise for the PATCH response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/reference/javascript/api/queries/api-promise) - A promise for the TRACE response
...
Always define types for your API paths, so that request and response bodies are type-checked:
...
- [SurrealQueryable.api](/docs/reference/javascript/api/core/surreal-queryable#api) - Creating API instances
- [ApiPromise](/docs/reference/javascript/api/queries/api-promise) - API response handling
- [User-Defined APIs Guide](/docs/reference/query-language/statements/define/api) - Defining APIs in SurrealDB
