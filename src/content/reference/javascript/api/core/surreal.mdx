...
The `Surreal` class is the primary interface for connecting to a SurrealDB instance, managing connections, executing queries, and handling database sessions. It extends [`SurrealSession`](/docs/reference/javascript/api/core/surreal-session) and inherits all session management and query execution capabilities.
...
**Extends:** [`SurrealSession`](/docs/reference/javascript/api/core/surreal-session) → [`SurrealQueryable`](/docs/reference/javascript/api/core/surreal-queryable)
...
The `Surreal` class inherits all properties from [`SurrealSession`](/docs/reference/javascript/api/core/surreal-session), including:
...
#### Returns
`Promise<SurrealSession>` - A new [`SurrealSession`](/docs/reference/javascript/api/core/surreal-session) instance
...
The `Surreal` class also inherits and re-emits events from [`SurrealSession`](/docs/reference/javascript/api/core/surreal-session):
...
As `Surreal` extends [`SurrealSession`](/docs/reference/javascript/api/core/surreal-session), it inherits all authentication and query methods:

### Authentication methods
- [`signup()`](/docs/reference/javascript/api/core/surreal-session#signup) - Sign up a new user
- [`signin()`](/docs/reference/javascript/api/core/surreal-session#signin) - Sign in with credentials
- [`authenticate()`](/docs/reference/javascript/api/core/surreal-session#authenticate) - Authenticate with a token
- [`invalidate()`](/docs/reference/javascript/api/core/surreal-session#invalidate) - Invalidate the session

### Session configuration methods
- [`use()`](/docs/reference/javascript/api/core/surreal-session#use) - Set namespace and database
- [`set()`](/docs/reference/javascript/api/core/surreal-session#set) - Set a session parameter
- [`unset()`](/docs/reference/javascript/api/core/surreal-session#unset) - Remove a session parameter
- [`reset()`](/docs/reference/javascript/api/core/surreal-session#reset) - Reset the session

### Query methods

As `Surreal` extends [`SurrealQueryable`](/docs/reference/javascript/api/core/surreal-queryable) (via `SurrealSession`), it also inherits all query execution methods:

- [`query()`](/docs/reference/javascript/api/core/surreal-queryable#query) - Execute raw SurrealQL
- [`select()`](/docs/reference/javascript/api/core/surreal-queryable#select) - Select records
- [`create()`](/docs/reference/javascript/api/core/surreal-queryable#create) - Create records
- [`insert()`](/docs/reference/javascript/api/core/surreal-queryable#insert) - Insert records
- [`update()`](/docs/reference/javascript/api/core/surreal-queryable#update) - Update records
- [`upsert()`](/docs/reference/javascript/api/core/surreal-queryable#upsert) - Upsert records
- [`delete()`](/docs/reference/javascript/api/core/surreal-queryable#delete) - Delete records
- [`relate()`](/docs/reference/javascript/api/core/surreal-queryable#relate) - Create graph relationships
- [`live()`](/docs/reference/javascript/api/core/surreal-queryable#live) - Subscribe to live queries
- [`run()`](/docs/reference/javascript/api/core/surreal-queryable#run) - Execute functions

### Transaction method
- [`beginTransaction()`](/docs/reference/javascript/api/core/surreal-transaction) - Start a transaction
...
- [SurrealSession](/docs/reference/javascript/api/core/surreal-session) - Session management and authentication
- [SurrealQueryable](/docs/reference/javascript/api/core/surreal-queryable) - Query execution methods
- [SurrealTransaction](/docs/reference/javascript/api/core/surreal-transaction) - Transaction support
- [Node engine](/docs/reference/javascript/engines/node) and [WASM engine](/docs/reference/javascript/engines/wasm) - Engine-specific documentation
- [Data types](/docs/reference/javascript/api/values) - Working with data types
