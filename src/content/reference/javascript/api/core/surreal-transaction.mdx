...
Transactions are created using the [`beginTransaction()`](/docs/reference/javascript/api/core/surreal-session#begintransaction) method on a [`SurrealSession`](/docs/reference/javascript/api/core/surreal-session) instance.
...
The constructor is not called directly. Use [`SurrealSession.beginTransaction()`](/docs/reference/javascript/api/core/surreal-session#begintransaction) to create transactions.
...
As `SurrealTransaction` extends [`SurrealQueryable`](/docs/reference/javascript/api/core/surreal-queryable), it inherits all query execution methods. All queries executed on a transaction instance are part of the transaction scope:
...
- [SurrealSession.beginTransaction()](/docs/reference/javascript/api/core/surreal-session#begintransaction) - Creating transactions
- [SurrealQueryable](/docs/reference/javascript/api/core/surreal-queryable) - Available query methods
