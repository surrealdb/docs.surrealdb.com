...
Thrown on unexpected or unknown internal server errors. Also used as the fallback for unrecognised `kind` strings from newer servers.
...
- [Surreal](/docs/reference/javascript/api/core/surreal) - Connection methods that may throw errors
- [SurrealSession](/docs/reference/javascript/api/core/surreal-session) - Session methods that may throw errors
