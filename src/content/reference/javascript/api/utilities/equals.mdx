...
- [RecordId.equals()](/docs/reference/javascript/api/values/record-id#equals) - RecordId-specific comparison
- [DateTime.equals()](/docs/reference/javascript/api/values/datetime#equals) - DateTime-specific comparison
