...
> [!NOTE: Tip]
> Prefer using [`surql`](/docs/reference/javascript/api/utilities/surql) or [`BoundQuery`](/docs/reference/javascript/api/utilities/bound-query) for automatic parameterisation. Use escape functions only when absolutely necessary.
...
- **For values:** Use [`surql`](/docs/reference/javascript/api/utilities/surql) or [`BoundQuery`](/docs/reference/javascript/api/utilities/bound-query)
- **For tables:** Use [`Table`](/docs/reference/javascript/api/values/table) class
- **For record IDs:** Use [`RecordId`](/docs/reference/javascript/api/values/record-id) class
- **For conditions:** Use [`expr`](/docs/reference/javascript/api/utilities/expr)
...
> [!WARNING]
> Escaping functions are NOT a complete defence against SQL injection. Always prefer parameterised queries using `surql` or `BoundQuery`.
...
- [surql](/docs/reference/javascript/api/utilities/surql) - Recommended for parameterised queries
- [BoundQuery](/docs/reference/javascript/api/utilities/bound-query) - Parameterised query class
- [Table](/docs/reference/javascript/api/values/table) - Type-safe table references
- [RecordId](/docs/reference/javascript/api/values/record-id) - Type-safe record identifiers
