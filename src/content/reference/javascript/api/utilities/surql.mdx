...
- [expr](/docs/reference/javascript/api/utilities/expr) - Expression builder
- [Query](/docs/reference/javascript/api/queries/query) - Executing queries
- [SurrealQueryable.query()](/docs/reference/javascript/api/core/surreal-queryable#query) - Query method
