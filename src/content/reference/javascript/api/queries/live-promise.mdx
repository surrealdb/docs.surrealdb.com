...
**Returned by:** [`SurrealQueryable.live()`](/docs/reference/javascript/api/core/surreal-queryable#live), [`SurrealQueryable.liveOf()`](/docs/reference/javascript/api/core/surreal-queryable#liveof)
...
**Returned by:** [`SurrealQueryable.live()`](/docs/reference/javascript/api/core/surreal-queryable#live)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Condition expression to filter updates (string or <a href="/docs/reference/javascript/api/utilities/expr">Expression</a> object).</td>
        </tr>
    </tbody>
</table>
...
**Returned by:** [`SurrealQueryable.liveOf()`](/docs/reference/javascript/api/core/surreal-queryable#liveof)
...
- [SurrealQueryable.live()](/docs/reference/javascript/api/core/surreal-queryable#live) - Create managed live subscription
- [SurrealQueryable.liveOf()](/docs/reference/javascript/api/core/surreal-queryable#liveof) - Subscribe to existing live query
