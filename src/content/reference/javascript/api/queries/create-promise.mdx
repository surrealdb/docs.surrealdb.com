...
**Returned by:** [`SurrealQueryable.create()`](/docs/reference/javascript/api/core/surreal-queryable#create)
...
- [SurrealQueryable.create()](/docs/reference/javascript/api/core/surreal-queryable#create) - Method that returns CreatePromise
- [InsertPromise](/docs/reference/javascript/api/queries/insert-promise) - Bulk insertion
- [UpsertPromise](/docs/reference/javascript/api/queries/upsert-promise) - Insert or replace
