...
**Returned by:** [`SurrealQueryable.relate()`](/docs/reference/javascript/api/core/surreal-queryable#relate)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/reference/javascript/api/values/datetime">DateTime</a></code></td>
...
As of SurrealDB 3.1.5, when the edge ID already exists, `INSERT RELATION` returns an error unless you use `ON DUPLICATE KEY UPDATE`. See [Explicit edge record IDs](/docs/reference/query-language/statements/relate#handling-duplicate-edge-record-ids) for more details.

## See also

- [SurrealQueryable.relate()](/docs/reference/javascript/api/core/surreal-queryable#relate) - Method that returns RelatePromise
- [Graph relationships](/docs/reference/query-language/statements/relate) - SurrealQL RELATE documentation
- [RecordId](/docs/reference/javascript/api/values#custom-data-type-classes) - Record identifier type
