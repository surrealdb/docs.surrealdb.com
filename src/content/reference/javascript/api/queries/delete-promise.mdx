...
**Returned by:** [`SurrealQueryable.delete()`](/docs/reference/javascript/api/core/surreal-queryable#delete)
...
> [!NOTE: Tip]
> For conditional deletions, use [`db.query()`](/docs/reference/javascript/api/core/surreal-queryable#query) with a DELETE statement including a WHERE clause.
...
- [SurrealQueryable.delete()](/docs/reference/javascript/api/core/surreal-queryable#delete) - Method that returns DeletePromise
- [UpdatePromise](/docs/reference/javascript/api/queries/update-promise) - Update records
- [Query](/docs/reference/javascript/api/queries/query) - Raw SurrealQL for conditional deletes
