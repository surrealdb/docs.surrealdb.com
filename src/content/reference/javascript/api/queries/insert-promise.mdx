...
**Returned by:** [`SurrealQueryable.insert()`](/docs/reference/javascript/api/core/surreal-queryable#insert)
...
- [SurrealQueryable.insert()](/docs/reference/javascript/api/core/surreal-queryable#insert) - Method that returns InsertPromise
- [CreatePromise](/docs/reference/javascript/api/queries/create-promise) - Single record creation
