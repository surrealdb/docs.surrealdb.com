...
**Returned by:** [`SurrealQueryable.select()`](/docs/reference/javascript/api/core/surreal-queryable#select)
...
- [SurrealQueryable.select()](/docs/reference/javascript/api/core/surreal-queryable#select) - Method that returns SelectPromise
- [Query overview](/docs/reference/javascript/api/queries/) - All query builder classes
- [Expression builders](/docs/reference/javascript/api/utilities/#expr) - Building complex conditions
