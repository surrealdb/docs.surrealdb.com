...
**Returned by:** Methods on [`SurrealApi`](/docs/reference/javascript/api/core/surreal-api)
...
- [SurrealApi](/docs/reference/javascript/api/core/surreal-api) - API instance methods
