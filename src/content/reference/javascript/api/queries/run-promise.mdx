...
**Returned by:** [`SurrealQueryable.run()`](/docs/reference/javascript/api/core/surreal-queryable#run)
...
- [SurrealQueryable.run()](/docs/reference/javascript/api/core/surreal-queryable#run) - Method that returns RunPromise
