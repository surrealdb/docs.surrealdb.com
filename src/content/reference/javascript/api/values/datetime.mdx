...
#### Returns
[`Duration`](/docs/reference/javascript/api/values/duration) - Duration between the two datetimes
...
- [Duration](/docs/reference/javascript/api/values/duration) - Time duration values
