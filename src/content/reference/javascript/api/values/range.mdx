...
- **Score Categorisation** - Categorise by score ranges (grades, ratings)
- **Geographic Bounds** - Coordinate ranges for maps

## See also

- [RecordIdRange](/docs/reference/javascript/api/values/record-id#recordidrange) - Range of record IDs
- [DateTime](/docs/reference/javascript/api/values/datetime) - Datetime values for date ranges
- [Decimal](/docs/reference/javascript/api/values/decimal) - Precise numbers for price ranges
