...
- [Getting started](/docs/languages/kotlin) for a complete working example
- [Connecting to SurrealDB](/docs/reference/kotlin/concepts/connecting-to-surrealdb) for connection options and protocols
- [Authentication](/docs/reference/kotlin/concepts/authentication) for signing in and managing credentials
