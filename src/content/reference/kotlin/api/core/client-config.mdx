...
`SurrealClientConfig` configures a [`SurrealClient`](/docs/reference/kotlin/api/core/surreal-client). The only required field is `url`; everything else has a sensible default.
...
- [Authentication](/docs/reference/kotlin/concepts/authentication)
