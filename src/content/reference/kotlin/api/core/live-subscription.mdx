...
`LiveQuerySubscription` is returned by [`.live()`](/docs/reference/kotlin/api/core/surreal-client#live). It exposes a coroutine [`Flow`](https://kotlinlang.org/api/kotlinx.coroutines/kotlinx-coroutines-core/kotlinx.coroutines.flow/-flow/) of notifications and a method to stop the subscription. See [Live queries](/docs/reference/kotlin/concepts/live-queries) for the concept.
...
- [Live queries](/docs/reference/kotlin/concepts/live-queries)
