...
`Session` satisfies the [`sendable`](/docs/reference/golang/api/types#sendable) constraint, so all generic functions like [`Query`](/docs/reference/golang/api/core/db#query), [`Select`](/docs/reference/golang/api/core/db#select), [`Create`](/docs/reference/golang/api/core/db#create), etc. accept `*Session` directly.
...
Returns [`ErrSessionClosed`](/docs/reference/golang/api/errors#sentinel-errors) if the session has already been detached.
...
**Returns:** [`(*Tokens, error)`](/docs/reference/golang/api/types#tokens)
...
**Returns:** [`(*VersionData, error)`](/docs/reference/golang/api/types#versiondata)
...
- [DB](/docs/reference/golang/api/core/db) for the main client reference
- [Transaction](/docs/reference/golang/api/core/transaction) for session-scoped transactions
- [Multiple sessions](/docs/reference/golang/concepts/multiple-sessions) for session usage patterns
- [Errors](/docs/reference/golang/api/errors) for `ErrSessionClosed` and `ErrSessionsNotSupported`
