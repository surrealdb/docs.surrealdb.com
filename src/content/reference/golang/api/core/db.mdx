...
The `DB` struct is the main client for interacting with SurrealDB. It holds the underlying connection and provides methods for [authentication](/docs/reference/golang/concepts/authentication), namespace selection, and [live query](/docs/reference/golang/concepts/live-queries) management. Data operations are performed through generic top-level functions that accept `*DB` as a parameter.
...
**Returns:** `(*VersionData, error)`, see [`VersionData`](/docs/reference/golang/api/types#versiondata)
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><code>any</code></td>
            <td>An <a href="/docs/reference/golang/api/types#auth"><code>Auth</code></a> struct or <code>map[string]any</code> with credentials.</td>
        </tr>
    </tbody>
</table>
...
**Returns:** `(*Tokens, error)` - see [`Tokens`](/docs/reference/golang/api/types#tokens)
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><code>authData</code> <Label label="required" /></td>
            <td><code>any</code></td>
            <td>An <a href="/docs/reference/golang/api/types#auth"><code>Auth</code></a> struct or <code>map[string]any</code> with signup credentials.</td>
        </tr>
    </tbody>
</table>
...
**Returns:** `(*Session, error)` - see [`Session`](/docs/reference/golang/api/core/session)
...
**Returns:** `(*Transaction, error)` - see [`Transaction`](/docs/reference/golang/api/core/transaction)

---

## Query functions

These are top-level generic functions that accept [`*DB`](#constructors), [`*Session`](/docs/reference/golang/api/core/session), or [`*Transaction`](/docs/reference/golang/api/core/transaction) as the `s` parameter.
...
**Returns:** `(*[]QueryResult[TResult], error)` - see [`QueryResult`](/docs/reference/golang/api/types#queryresult)
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>A pointer to a slice of <a href="/docs/reference/golang/api/types#querystmt"><code>QueryStmt</code></a> objects. Results are written back to each statement.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><code>string |</code> <a href="/docs/reference/golang/api/values/table"><code>Table</code></a> <code>|</code> <a href="/docs/reference/golang/api/values/record-id"><code>RecordID</code></a></td>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="/docs/reference/golang/api/values/table"><code>models.Table</code></a></td>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>JSON Patch operations. See <a href="/docs/reference/golang/api/types#patchdata"><code>PatchData</code></a>.</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>The relationship to create. See <a href="/docs/reference/golang/api/types#relationship"><code>Relationship</code></a>.</td>
        </tr>
    </tbody>
</table>
...
**Returns:** [`(*models.UUID, error)`](/docs/reference/golang/api/values/uuid)
...
**Returns:** `(chan` [`connection.Notification`](/docs/reference/golang/api/types#notification)`, error)`
...
- [Session](/docs/reference/golang/api/core/session) for session management reference
- [Transaction](/docs/reference/golang/api/core/transaction) for transaction reference
- [Types](/docs/reference/golang/api/types) for type definitions used by these methods
- [Errors](/docs/reference/golang/api/errors) for error types
- [Connecting to SurrealDB](/docs/reference/golang/concepts/connecting-to-surrealdb) for connection patterns
