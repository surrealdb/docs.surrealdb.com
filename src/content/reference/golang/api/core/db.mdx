...
These are top-level generic functions that accept [`*DB`](#db), [`*Session`](/docs/reference/golang/api/core/session), or [`*Transaction`](/docs/reference/golang/api/core/transaction) as the `s` parameter.
