...
- [Live queries](/docs/reference/golang/concepts/live-queries) for live query UUIDs
- [Session](/docs/reference/golang/api/core/session#id) for session UUIDs
- [Transaction](/docs/reference/golang/api/core/transaction#id) for transaction UUIDs
- [Value types](/docs/reference/golang/concepts/value-types) for the full type mapping
