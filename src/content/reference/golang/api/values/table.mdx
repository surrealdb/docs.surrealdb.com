...
- [RecordID](/docs/reference/golang/api/values/record-id) for targeting specific records
- [Data manipulation](/docs/reference/golang/concepts/data-manipulation) for using tables in CRUD operations
