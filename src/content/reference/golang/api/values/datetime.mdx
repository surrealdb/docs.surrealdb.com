...
- [Duration](/docs/reference/golang/api/values/duration) for the duration type
- [Value types](/docs/reference/golang/concepts/value-types) for the full type mapping
- [Data manipulation](/docs/reference/golang/concepts/data-manipulation) for using datetime values in CRUD operations
