...
- [RecordID](/docs/reference/golang/api/values/record-id) for the record identifier type
- [CustomDateTime](/docs/reference/golang/api/values/datetime) for the datetime type
- [Value types](/docs/reference/golang/concepts/value-types) for the full type mapping
- [Data manipulation](/docs/reference/golang/concepts/data-manipulation) for using duration values in CRUD operations
