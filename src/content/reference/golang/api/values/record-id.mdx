...
- [Table](/docs/reference/golang/api/values/table) for the table name type
- [Value types](/docs/reference/golang/concepts/value-types) for the full type mapping
- [Data manipulation](/docs/reference/golang/concepts/data-manipulation) for using record IDs in CRUD operations
