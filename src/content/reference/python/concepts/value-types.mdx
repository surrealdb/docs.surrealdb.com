...
A [`Datetime`](/docs/reference/python/api/values/datetime) wraps an ISO 8601 datetime string for use with SurrealDB's `datetime` type. It preserves the original string representation through serialisation and deserialisation.
