...
- [Authentication](/docs/reference/python/concepts/authentication) for auth-related error patterns
- [Connecting to SurrealDB](/docs/reference/python/concepts/connecting-to-surrealdb) for connection error patterns
