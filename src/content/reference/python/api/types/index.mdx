...
When a `str` is passed, it is treated as a table name. Pass a [`RecordID`](/docs/reference/python/api/values/record-id) for specific record targeting, or a [`Table`](/docs/reference/python/api/values/table) for explicit table references.
...
- [Surreal API reference](/docs/reference/python/api/core/surreal) for methods using these types
