...
- [Error handling concept](/docs/reference/python/concepts/error-handling) for patterns and best practices
- [Surreal API reference](/docs/reference/python/api/core/surreal) for methods that may throw errors
