...
- [Getting started](/docs/languages/python) for a complete working example
- [Connecting to SurrealDB](/docs/reference/python/concepts/connecting-to-surrealdb) for connection options and protocols
- [Authentication](/docs/reference/python/concepts/authentication) for signing in and managing credentials
