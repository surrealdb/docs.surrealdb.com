...
| `UUID`                                                  | `uuid`                                                                                                        | `java.util`                              |
| `byte[]`                                                | `bytes`                                                                                                       |                                          |
| `Instant`                                               | [`datetime`](/docs/reference/query-language/language-primitives/data-types/datetimes)                         | `java.time`                              |
| `ZonedDateTime`                                         | [`datetime`](/docs/reference/query-language/language-primitives/data-types/datetimes)                         | `java.time`                              |
| `OffsetDateTime`                                        | [`datetime`](/docs/reference/query-language/language-primitives/data-types/datetimes)                         | `java.time`                              |
| `LocalDateTime`                                         | [`datetime`](/docs/reference/query-language/language-primitives/data-types/datetimes)                         | `java.time`                              |
| `java.util.Date`                                        | [`datetime`](/docs/reference/query-language/language-primitives/data-types/datetimes)                         | `java.time`                              |
...
| [`RecordId`](/docs/reference/java/api/values/record-id) | [`record`](/docs/reference/query-language/language-primitives/data-types/record-ids)                          | SDK class                                |
| [`Geometry`](/docs/reference/java/api/values/geometry)  | [`geometry`](/docs/reference/query-language/language-primitives/data-types/geometries)                        | SDK class                                |
| [`FileRef`](/docs/reference/java/api/values/file-ref)   | [`file`](/docs/reference/query-language/language-primitives/data-types/files)                                 | SDK class                                |

See [Value types](/docs/reference/java/concepts/value-types) for the complete type mapping reference.
...
SurrealDB [`datetime`](/docs/reference/query-language/language-primitives/data-types/datetimes) values represent an absolute point in time. When serialising Java objects, the SDK accepts `Instant`, `ZonedDateTime`, `OffsetDateTime`, `LocalDateTime`, and `java.util.Date` fields. When deserialising SurrealDB `datetime` values back into POJOs, the same types are supported; `ZonedDateTime` is the usual choice when you need the stored instant with its offset.
...
[`duration`](/docs/reference/query-language/language-primitives/data-types/datetimes#durations-and-datetimes) fields map to `java.time.Duration` in your POJOs.
...
Graph edges created with [`.relate()`](/docs/reference/java/api/core/surreal#relate) or [`.insertRelation()`](/docs/reference/java/api/core/surreal#insert-relation) use specialized base classes that include the standard relation fields (`id`, `in`, `out`).

### Using `Relation`

Extend [`Relation`](/docs/reference/java/api/types#relation) when reading or creating edges with `.relate()`. The base class provides `id`, `in`, and `out` as `RecordId` fields.
...
Extend [`InsertRelation`](/docs/reference/java/api/types#insert-relation) when inserting edges with `.insertRelation()`. The base class provides `id` as an [`Id`](/docs/reference/java/api/values/record-id#id) and `in` / `out` as `RecordId` fields.
  ...
  <tbody>
    <tr>
      <td scope="row" data-label="Method">
        <a href="/docs/reference/java/api/core/surreal#select">
    ...
    <tr>
      <td scope="row" data-label="Method">
        <a href="/docs/reference/java/api/core/surreal#create">
    ...
    <tr>
      <td scope="row" data-label="Method">
        <a href="/docs/reference/java/api/core/surreal#insert">
    ...
    <tr>
      <td scope="row" data-label="Method">
        <a href="/docs/reference/java/api/core/surreal#update">
    ...
    <tr>
      <td scope="row" data-label="Method">
        <a href="/docs/reference/java/api/core/surreal#upsert">
    ...
    <tr>
      <td scope="row" data-label="Method">
        <a href="/docs/reference/java/api/core/surreal#relate">
    ...
    <tr>
      <td scope="row" data-label="Method">
        <a href="/docs/reference/java/api/core/response#take">
    ...
    <tr>
      <td scope="row" data-label="Method">
        <a href="/docs/reference/java/api/values/value#get">
    ...
    <tr>
      <td scope="row" data-label="Method">
        <a href="/docs/reference/java/api/values/value#array-typed-iterator">
...
When the SDK cannot convert a value to the target class - for example, because a field type is incompatible or the class is missing a no-argument constructor - it throws a [`SerializationException`](/docs/reference/java/api/errors#serialization-exception). You can catch this specifically or handle it as part of the general [`SurrealException`](/docs/reference/java/api/errors) hierarchy.
...
See [Error handling](/docs/reference/java/concepts/error-handling) for more on the exception hierarchy.

## Learn more

- [Value types](/docs/reference/java/concepts/value-types) for the complete SurrealDB-to-Java type mapping
- [Data manipulation](/docs/reference/java/concepts/data-manipulation) for using converted types with CRUD operations
- [Value API reference](/docs/reference/java/api/values/value) for the `Value.get(Class)` method
- [Response API reference](/docs/reference/java/api/core/response) for typed response extraction
- [Java Types reference](/docs/reference/java/api/types) for `Relation`, `InsertRelation`, and other SDK types
- [Error handling](/docs/reference/java/concepts/error-handling) for serialisation error details
