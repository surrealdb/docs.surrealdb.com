...
SurrealDB [`datetime`](/docs/reference/query-language/language-primitives/data-types/datetimes) values map to Java's `java.time.ZonedDateTime`. The SDK handles conversion automatically when deserializing query results into [`Value`](/docs/reference/java/api/values/value) objects or POJOs.
...
- [Value](/docs/reference/java/api/values/value) — The Value class reference
