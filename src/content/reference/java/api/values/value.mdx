...
| `getGeometry()` | [`Geometry`](/docs/reference/java/api/values/geometry) |
| `getDateTime()` | `ZonedDateTime` |
| `getDuration()` | `Duration` |
| `getBytes()` | `byte[]` |
| `getRecordId()` | [`RecordId`](/docs/reference/java/api/values/record-id) |
| `getFile()` | [`FileRef`](/docs/reference/java/api/values/file-ref) |
...
- [Value types](/docs/reference/java/concepts/value-types) — Type mapping overview
- [RecordId](/docs/reference/java/api/values/record-id) — Record identifiers
- [SurrealQL data model](/docs/reference/query-language/language-primitives/data-types) — SurrealDB data types and structures
