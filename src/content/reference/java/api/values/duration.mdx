...
SurrealDB [`duration`](/docs/reference/query-language/language-primitives/data-types/datetimes#durations-and-datetimes) values map to Java's `java.time.Duration`. The SDK handles conversion automatically when deserialising query results into [`Value`](/docs/reference/java/api/values/value) objects or POJOs.
