...
- [Executing queries](/docs/reference/java/concepts/executing-queries), Query concepts and patterns
- [Value types](/docs/reference/java/concepts/value-types), Working with the Value class
