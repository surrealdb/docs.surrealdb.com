...
**Returns:** [`Response`](/docs/reference/java/api/core/response)
...
**Returns:** [`LiveStream`](/docs/reference/java/api/core/live-stream)
...
**Returns:** [`Transaction`](/docs/reference/java/api/core/transaction)
...
- [Transaction](/docs/reference/java/api/core/transaction) — Transaction reference
- [Response](/docs/reference/java/api/core/response) — Query response reference
- [LiveStream](/docs/reference/java/api/core/live-stream) — Live query reference
- [Connecting to SurrealDB](/docs/reference/java/concepts/connecting-to-surrealdb) — Connection protocols and patterns
- [Authentication](/docs/reference/java/concepts/authentication) — Authentication concepts
