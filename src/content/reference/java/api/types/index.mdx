...
The SDK provides several supporting types for authentication, update operations, and relation modeling. These types are used as parameters to methods on the [`Surreal`](/docs/reference/java/api/core/surreal) class.
