...
| [`POST /gql`](/docs/reference/rest-api/http-protocol#gql) | HTTP | ISO GQL (Cypher Query Language) | `curl`, HTTP clients |
...
- [GQL overview](/docs/learn/querying/gql/overview): ISO GQL (Cypher Query Language) concepts and wire surfaces
