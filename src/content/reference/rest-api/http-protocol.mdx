...
The [local database serving](/docs/explore/surrealist/concepts/local-database-serving) functionality on the Surrealist UI can also be used to start a server.
