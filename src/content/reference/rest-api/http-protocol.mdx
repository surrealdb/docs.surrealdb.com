...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td scope="row" data-label="Description">Runs read-only ISO GQL graph pattern queries (`MATCH … RETURN`)</td>
        </tr>
        <tr>
...
The GQL endpoint runs **read-only** [ISO GQL](/docs/learn/querying/gql/overview) graph pattern queries (`MATCH … RETURN …`) against your existing tables and `RELATE` edges.
