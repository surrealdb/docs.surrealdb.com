...
The following example will work as long as as an access method has been defined and a record user has been signed up using the [`/signup`](/docs/reference/rest-api/http-protocol#signup) endpoint.
