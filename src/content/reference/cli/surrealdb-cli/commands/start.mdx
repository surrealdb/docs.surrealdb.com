...
> [!NOTE]
> If using SurrealDB Cloud, capabilities can be set using the [Configure Instance](/docs/build/deployment/surrealdb-cloud/getting-started/create-an-instance#configure-an-instance) panel on Surrealist.
