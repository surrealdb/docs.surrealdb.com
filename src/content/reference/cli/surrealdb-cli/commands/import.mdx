...
> [!NOTE]
> If you are using Surrealist, you can import files into your database by using the `Import database` button in the Explorer view. See the [Surrealist documentation](/docs/explore/surrealist) for more information.
