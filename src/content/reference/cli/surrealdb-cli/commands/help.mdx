...
> [!NOTE]
> The pasted output above predates SurrealDB 3.1.0 and so does not list [`surreal mcp`](/docs/reference/cli/surrealdb-cli/commands/mcp). For the current list of subcommands, see [CLI commands](/docs/reference/cli/surrealdb-cli/commands).
