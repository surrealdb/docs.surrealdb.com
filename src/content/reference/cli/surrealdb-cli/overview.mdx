...
> [!IMPORTANT]
> Before using the CLI, you will need to [install SurrealDB](/docs/self-hosted/installation). To experiment with SurrealDB before installing, see the [Surrealist sandbox](https://app.surrealdb.com/).
