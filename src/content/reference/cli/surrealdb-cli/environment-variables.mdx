...
<tr>
    ...
    <tr>
      ...
      <td scope="row" data-label="Default">none</td>
      <td scope="row" data-label="Allowed values">A duration</td>
      <td scope="row" data-label="Notes">The maximum duration that a batch of statements can run for.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td scope="row" data-label="Env var"><code>SURREAL_STARTUP_OPERATION_TIMEOUT</code><Since v="v3.3.0" /></td>
