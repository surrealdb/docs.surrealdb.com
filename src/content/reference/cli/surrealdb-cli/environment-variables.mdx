...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Env var"><code>SURREAL_SURREALISM_LOG_LEVEL</code><Since v="v3.0.6" /></td>
...
Many of the arguments passed into [the CLI](/docs/reference/cli/surrealdb-cli/start) can be set using the above environment variables instead.
