...
> [!IMPORTANT] These lists are **global**. What an organisation may actually deploy is narrower, and [`org plans`](/docs/reference/cli/surrealctl/commands/org#org-plans) is the organisation-scoped answer — the one to trust before a create.
