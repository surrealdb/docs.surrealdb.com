...
The `surreal binary` check reports which copy is in use and does not offer to download one; a diagnostic should not fetch a binary. See [the `surreal` handoff](/docs/manage/surrealctl/install#the-surreal-handoff).
...
See [Installation](/docs/manage/surrealctl/install#shell-completion) for where each shell expects the file to live.
...
- [Installation](/docs/manage/surrealctl/install) — completion setup and the `surreal` handoff
