...
This lists what a token *can* be granted. [`auth scopes`](/docs/reference/cli/surrealctl/commands/auth#auth-scopes) lists what the credential in hand actually carries.
