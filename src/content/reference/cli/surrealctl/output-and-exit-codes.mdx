...
`not_available` is worth calling out: it is HTTP 501, and it means nothing is broken — the feature is simply not enabled here. Every [Spectron](/docs/reference/cli/surrealctl/commands/spectron) route answers this way on a deployment without Spectron.
