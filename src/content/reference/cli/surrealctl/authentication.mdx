...
Two commands answer two different questions. [`token scopes`](/docs/reference/cli/surrealctl/commands/token#token-scopes) is the catalogue of what *can* be granted; [`auth scopes`](/docs/reference/cli/surrealctl/commands/auth#auth-scopes) is what the credential in hand *carries*.
