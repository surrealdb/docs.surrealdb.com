...
> [!WARNING] `instance create` has no idempotency key, because the API's create route accepts none. A retried create is a second instance and a second bill. If a create times out, run [`instance list`](/docs/reference/cli/surrealctl/commands/instance#instance-list) before running it again.
