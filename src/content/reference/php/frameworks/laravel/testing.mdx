...
- [Container and facades](/docs/reference/php/frameworks/laravel/container-and-facades) for the facade testing helpers
- [Queries and transactions](/docs/reference/php/frameworks/laravel/queries-and-transactions) for the queries under test
- [Surqlize connections](/docs/reference/php/ecosystem/surqlize/connections) for executor injection
