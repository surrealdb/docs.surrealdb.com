...
The integration adds two Artisan commands for managing your [Surqlize schema](/docs/reference/php/libraries/surqlize/schema). Both read the model list from `config('surqlize.models')`.
...
- [Schema](/docs/reference/php/libraries/surqlize/schema) for defining tables and fields
- [Configuration](/docs/reference/php/frameworks/laravel/configuration#orm-configuration) for the model list
- [Surqlize CLI](/docs/reference/php/libraries/surqlize/code-generation-and-cli) for the framework-agnostic commands
