...
Define [Surqlize models](/docs/reference/php/libraries/surqlize/models) and query them directly. They run through the Laravel-managed connection.
...
See [Querying](/docs/reference/php/libraries/surqlize/querying) and [Mutations](/docs/reference/php/libraries/surqlize/mutations) for the full model API.
...
- [Surqlize transactions](/docs/reference/php/libraries/surqlize/transactions) for the batching mechanism
