...
If you haven't defined a scope for your database, you can define a scope by querying the database using the [`query`](/docs/reference/php/v1/methods/query) method.
