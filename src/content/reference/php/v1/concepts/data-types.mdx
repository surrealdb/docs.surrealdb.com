...
Used to check if geometry X is exactly equal to geometry Y
...
A [point](/docs/reference/query-language/language-primitives/data-types/geometries#point) in space, made up of a long and lat coordinate, automatically converted to a float.
