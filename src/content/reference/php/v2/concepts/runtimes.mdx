...
See [Observability](/docs/reference/php/v2/concepts/observability#runtime-presets) for the full setup and options.
...
> [!NOTE]
> For Laravel applications, [Laravel Octane](https://laravel.com/docs/octane) runs your app on Swoole, FrankenPHP, or RoadRunner with a configurable `--workers` count. See the [Laravel integration](/docs/reference/php/frameworks/laravel).

## Learn more

- [Live queries](/docs/reference/php/v2/concepts/live-queries) for the subscription API
- [Connecting to SurrealDB](/docs/reference/php/v2/concepts/connecting-to-surrealdb) for connection setup
- [Utilities](/docs/reference/php/v2/api/utilities#driveroptions) for the `DriverOptions` the presets configure
