...
An uncomputed SurrealQL [future](/docs/reference/query-language/language-primitives/data-types/futures), such as `<future> { ... }`. The body is the SurrealQL expression to evaluate.
...
- [Data types concept](/docs/reference/php/v2/concepts/data-types) for the type mapping and guidance
