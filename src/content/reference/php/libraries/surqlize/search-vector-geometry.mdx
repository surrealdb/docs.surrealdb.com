...
- [Models](/docs/reference/php/libraries/surqlize/models) for the `#[Search]`, `#[Vector]`, and `#[Geometry]` attributes
- [Schema](/docs/reference/php/libraries/surqlize/schema) to define search analysers and vector indexes
- [Querying](/docs/reference/php/libraries/surqlize/querying) for the query builder these helpers plug into
