...
- [Models](/docs/reference/php/ecosystem/surqlize/models) for the `#[Search]`, `#[Vector]`, and `#[Geometry]` attributes
- [Schema](/docs/reference/php/ecosystem/surqlize/schema) to define search analysers and vector indexes
- [Querying](/docs/reference/php/ecosystem/surqlize/querying) for the query builder these helpers plug into
