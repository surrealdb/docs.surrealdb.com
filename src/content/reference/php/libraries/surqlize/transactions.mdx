...
- [Connections](/docs/reference/php/libraries/surqlize/connections) for executor injection
- [Mutations](/docs/reference/php/libraries/surqlize/mutations) for the queries you batch
