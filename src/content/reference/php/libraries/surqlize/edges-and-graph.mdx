...
- [Models](/docs/reference/php/ecosystem/surqlize/models) for the `#[Edge]` attribute
- [Schema](/docs/reference/php/ecosystem/surqlize/schema) to define the relation table
