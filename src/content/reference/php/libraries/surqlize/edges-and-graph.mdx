...
- [Models](/docs/reference/php/libraries/surqlize/models) for the `#[Edge]` attribute
- [Schema](/docs/reference/php/libraries/surqlize/schema) to define the relation table
