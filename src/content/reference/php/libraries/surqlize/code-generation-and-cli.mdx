...
Applies the [schema](/docs/reference/php/libraries/surqlize/schema) definitions for the configured models through the configured executor.
...
- [Querying](/docs/reference/php/libraries/surqlize/querying) for the typed callbacks adapters support
- [Schema](/docs/reference/php/libraries/surqlize/schema) for the definitions `schema:apply` runs
