...
Applies the [schema](/docs/reference/php/ecosystem/surqlize/schema) definitions for the configured models through the configured executor.
...
- [Querying](/docs/reference/php/ecosystem/surqlize/querying) for the typed callbacks adapters support
- [Schema](/docs/reference/php/ecosystem/surqlize/schema) for the definitions `schema:apply` runs
- [Laravel integration](/docs/reference/php/frameworks/laravel/schema-commands) for the Artisan schema commands
