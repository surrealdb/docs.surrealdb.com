...
Surqlize builds a `SELECT` as a typed query object. You start it from a model, refine it with chained methods, and either compile it to a SurrealQL string or execute it through the [SDK executor](/docs/reference/php/ecosystem/surqlize/connections).
...
- [Mutations](/docs/reference/php/ecosystem/surqlize/mutations) for create, update, and delete
- [Edges and graph](/docs/reference/php/ecosystem/surqlize/edges-and-graph) for graph traversal in a select
- [Search, vector, and geometry](/docs/reference/php/ecosystem/surqlize/search-vector-geometry) for specialised field helpers
