...
4. Launch your web browser on the generated url (eg. [http://localhost:5173/](http://localhost:5173/)) and play with the app: create new accounts, join rooms, leave rooms, etc..
