...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description"><Since v="v3.0.0-alpha.7" /> Performs weighted linear search</td>
    </tr>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description"><Since v="v3.0.0-alpha.7" /> Performs RRF (reciprocal rank fusion) search</td>
    </tr>
    <tr>
...
[
	{
		distance: 0.0034969844824588314f,
		ft_score: 0.5366538763046265f,
		id: test:1,
		linear_score: 2
	},
	{
		distance: 0.056393806565797844f,
		id: test:3,
		linear_score: 0
	}
]
