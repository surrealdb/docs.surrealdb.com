...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description"><Since v="v3.0.0-beta" /> Performs weighted linear search</td>
    </tr>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description"><Since v="v3.0.0-beta" /> Performs RRF (reciprocal rank fusion) search</td>
    </tr>
    <tr>
