...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#objectfrom_entries"><code>object::from\_entries()</code></a></td>
      <td scope="row" data-label="Description">Transforms an array with arrays of key-value combinations into an object.</td>
    </tr>

    <tr>
      <td scope="row" data-label="Function"><a href="#objectis_empty"><code>object::is\_empty()</code></a></td>
