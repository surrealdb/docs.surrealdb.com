...
<img src="~/assets/img/image/light/geo-wyoming.avif" darkSrc="~/assets/img/image/dark/geo-wyoming.avif" alt="A map of Wyoming in the United States with four approximate points on each corner used to approximate its total surface area in SurrealDB's geo area function." />
...
<img src="~/assets/img/image/light/geo-bearing.avif" darkSrc="~/assets/img/image/dark/geo-bearing.avif" alt="A circle showing how bearing is defined from 0 degrees to 360 degrees." />
...
<img src="~/assets/img/image/light/geo-paris.avif" darkSrc="~/assets/img/image/dark/geo-paris.avif" alt="A map showing the path from Paris, the capital of France, to a French town called Le Puy En Velay. The bearing is south southeast." />
...
<img src="~/assets/img/image/light/geo-centroid.avif" darkSrc="~/assets/img/image/dark/geo-centroid.avif" alt="A map showing the centroid between four points in Europe: London, Kyiv, Sofia, and Barcelona. The centroid itself is located in Austria." />
...
<img src="~/assets/img/image/light/geo-london.avif" darkSrc="~/assets/img/image/dark/geo-london.avif" alt="A map showing the distance in a straight line from London, the capital of the United Kingdom, to Harare, the capital of Zimbabwe" />
