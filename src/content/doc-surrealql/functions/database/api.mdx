...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#apireqmax_body"><code>api::req::max\_body()</code></a></td>
      <td scope="row" data-label="Description">Sets the maximum body size in bytes for requests made to a defined API endpoint</td>
    </tr>

    <tr>
      <td scope="row" data-label="Function"><a href="#apireqraw_body"><code>api::req::raw\_body()</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#apiresraw_body"><code>api::res::raw\_body()</code></a></td>
