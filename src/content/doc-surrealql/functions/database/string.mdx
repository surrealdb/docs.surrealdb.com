...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#stringdistancedamerau_levenshtein"><code>string::distance::damerau_levenshtein()</code></a></td>
      <td scope="row" data-label="Description">Returns the Damerau–Levenshtein distance between two strings</td>
    </tr>
    <tr>
      <td scope="row" data-label="Function"><a href="#stringdistancenormalized_damerau_levenshtein"><code>string::distance::normalized_damerau_levenshtein()</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#stringdistancenormalized_levenshtein"><code>string::distance::normalized_levenshtein()</code></a></td>
      <td scope="row" data-label="Description">Returns the normalized Levenshtein distance between two strings</td>
    </tr>
    <tr>
      <td scope="row" data-label="Function"><a href="#stringdistanceosa_distance"><code>string::distance::osa_distance()</code></a></td>
