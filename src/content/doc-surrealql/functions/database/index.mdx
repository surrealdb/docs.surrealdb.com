  ...
  <tbody>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description and Example">
        ...
        Example: <code>bytes::len("SurrealDB".to\_bytes());</code>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description and Example">
        ...
        <code>
          object::from\_entries(\[\[ "a", 1 ],\[ "b", true ]])
        </code>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description and Example">
        ...
        <code>
          parse::url::domain("[http://127.0.0.1/index.html](http://127.0.0.1/index.html)")
        </code>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description and Example">
        ...
        Example: <code>type::is\_number(500)</code>
      </td>
    </tr>
