...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description and Example">These functions can be used for generating and coercing data to specific data types.<br/>Example: <code>type::is_number(500)</code></td>
    </tr>
    <tr>
