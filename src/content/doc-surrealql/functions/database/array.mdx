...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#arrayboolean_and"><code>array::boolean\_and()</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#arrayboolean_or"><code>array::boolean\_or()</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#arrayboolean_xor"><code>array::boolean\_xor()</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#arrayboolean_not"><code>array::boolean\_not()</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#arrayfilter_index"><code>array::filter\_index()</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#arrayfind_index"><code>array::find\_index()</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#arrayis_empty"><code>array::is\_empty()</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#arraylogical_and"><code>array::logical\_and()</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#arraylogical_or"><code>array::logical\_or()</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#arraylogical_xor"><code>array::logical\_xor()</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#arraysort_lexical"><code>array::sort\_lexical()</code></a></td>
      <td scope="row" data-label="Description">Sorts the values in an array, with strings sorted lexically</td>
    </tr>

    <tr>
      <td scope="row" data-label="Function"><a href="#arraysort_natural"><code>array::sort\_natural()</code></a></td>
      <td scope="row" data-label="Description">Sorts the values in an array, with numeric strings sorted numerically</td>
    </tr>

    <tr>
      <td scope="row" data-label="Function"><a href="#arraysort_natural_lexical"><code>array::sort\_natural\_lexical()</code></a></td>
