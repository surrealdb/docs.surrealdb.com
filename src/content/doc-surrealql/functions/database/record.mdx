...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#recordid"><code>record::is::edge()</code></a></td>
...
<Since v="v3.0.0-alpha.9" />

The `record::is::edge` function checks to see if the value passed in is a graph edge.
