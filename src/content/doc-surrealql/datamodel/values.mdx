...
```surql
CREATE time_data:[d'2024-07-23T06:36:56.004Z'];
CREATE time_data:[d'2024-07-24T06:36:56.014Z'];
CREATE time_data:[d'2024-07-25T06:36:56.014Z'];
...
```surql
-- Any record with 'London' in index 0
