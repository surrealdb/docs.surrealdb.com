...
If the idiom path is enclosed in parentheses, it will return the record in full.
...
Here is one more example showing the behaviour of `.*` when not enclosed in parentheses.
