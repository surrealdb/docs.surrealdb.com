...
The `@` symbol is used in recursive queries to refer to the current document. This is needed in `SELECT` queries, as without it there is no way to know the context.
