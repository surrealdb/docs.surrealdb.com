...
[[test.results]]
parse-error = """Unexpected character `_`, expected byte seperator `-`
 --> [1:18]
  |
1 | RETURN u"018f0e6a_9b95-7ecc-8a38-aea7bf3627dd";
  |                  ^"""

[[test.results]]
parse-error = """Unexpected character `_`, expected datetime seperator characters `-`
 --> [1:14]
  |
1 | RETURN d"2024_06-06T12:00:00Z";
  |              ^"""
