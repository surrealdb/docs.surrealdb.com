...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td colspan="2" scope="row" data-label="Constant">
        <code>MATH::FRAC\_1\_SQRT\_2</code>
      </td>
    ...
    <tr>
      <td colspan="2" scope="row" data-label="Constant">
        <code>MATH::FRAC\_2\_SQRT\_PI</code>
      </td>
