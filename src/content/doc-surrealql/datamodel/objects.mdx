...
A field of an object can be of any value type, including another object, with no limit to the depth of any nested objects or values within. This allows objects and arrays to be stored within each other in order to model complex data scenarios.
