...
> [!IMPORTANT]
> Record references are an experimental feature. We cannot guarantee that it will provide the same security guarantees as SurrealQL. It is not recommended for production use. We welcome your feedback and contributions to help improve the feature and make it more robust.
