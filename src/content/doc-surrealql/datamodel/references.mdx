...
DEFINE FIELD owned_by ON comic_book COMPUTED <~person.comics;
DEFINE FIELD borrowed_by ON comic_book COMPUTED <~person.borrowed_comics;
...
TODO: ON DELETE IGNORE might no longer be needed
