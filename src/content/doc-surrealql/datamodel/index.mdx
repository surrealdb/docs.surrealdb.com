    ...
    <tbody>
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">any</code>
            </td>
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">array</code>
            </td>
            <td scope="row" data-label="Description">
                An array of items.
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">bool</code>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <a href="#bytes"><code class="text-nowrap">bytes</code></a>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">datetime</code>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">decimal</code>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">duration</code>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">float</code>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <a href="#geometry"><code class="text-nowrap">geometry</code></a>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">int</code>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">number</code>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">object</code>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">regex</code>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <a href="/docs/surrealql/datamodel/literals"><code class="text-nowrap">literal</code></a>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">option</code>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">range</code>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">record</code>
            </td>
            <td scope="row" data-label="Description">
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">set</code>
            </td>
            <td scope="row" data-label="Description">
                A set of items. 
        ...
        <tr>
            <td scope="row" data-label="Type">
                <code class="text-nowrap">string</code>
            </td>
            <td scope="row" data-label="Description">
