...
An example of a record ID is: `company:surrealdb` or `company:w6xb3izpgvz4n0gow6q7`.
...
Record IDs can be constructed using a number of different types of values, including alphanumeric text, complex Unicode text and symbols, numbers, arrays, and objects. As record IDs are immutable, it is important to choose the record ID that suits your purposes.
