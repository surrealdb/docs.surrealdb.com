...
* [File functions](/docs/surrealql/functions/database/file) such as `file::put()` and `file::get()`
...
* [Using files for ad-hoc memory storage](/docs/surrealdb/reference-guide/working-with-types#using-files-for-ad-hoc-memory-storage)
