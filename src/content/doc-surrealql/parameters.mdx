...
## Parameters and expressions in statements

Parameters and expressions have traditionally only been available in a limited fashion in SurrealQL statements. As of version 3.0.0, work is undergoing to allow parameters and expressions to be used in many places that were not possible before.
