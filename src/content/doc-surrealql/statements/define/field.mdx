...
> [!NOTE]
> In versions of SurrealDB before 3.0.0-beta.1, `COMPUTED` fields were implemented using a data type called a `future`. Please see [the page on futures](/docs/surrealql/datamodel/futures) in this case.
