...
export const defineUserAst = {
  ...
  children: [
    { type: "Sequence", children: [
      ...
      { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "DURATION" }, { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "FOR" }, { type: "Terminal", text: "TOKEN" }, { type: "NonTerminal", text: "@duration" }, { type: "Optional", child: { type: "Terminal", text: "," } } ] } }, { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "FOR" }, { type: "Terminal", text: "SESSION" }, { type: "NonTerminal", text: "@duration" } ] } } ] } },
