...
:::note
__Note:__  Since `v2.0.0`, schemafull tables are implicitly type [`NORMAL`](/docs/surrealql/statements/define/table#table-with-specialized-type-clause) tables by default.
:::
