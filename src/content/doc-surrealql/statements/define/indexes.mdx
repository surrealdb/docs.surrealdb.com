...
> [!NOTE]
> Before SurrealDB version 3.0.0-alpha.9, the `FULLTEXT ANALYZER` clause used the syntax `SEARCH ANALYZER`.
...
-- Since 3.0.0-alpha.9: only FULLTEXT used to benefit from concurrent full-text search
