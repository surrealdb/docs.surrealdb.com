    ...
    { type: "Sequence", children: [
      ...
      { type: "Optional", child: { type: "Choice", index: 1, children: [
        ...
        { type: "Sequence", children: [
          ...
          { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "CAPACITY" }, { type: "NonTerminal", text: "@capacity" } ] } }
        ] },
        { type: "Sequence", children: [
...
[[test.results]]
parse-error = """Unexpected token `FIELD`, expected Eof
 --> [1:29]
  |
