...
<SurrealistMini url="https://app.surrealdb.com/mini?query=%2F%2F+Define+index+with+MANHATTAN+distance+functions%0ADEFINE+INDEX+idx_mtree_embedding_manhattan+ON+Document+FIELDS+items.embedding+MTREE+DIMENSION+4+DIST+MANHATTAN%3B%0A%0A%2F%2F+Define+index+with+COSINE+distance+functions+%0ADEFINE+INDEX+idx_mtree_embedding_cosine+ON+Document+FIELDS+items.embedding+MTREE+DIMENSION+4+DIST+COSINE%3B%0A%0A%2F%2F+See+information+for+indexes+on+Table%0AINFO+FOR+TABLE+Document%3B%0A%0A%2F%2F+Create+a+new+record+with+a+4+dimension+vector+%0ACREATE+ONLY+Document%3A1+CONTENT+%7B%0A++++%22items%22%3A+%5B%0A++++++++%7B%0A++++++++++++%22content%22%3A+%22file-1%22%2C%0A++++++++++++%22embedding%22%3A+%5B%0A++++++++++++++++0.009953570552170277%2C%0A++++++++++++++++-0.02680361643433571%2C+-0.018817437812685966%2C%0A++++++++++++++++-0.08697346597909927%0A++++++++++++%5D%0A++++++++%7D%0A++++%5D%0A%7D%3B%0A%0A%2F%2F+Select+all+from+Document.+%0ASELECT+*+FROM+Document%3B+&orientation=horizontal" />
