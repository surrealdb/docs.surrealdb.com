...
@fields
	[ UNIQUE
        | [ FULLTEXT | SEARCH ] ANALYZER @analyzer [ BM25 [(@k1, @b)] ] [ HIGHLIGHTS ]
  ...
  children: [
    { type: "Sequence", children: [
      ...
      { type: "Optional", child: { type: "Choice", index: 1, children: [
        ...
        { type: "Sequence", children: [ { type: "Choice", index: 1, children: [ { type: "Terminal", text: "FULLTEXT" }, { type: "Terminal", text: "SEARCH" } ] }, { type: "Terminal", text: "ANALYZER" }, { type: "NonTerminal", text: "@analyzer" }, { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "BM25" }, { type: "Optional", child: { type: "Terminal", text: "(@k1, @b)" } } ] } }, { type: "Optional", child: { type: "Terminal", text: "HIGHLIGHTS" } } ] },
        { type: "Sequence", children: [ { type: "Terminal", text: "MTREE" }, { type: "Terminal", text: "DIMENSION" }, { type: "NonTerminal", text: "@dimension" }, { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "TYPE" }, { type: "NonTerminal", text: "@type" } ] } }, { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "DIST" }, { type: "NonTerminal", text: "@distance" } ] } }, { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "CAPACITY" }, { type: "NonTerminal", text: "@capacity" } ] } } ] },
        { type: "Sequence", children: [ { type: "Terminal", text: "HNSW" }, { type: "Terminal", text: "DIMENSION" }, { type: "NonTerminal", text: "@dimension" }, { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "TYPE" }, { type: "NonTerminal", text: "@type" } ] } }, { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "DIST" }, { type: "NonTerminal", text: "@distance" } ] } }, { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "EFC" }, { type: "NonTerminal", text: "@efc" } ] } }, { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "M" }, { type: "NonTerminal", text: "@m" } ] } } ] }
      ] } },
...
The composite index spans multiple fields and columns of a table. Composite indexes are mainly used to create a unique index when the definition of what is unique pertains to more than one field.
