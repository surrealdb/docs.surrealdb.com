...
Since version 2.0.5, a statement with a `CONTENT` clause will bypass `READONLY` fields instead of generating an error.
...
<TabItem value="Before" label="Output before 2.0.5" >
...
<TabItem value="After" label="Output after 2.0.5" >
