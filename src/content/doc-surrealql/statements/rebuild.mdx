...
### Rebuilding a concurrent index

In the cases where you have a concurrent index, you can use the `REBUILD` statement to rebuild the index. This will ensure that the index is fully optimized and that the index is up to date.
