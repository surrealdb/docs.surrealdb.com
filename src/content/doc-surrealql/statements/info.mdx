...
> [!NOTE]
> Before SurrealDB v3.0.0-beta, the output of an `INFO FOR` was only able to be used as a standalone statement and not in a dynamic context, such as inside other queries or as the value of a parameter.
