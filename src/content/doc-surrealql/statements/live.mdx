  ...
  children: [
    { type: "Sequence", children: [
      ...
      { type: "Choice", index: 1, children: [
        { type: "Sequence", children: [ { type: "Optional", child: { type: "Terminal", text: "VALUE" } }, { type: "NonTerminal", text: "@fields" }, { type: "Optional", child: { type: "Sequence", children: [ { type: "Terminal", text: "AS" }, { type: "NonTerminal", text: "@alias" } ] } } ] },
