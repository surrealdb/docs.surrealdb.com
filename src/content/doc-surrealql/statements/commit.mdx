...
<railroaddiagram ast='{"type":"Diagram","padding":[10,20,10,20],"children":[{"type":"Sequence","children":[{"type":"Terminal","text":"COMMIT"},{"type":"Optional","child":{"type":"Terminal","text":"TRANSACTION"}},{"type":"Terminal","text":";"}]}]}' />
