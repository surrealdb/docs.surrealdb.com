...
:::note
__Note:__ To see the already defined items that can be modified with `ALTER`, use the [INFO](/docs/surrealql/statements/info) statement (`INFO FOR ROOT`, `INFO FOR NAMESPACE`, or `INFO FOR DATABASE`).
:::
