...
To override this default behaviour and return an error if no records exist to relate, you can add the `ENFORCED` keyword to a [`DEFINE TABLE`](/docs/surrealql/statements/define/table) statement.
:::
