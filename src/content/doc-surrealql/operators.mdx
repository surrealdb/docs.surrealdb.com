...
In addition to the `AND` keyword, the `OR` matches operator can also be used as of 3.0.0-alpha.8. This allows a single string to be compared against instead of needing to specify individual parts of the string.
