...
- **Connect using the CLI**: Since Surrealist always runs in a secure environment, localhost or LAN connections may be blocked by a viarety of reasons. Try connecting to the database using the [CLI](/docs/reference/cli/surrealdb-cli/overview) to see if the issue persists, as this is not subject to the same restrictions.
