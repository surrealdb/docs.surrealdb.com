...
description: "Create and edit SurrealDB functions in Surrealist, browse definitions, namespace names with fn::, edit arguments and permissions, then save or export from the functions workspace."
---
