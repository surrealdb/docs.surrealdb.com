      ...
      <TabItem label="Connect to your instance">
        <div className="flex flex-col md:flex-row items-start justify-between">
          <div className="flex-1 text-left">
            You can connect to any SurrealDB Cloud Instance via [Surrealist](/docs/build/deployment/surrealdb-cloud/connecting/via-surrealist), a [command-line interface (CLI)](/docs/build/deployment/surrealdb-cloud/connecting/via-cli), and [any of the supported SDKs](/docs/build/deployment/surrealdb-cloud/connecting/via-sdk).
