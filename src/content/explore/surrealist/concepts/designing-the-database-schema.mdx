...
The Designer view is built on top of the powerful [INFO FOR DB](/docs/reference/query-language/statements/info#database-information) and [INFO FOR TABLE](/docs/reference/query-language/statements/info#table-information) statements, which you can utilize yourself to programatically extract schema information from the database.
