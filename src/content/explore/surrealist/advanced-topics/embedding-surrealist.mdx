...
description: "Embed Surrealist queries on a page, use variable defaults, preview, copyable URLs and iframe snippets, and optional dataset loading for reproducible demos."
---
...
For example, to load the [surreal deal dataset](/docs/start) in the embeds by selecting the dropdown in the `Dataset` section and selecting the `surreal deal` dataset. This allows you to query the tables within a dataset and embed the results in your website or application.
...
<table>
    ...
    <tbody>
		...
		<tr>
            ...
            <td scope="row" data-label="Description">
                Change which visualisation is used for rendering results.
            </td>
			<td scope="row" data-label="Description">
