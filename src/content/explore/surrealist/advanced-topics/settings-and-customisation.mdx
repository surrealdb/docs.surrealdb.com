...
You can configure [connection templates](/docs/explore/surrealist/advanced-topics/connection-templates) to reuse connection details when creating new connections. This is especially useful when you find yourself connecting to similar databases frequently.
