...
description: "SurrealQL editor shortcuts in Surrealist for indentation, find and replace, comments, multi-cursor selection, run query, record-id inspection, and JSON value formatting preferences."
---
