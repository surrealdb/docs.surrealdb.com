...
description: "Open Surrealist search to reach connections, views, tables, and settings quickly, and scan the in-app shortcut reference for navigation and editing."
---
