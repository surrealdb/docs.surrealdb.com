...
This page will guide you through the process of setting up and using Surrealist. At this point we assume you have already installed Surrealist on your system. If you have not done so yet, please refer to the [installation guide](/docs/explore/surrealist/installation).

## Start screen

When launching Surrealist for the first time you will be greeted by the start screen. This screen allows you to easily jump into a sandbox environment or create a new connection to your SurrealDB instance.

If you are new to SurrealDB or looking to experiment with SurrealQL, we recommend starting with the sandbox environment. This environment allows you to test and experiment without installing the SurrealDB database or storing data persistently. To persist your data while still experimenting, click on **Deploy to Cloud** in Surrealist, where you can create a free SurrealDB Cloud instance to hold your data.
...
Alternatively, you can select the **Cloud instance** option where you can create a new connection to a SurrealDB Cloud instance. Learn more about SurrealDB Cloud in the [SurrealDB Cloud documentation](/docs/manage/cloud).
...
In addition to the different views, you can also find a button to open [Surrealist Search](/docs/explore/surrealist/advanced-topics/search-and-shortcuts), and a button to open the [settings](/docs/explore/surrealist/advanced-topics/settings-and-customisation). Within the settings
...
After reading this guide, you can watch the following video which covers some features of Surrealist that can help you get started. This includes organising connections and connection groups, [recordID](/docs/reference/query-language/language-primitives/data-types/record-ids) inspector, [editor shortcuts](/docs/explore/surrealist/advanced-topics/search-and-shortcuts), surrealist search and useful settings.
<iframe
	width="100%"
