...
To further test out SurrealDB and SurrealQL functionality, we've included two demo datasets here in `.surql` files which you can download and [`import`](/docs/reference/cli/surrealdb-cli/import) into SurrealDB using the [CLI](/docs/reference/cli/surrealdb-cli/overview).
...
Once one of the datasets has been downloaded, it's now time to [start the server](/docs/reference/cli/surrealdb-cli/start).
...
Lastly, use the [import command](/docs/reference/cli/surrealdb-cli/import) to add the dataset.
