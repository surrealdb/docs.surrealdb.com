...
Next, we should configure SurrealDB so that it can verify tokens sent to it through the [HTTP REST API](/docs/reference/rest-api/http-protocol) via the “Authorization” header or through any of the [SDKs](/docs#sdks) via the “Authenticate” methods.
