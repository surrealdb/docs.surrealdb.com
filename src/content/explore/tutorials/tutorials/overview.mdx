...
If you are new to SurrealDB, we recommend that you start with the [Getting started](/docs/start) or [SurrealQL](/docs/reference/query-language) sections of the documentation.
