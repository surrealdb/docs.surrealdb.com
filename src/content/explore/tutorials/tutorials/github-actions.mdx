...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td scope="row" data-label="Value">
                <a href="/docs/reference/cli/surrealdb-cli/start" target="_blank" rel="noopener noreferrer" title="Any valid SurrealDB CLI arguments">Any valid SurrealDB CLI arguments</a>            
            </td>
        </tr>
    </tbody>
</table>
