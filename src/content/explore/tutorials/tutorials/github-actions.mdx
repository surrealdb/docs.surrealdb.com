...
The official SurrealDB GitHub Action accepts several arguments to configure the SurrealDB setup. The table below lists the available arguments and their defaults:
...
4. **Additional Arguments**: Use surrealdb_additional_args to pass any additional CLI arguments required by your setup.
...
Using the official GitHub Action for SurrealDB simplifies the process of setting up and running SurrealDB in your CI/CD pipeline. Customise the workflow as per your project requirements, and ensure you follow best practices for security and version control.
