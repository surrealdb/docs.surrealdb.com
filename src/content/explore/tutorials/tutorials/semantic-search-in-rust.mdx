...
![Semantic search in Rust with SurrealDB and Mistral AI](~/assets/img/tutorials/semantic-search-mistral.jpg)
...
![Semantic search in Rust with SurrealDB and OpenAI](~/assets/img/tutorials/semantic-search-openai.jpg)
