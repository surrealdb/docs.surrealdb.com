...
- [A Command line interface (CLI)](/docs/reference/cli/surrealdb-cli/sql) for interacting with SurrealDB or a [Surrealist sandbox](/docs/explore/surrealist/getting-started#using-the-sandbox).
