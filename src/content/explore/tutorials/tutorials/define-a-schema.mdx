...
- [A Command line interface (CLI)](/docs/reference/cli/surrealdb-cli/commands/sql) for interacting with SurrealDB or a [Surrealist sandbox](/docs/explore/surrealist).
