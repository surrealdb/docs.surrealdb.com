...
a. [SurrealDB](/docs/self-hosted/installation) installed on your machine (Make sure you upgrade to the latest version if you already have SurrealDB installed on your machine)
...
```bash
surreal start --log debug --user root --pass secret memory --allow-guests
```
...
- [Javascript SDK documentation](/docs/languages/javascript/overview) - The Javascript SDK documentation
