...
a. [SurrealDB](/docs/start/self-hosted/installation) installed on your machine (Make sure you upgrade to the latest version if you already have SurrealDB installed on your machine)
...
- [Javascript SDK Documentation](/docs/start/languages/javascript) - The Javascript SDK documentation