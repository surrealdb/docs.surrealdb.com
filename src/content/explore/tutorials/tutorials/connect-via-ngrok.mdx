...
- You have [SurrealDB installed](/docs/running/installation) and a [fresh instance of SurrealDB running.](/docs/running/overview)
...
Open your command line or terminal and run the following command to [start SurrealDB](/docs/running/overview).
