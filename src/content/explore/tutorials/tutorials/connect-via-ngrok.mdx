...
- You have [SurrealDB installed](/docs/start/self-hosted/installation) and a [fresh instance of SurrealDB running.](/docs/start)
...
Now, let's [connect to your SurrealDB instance](/docs/reference/cli/surrealdb-cli/sql) using the forwarding address provided by Ngrok.
