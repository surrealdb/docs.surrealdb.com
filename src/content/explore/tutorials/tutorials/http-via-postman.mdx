...
- SurrealDB installed - If you do not, see the [installation guide](/docs/self-hosted/installation) specific to your machine.
...
To define a [record user](/docs/learn/security/authentication/authentication#record-users), first navigate to the `POST /sql`  endpoint and in the header of the request add the following fields:
