...
Because traces are kept as memory rather than as logs, the next ranking pass can use them.
...
The [REST API](/docs/agent-memory/reference/rest-api) and [MCP tools reference](/docs/agent-memory/integrations/mcp-server/tools-reference) exercise these paths.
