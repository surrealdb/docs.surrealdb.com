...
See [Profiles](/docs/agent-memory/operations/profiles) for the full profile shape.
...
- [Authority when pillars meet](/docs/agent-memory/reasoning/authority-hierarchy)
- [Profiles](/docs/agent-memory/operations/profiles)
- [REST API — state and profile](/docs/agent-memory/reference/rest-api)
