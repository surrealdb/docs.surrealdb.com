...
> [!NOTE]
> Workbench turns are durable memory in this context, and they compete with your own data at retrieval time. For a clean evaluation run, use a separate context. See [Contexts and scope](/docs/agent-memory/mental-model/contexts-and-scope).
