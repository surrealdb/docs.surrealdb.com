...
`source.span` stores **character positions** in the originating turn or document passage. Citations are **stored data**, not best-effort model prose. That powers “jump to quote” in UIs and defensible audit; tiered reads are described in [Coherence, retrieval, and cost tiers](/docs/agent-memory/architecture/coherence-retrieval-and-tiers).
...
- [Supersession, decay, and forget](/docs/agent-memory/mental-model/memory-lifecycle)
