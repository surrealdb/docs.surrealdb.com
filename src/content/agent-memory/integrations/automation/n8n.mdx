...
- [REST API](/docs/agent-memory/integrations/surfaces/rest): the endpoints the HTTP Request nodes call
- [MCP server](/docs/agent-memory/integrations/mcp-server/install): if your n8n host speaks MCP instead
