...
position: 3
title: Swift SDK
description: "Using SurrealDB Agent Memory from Swift applications and agents."
---
...
See the [Swift SDK reference](/docs/agent-memory/reference/sdk-swift) and [REST API](/docs/agent-memory/reference/rest-api) for the full contract.
