...
position: 1
title: Cursor
description: "Installing SurrealDB Agent Memory as an MCP server in Cursor."
---
...
For integration rules your agent should follow (auth, scope, endpoints, common mistakes), see **[Agent guide (AGENTS.md)](/docs/agent-memory/reference/agents)**. You can copy that page into `.cursor/rules/` or a project skill.
