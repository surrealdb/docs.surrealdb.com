...
position: 7
title: OpenCode
description: "Installing SurrealDB Agent Memory as an MCP server in OpenCode."
---
...
For integration rules your agent should follow (auth, scope, endpoints, common mistakes), see **[Agent guide (AGENTS.md)](/docs/agent-memory/reference/agents)**. OpenCode reads a project `AGENTS.md` automatically.
...
```powershell
$env:SPECTRON_API_KEY = "<your-api-key>"
```
</TabItem>
</Tabs>
