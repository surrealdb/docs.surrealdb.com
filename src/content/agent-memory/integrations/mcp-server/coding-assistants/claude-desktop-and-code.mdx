...
position: 2
title: Claude
description: "Connecting SurrealDB Agent Memory to Claude Code, Cowork, and Claude Desktop."
---
...
```powershell
$env:SPECTRON_MCP_URL = "https://<your-spectron-instance>/mcp"
$env:SPECTRON_MCP_TOKEN = "<your-api-key>"
```
</TabItem>
</Tabs>
