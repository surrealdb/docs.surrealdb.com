...
description: "Connect SurrealDB Agent Memory to Claude, Cursor, Windsurf, VS Code, and other MCP clients."
---
...
Use this for `cursor`, `vscode`, `windsurf`, `zed`, and `opencode`. **Claude** (Code, Cowork, Desktop) and **Codex** have a dedicated SurrealDB plugin - see the [Claude](/docs/agent-memory/integrations/mcp-server/coding-assistants/claude-desktop-and-code) and [Codex](/docs/agent-memory/integrations/mcp-server/coding-assistants/codex) guides. JetBrains IDEs, JetBrains Air, and Antigravity use the manual configuration below.
...
- [Claude Desktop and Claude Code](/docs/agent-memory/integrations/mcp-server/coding-assistants/claude-desktop-and-code)
- [Cursor](/docs/agent-memory/integrations/mcp-server/coding-assistants/cursor)
- [VS Code](/docs/agent-memory/integrations/mcp-server/coding-assistants/vscode)
- [Windsurf](/docs/agent-memory/integrations/mcp-server/coding-assistants/windsurf)
- [Codex](/docs/agent-memory/integrations/mcp-server/coding-assistants/codex)
- [Antigravity](/docs/agent-memory/integrations/mcp-server/coding-assistants/antigravity)
- [OpenCode](/docs/agent-memory/integrations/mcp-server/coding-assistants/opencode)
- [JetBrains](/docs/agent-memory/integrations/mcp-server/coding-assistants/jetbrains)
- [JetBrains Air](/docs/agent-memory/integrations/mcp-server/coding-assistants/jetbrains-air)
- [Zed](/docs/agent-memory/integrations/mcp-server/coding-assistants/zed)
...
Tool schemas: [MCP tools reference](/docs/agent-memory/reference/mcp-tools).
