...
description: "Accessing SurrealDB Agent Memory's knowledge layer as a virtual filesystem."
---
...
- [MCP server: install](/docs/agent-memory/integrations/mcp-server/install) - connecting an MCP client to SurrealDB Agent Memory
- [MCP tools reference](/docs/agent-memory/reference/mcp-tools) - the full set of MCP tools and resources
- [Uploading documents](/docs/agent-memory/ingest/authoritative/uploading-documents) - ingesting documents that appear in the filesystem view
