...
position: 9
title: Pydantic AI
description: "SurrealDB Agent Memory for Pydantic AI, via a toolset, auto-recall processor, and persistence helpers."
---
...
- To call SurrealDB Agent Memory directly outside Pydantic AI, use the [Python SDK](/docs/agent-memory/integrations/sdks/python).
