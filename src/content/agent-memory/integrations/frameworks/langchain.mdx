...
position: 1
title: LangChain
description: "LangChain and LangGraph integration for SurrealDB Agent Memory, with retrievers, agent tools, and a LangGraph store."
---
...
- If the host is Claude, Cursor, or another MCP-native client, prefer the [MCP server](/docs/agent-memory/integrations/mcp-server/install), with no adapter required.
- If your application calls SurrealDB Agent Memory directly rather than through LangChain, use the [JavaScript SDK](/docs/agent-memory/integrations/sdks/javascript-and-typescript).
