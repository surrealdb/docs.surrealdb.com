...
Using the [`.connect()`](/docs/sdk/javascript/api/core/surreal#connect) method, you can connect to a SurrealDB instance. The connection string specifies whether to connect to the Wasm engine, in memory or persisted with the `mem://` or `indxdb://` prefixes respectively.
