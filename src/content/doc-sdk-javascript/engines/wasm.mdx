...
The WebAssembly engine is available on NPM as [`@surrealdb/wasm`](https://npmjs.com/package/@surrealdb/wasm) and requires the [JavaScript SDK](https://npmjs.com/package/surrealdb) to operate.
