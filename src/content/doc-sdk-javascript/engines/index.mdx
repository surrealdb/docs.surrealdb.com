...
- [WebAssembly](/docs/sdk/javascript/engines/wasm) : Run SurrealDB as a non-embedded database within a browser environment, backed by either an in-memory engine or IndexedDB.
