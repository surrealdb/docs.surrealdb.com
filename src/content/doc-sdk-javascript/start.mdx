...
In the root of your project, create a `utils` folder and create a `surreal.ts` file. This file will contain the SDK initialization logic which manages the connection to the database using the [`connect`](/docs/2.x/sdk/javascript/api/core/surreal#connect), [`use`](/docs/2.x/sdk/javascript/api/core/surreal-session#use), and [`close`](/docs/2.x/sdk/javascript/api/core/surreal#close) methods.
...
### Create a new user
Create a new `src` folder and add `create-user.ts` file. This file will contain the logic to create a new user in the database. We will use the [`create`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#create) method to make a new user in the database. 
...
In the `src` folder, add `query-user.ts` file. This file will contain the logic to query a user in the database. We will use the [`select`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#select) method to get all users in the database.
...
```
> [!NOTE]
> You can also specify a specific user to query by using the [`RecordId`](/docs/sdk/javascript/api/values#recordid) datatype. Learn more about the [`select`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#select) method [in the Data Types section](/docs/sdk/javascript/api/values).


### Update a user

In the `src` folder, add `update-user.ts` file. This file will contain the logic to update a user in the database. We will use the [`update`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#update) method to update a user in the database. 
...
Learn more about the [`RecordId`](/docs/sdk/javascript/api/values#recordid) datatype [in the Data Types section](/docs/sdk/javascript/api/values).
...
In the `src` folder, add `delete-user.ts` file. This file will contain the logic to delete a user in the database. We will use the [`delete`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#delete) method to delete the user. 
...
Now that you have learned the basics of the SurrealDB SDK for JavaScript, you can learn more about the SDK in the [API reference](/docs/2.x/sdk/javascript/api) and [data types section](/docs/sdk/javascript/api/values).