...
<Boxes>
	{/* <IconBox
		...
		description="Learn about all the available data manipulation methods, including inserting, updating, merging, patching, and deleting records."
		href="/docs/sdk/javascript/core/data-manipulation"
	/> */}
	<IconBox
		title="Embedding SurrealDB"
		description="Run SurrealDB as an embedded database within your JavaScript application using WebAssembly or Node.js engines."
		href="/docs/sdk/javascript/engines"
	/>
	<IconBox
		title="SurrealQL"
	...
	{/* <IconBox
		title="Live queries"
		description="Subscribe to real-time data changes using live queries and react to changes as they happen."
		href="/docs/sdk/javascript/core/live-queries"
	/> */}
</Boxes>