...
```
> [!NOTE]
> You can also specify a specific user to query by using the [`RecordId`](/docs/sdk/javascript/data-types#recordid) datatype. Learn more about the [`select`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#select) method [in the Data Types section](/docs/sdk/javascript/data-types).
...
Now that you have learned the basics of the SurrealDB SDK for JavaScript, you can learn more about the SDK in the [API reference](/docs/2.x/sdk/javascript/api) and [data types section](/docs/sdk/javascript/data-types).