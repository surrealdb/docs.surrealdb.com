...
<table>
	...
	<tbody>
        ...
        <tr>
            <td scope="row" data-label="Function"><a href="/docs/sdk/javascript/core/initialization#close"> <code> db.close() </code></a></td>
            <td scope="row" data-label="Description">Closes the persistent connection to the database</td>
        </tr>
        <tr>
            <td scope="row" data-label="Function"><a href="/docs/sdk/javascript/core/initialization#wait"> <code> db.wait() </code></a></td>
