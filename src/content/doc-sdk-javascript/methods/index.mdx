...
<table>
	...
	<tbody>
        ...
        <tr>
            <td scope="row" data-label="Method"><a href="/docs/sdk/javascript/core/create-a-new-connection#wait"> <code> db.wait() </code></a></td>
...
<table>
    ...
    <tbody>
		...
		<tr>
            <td scope="row" data-label="Method"><a href="/docs/sdk/javascript/core/methods/invalidate"> <code>db.invalidate()</code></a></td>
            <td scope="row" data-label="Description">Invalidates the authentication for the current connection</td>
        </tr>
        <tr>
            <td scope="row" data-label="Method"><a href="/docs/sdk/javascript/core/methods/authenticate"> <code>db.authenticate(token)</code></a></td>
