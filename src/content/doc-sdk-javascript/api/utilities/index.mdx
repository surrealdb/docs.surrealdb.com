...
- [**expr**](/docs/2.x/sdk/javascript/api/utilities/expr) - Type-safe expression builder for WHERE clauses and conditions
...
- [**surql**](/docs/2.x/sdk/javascript/api/utilities/surql) - Tagged template for composing parameterized queries
  - Automatic value binding
  - SQL injection prevention
  - Type preservation
  - Incremental query building

- [**BoundQuery**](/docs/2.x/sdk/javascript/api/utilities/bound-query) - Parameterized query class with manual control
...
- [**equals**](/docs/2.x/sdk/javascript/api/utilities/equals) - Deep equality comparison for all types
...
- [**Escape Functions**](/docs/2.x/sdk/javascript/api/utilities/escape) - Escape identifiers and values
...
- [Core Classes](/docs/2.x/sdk/javascript/api/core/) - Core SDK classes
- [Data Types](/docs/2.x/sdk/javascript/api/values/) - SurrealDB data types
