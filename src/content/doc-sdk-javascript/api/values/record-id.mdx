...
- [Table](/docs/sdk/javascript/api/values/table) - Table references
- [Query Builders](/docs/sdk/javascript/api/queries/) - Using RecordId in queries
- [SurrealQL Record IDs](/docs/surrealdb/surrealql/datamodel/ids) - Database record ID documentation
