...
- [Query Builders](/docs/sdk/javascript/api/queries/) - Using Table in queries
- [SurrealQL Tables](/docs/surrealdb/surrealql/statements/define/table) - Database table definitions
