...
- [RecordIdRange](/docs/sdk/javascript/api/values/record-id#recordidrange) - Range of record IDs
- [DateTime](/docs/sdk/javascript/api/values/datetime) - Datetime values for date ranges
- [Decimal](/docs/sdk/javascript/api/values/decimal) - Precise numbers for price ranges
- [Data Types Overview](/docs/sdk/javascript/api/values/) - All custom data types
- [SurrealQL Ranges](/docs/surrealdb/surrealql/datamodel/ranges) - Database range syntax
