...
The `SurrealSession` class represents a scoped contextual session attached to a SurrealDB connection. It provides authentication, session configuration, and inherits all query execution methods from [`SurrealQueryable`](/docs/2.x/sdk/javascript/api/core/surreal-queryable).
...
**Extends:** [`SurrealQueryable`](/docs/2.x/sdk/javascript/api/core/surreal-queryable)

**Extended by:** [`Surreal`](/docs/2.x/sdk/javascript/api/core/surreal)

**Source:** [api/session.ts](https://github.com/surrealdb/surrealdb.js/blob/main/packages/sdk/src/api/session.ts)

## Constructor

The constructor is typically not called directly. Use [`Surreal.newSession()`](/docs/2.x/sdk/javascript/api/core/surreal#newsession) or [`forkSession()`](#forksession) to create new sessions.
...
**Type:** [`Uuid`](/docs/2.x/sdk/javascript/api/values/uuid) `| undefined`
...
#### Returns
[`Promise<SurrealSession>`](/docs/2.x/sdk/javascript/api/core/surreal-session) - A new session instance
...
Call [`commit()`](/docs/2.x/sdk/javascript/api/core/surreal-transaction#commit) on the transaction to apply changes, or [`cancel()`](/docs/2.x/sdk/javascript/api/core/surreal-transaction#cancel) to discard them.
...
#### Returns
`Promise<SurrealTransaction>` - A new [`SurrealTransaction`](/docs/2.x/sdk/javascript/api/core/surreal-transaction) instance
...
#### Returns
[`Promise<NamespaceDatabase>`](/docs/2.x/sdk/javascript/api/types/#namespacedatabase) - The newly selected namespace and database
...
> [!NOTE]
> When this method is called, the `authentication` property passed to [`connect()`](/docs/2.x/sdk/javascript/api/core/surreal#connect) will be ignored. You are responsible for handling session invalidation by listening to the [`auth`](#event-auth) event.
...
#### Returns
[`Promise<Tokens>`](/docs/2.x/sdk/javascript/api/types/#tokens) - The authentication tokens (access and refresh tokens)
...
#### Returns
[`Promise<Tokens>`](/docs/2.x/sdk/javascript/api/types/#tokens) - The authentication tokens
...
#### Returns
[`Promise<Tokens>`](/docs/2.x/sdk/javascript/api/types/#tokens) - The authentication tokens (may include new refresh token)
...
**Payload:** `[tokens:` [`Tokens`](/docs/2.x/sdk/javascript/api/types/#tokens) `| null]` - The new authentication tokens, or `null` if invalidated
...
**Payload:** `[using:` [`NamespaceDatabase`](/docs/2.x/sdk/javascript/api/types/#namespacedatabase)`]` - Object containing the new namespace and database
...
As `SurrealSession` extends [`SurrealQueryable`](/docs/2.x/sdk/javascript/api/core/surreal-queryable), it inherits all query execution methods:

- [`query()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#query) - Execute raw SurrealQL
- [`select()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#select) - Select records
- [`create()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#create) - Create records
...
- [`upsert()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#upsert) - Upsert records
- [`delete()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#delete) - Delete records
- [`relate()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#relate) - Create graph relationships
- [`live()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#live) - Subscribe to live queries
- [`run()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#run) - Execute functions
- [`api`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#api) - Access user-defined APIs
...
- [Surreal](/docs/2.x/sdk/javascript/api/core/surreal) - Main connection class
- [SurrealQueryable](/docs/2.x/sdk/javascript/api/core/surreal-queryable) - Query execution methods
- [SurrealTransaction](/docs/2.x/sdk/javascript/api/core/surreal-transaction) - Transaction support
- [Authentication Types](/docs/2.x/sdk/javascript/api/types/#anyauth) - Authentication type definitions
