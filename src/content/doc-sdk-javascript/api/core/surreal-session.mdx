...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>Nullable&lt;<a href="/docs/2.x/sdk/javascript/api/types/#namespacedatabase">NamespaceDatabase</a>&gt;</code></td>
...
#### Returns
[`Promise<NamespaceDatabase>`](/docs/2.x/sdk/javascript/api/types/#namespacedatabase) - The current or newly selected namespace and database
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/2.x/sdk/javascript/api/types/#token">Token</a> | <a href="/docs/2.x/sdk/javascript/api/types/#tokens">Tokens</a></code></td>
...
- [`liveOf()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#liveof) - Subscribe to existing live queries
- [`run()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#run) - Execute functions
- [`auth()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#auth) - Get authenticated record user
