...
Transactions are created using the [`beginTransaction()`](/docs/2.x/sdk/javascript/api/core/surreal-session#begintransaction) method on a [`SurrealSession`](/docs/2.x/sdk/javascript/api/core/surreal-session) instance.
...
The constructor is not called directly. Use [`SurrealSession.beginTransaction()`](/docs/2.x/sdk/javascript/api/core/surreal-session#begintransaction) to create transactions.
...
As `SurrealTransaction` extends [`SurrealQueryable`](/docs/2.x/sdk/javascript/api/core/surreal-queryable), it inherits all query execution methods. All queries executed on a transaction instance are part of the transaction scope:
...
- [SurrealSession.beginTransaction()](/docs/2.x/sdk/javascript/api/core/surreal-session#begintransaction) - Creating transactions
- [SurrealQueryable](/docs/2.x/sdk/javascript/api/core/surreal-queryable) - Available query methods
- [Query Builders](/docs/2.x/sdk/javascript/api/queries/) - Query builder classes
