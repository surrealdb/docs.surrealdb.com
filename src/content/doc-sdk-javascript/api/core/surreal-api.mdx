...
API instances are created through the [`api`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#api) property on [`Surreal`](/docs/2.x/sdk/javascript/api/core/surreal), [`SurrealSession`](/docs/2.x/sdk/javascript/api/core/surreal-session), or [`SurrealTransaction`](/docs/2.x/sdk/javascript/api/core/surreal-transaction):
...
#### Returns
[`ApiPromise<Req, Res>`](/docs/2.x/sdk/javascript/api/queries/api-promise) - A promise for the API response
...
#### Returns
[`ApiPromise<void, ResponseBody>`](/docs/2.x/sdk/javascript/api/queries/api-promise) - A promise for the GET response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/2.x/sdk/javascript/api/queries/api-promise) - A promise for the POST response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/2.x/sdk/javascript/api/queries/api-promise) - A promise for the PUT response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/2.x/sdk/javascript/api/queries/api-promise) - A promise for the DELETE response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/2.x/sdk/javascript/api/queries/api-promise) - A promise for the PATCH response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/2.x/sdk/javascript/api/queries/api-promise) - A promise for the TRACE response
...
- [ApiPromise](/docs/2.x/sdk/javascript/api/queries/api-promise) - API response handling
- [User-Defined APIs Guide](/docs/surrealql/statements/define/api) - Defining APIs in SurrealDB
