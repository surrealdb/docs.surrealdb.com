...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><code><a href="/docs/2.x/sdk/javascript/api/types/#apirequest">ApiRequest</a>&lt;T&gt;</code></td>
...
#### Returns
[`ApiPromise<unknown>`](/docs/2.x/sdk/javascript/api/queries/api-promise) - A promise for the API response
