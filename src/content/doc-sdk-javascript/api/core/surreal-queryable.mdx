...
Create a [`SurrealApi`](/docs/2.x/sdk/javascript/api/core/surreal-api) instance for invoking user-defined API endpoints. You can provide type definitions for type-safe API calls and an optional path prefix.
...
#### Returns
[`SurrealApi<TPaths>`](/docs/2.x/sdk/javascript/api/core/surreal-api) - An API instance for invoking custom database APIs
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/2.x/sdk/javascript/api/types/#anyrecordid">AnyRecordId</a></code></td>
...
#### Returns
- For `RecordId`: [`SelectPromise<T | undefined, T>`](/docs/2.x/sdk/javascript/api/queries/select-promise) - A promise resolving to a single record or `undefined`
- For `Table` or `RecordIdRange`: [`SelectPromise<T[], T>`](/docs/2.x/sdk/javascript/api/queries/select-promise) - A promise resolving to an array of records
...
#### Returns
[`CreatePromise<RecordResult<T>, T>`](/docs/2.x/sdk/javascript/api/queries/create-promise) - A promise with chainable configuration methods
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/2.x/sdk/javascript/api/types/#anyrecordid">AnyRecordId</a> | AnyRecordId[]</code></td>
            <td>The source record(s) for the relationship.</td>
        </tr>
        <tr>
            <td><code>edge</code> <Label label="required" /></td>
            <td><code>Table | <a href="/docs/2.x/sdk/javascript/api/types/#anyrecordid">AnyRecordId</a></code></td>
...
#### Returns
[`UnmanagedLivePromise<T>`](/docs/2.x/sdk/javascript/api/queries/live-promise) - An unmanaged live query subscription
