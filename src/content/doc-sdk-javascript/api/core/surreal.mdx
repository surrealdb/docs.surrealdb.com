...
The `Surreal` class is the primary interface for connecting to a SurrealDB instance, managing connections, executing queries, and handling database sessions. It extends [`SurrealSession`](/docs/2.x/sdk/javascript/api/core/surreal-session) and inherits all session management and query execution capabilities.
...
**Extends:** [`SurrealSession`](/docs/2.x/sdk/javascript/api/core/surreal-session) → [`SurrealQueryable`](/docs/2.x/sdk/javascript/api/core/surreal-queryable)
...
**Type:** [`ConnectionStatus`](/docs/2.x/sdk/javascript/api/types/#connectionstatus)
...
The `Surreal` class inherits all properties from [`SurrealSession`](/docs/2.x/sdk/javascript/api/core/surreal-session), including:
...
#### Returns
[`Promise<VersionInfo>`](/docs/2.x/sdk/javascript/api/types/#versioninfo) - An object containing version information
...
#### Returns
`Promise<SurrealSession>` - A new [`SurrealSession`](/docs/2.x/sdk/javascript/api/core/surreal-session) instance
...
The `Surreal` class also inherits and re-emits events from [`SurrealSession`](/docs/2.x/sdk/javascript/api/core/surreal-session):
...
As `Surreal` extends [`SurrealSession`](/docs/2.x/sdk/javascript/api/core/surreal-session), it inherits all authentication and query methods:

### Authentication Methods
- [`signup()`](/docs/2.x/sdk/javascript/api/core/surreal-session#signup) - Sign up a new user
- [`signin()`](/docs/2.x/sdk/javascript/api/core/surreal-session#signin) - Sign in with credentials
- [`authenticate()`](/docs/2.x/sdk/javascript/api/core/surreal-session#authenticate) - Authenticate with a token
- [`invalidate()`](/docs/2.x/sdk/javascript/api/core/surreal-session#invalidate) - Invalidate the session

### Session Configuration Methods
- [`use()`](/docs/2.x/sdk/javascript/api/core/surreal-session#use) - Set namespace and database
- [`set()`](/docs/2.x/sdk/javascript/api/core/surreal-session#set) - Set a session parameter
- [`unset()`](/docs/2.x/sdk/javascript/api/core/surreal-session#unset) - Remove a session parameter
- [`reset()`](/docs/2.x/sdk/javascript/api/core/surreal-session#reset) - Reset the session

### Query Methods

As `Surreal` extends [`SurrealQueryable`](/docs/2.x/sdk/javascript/api/core/surreal-queryable) (via `SurrealSession`), it also inherits all query execution methods:
...
### Transaction Method
- [`beginTransaction()`](/docs/2.x/sdk/javascript/api/core/surreal-transaction) - Start a transaction
...
- [SurrealSession](/docs/2.x/sdk/javascript/api/core/surreal-session) - Session management and authentication
...
- [Data Types](/docs/sdk/javascript/api/values) - Working with data types
