...
Query builder classes are promise-like objects returned by query methods on [`SurrealQueryable`](/docs/sdk/javascript/api/core/surreal-queryable). They provide chainable configuration methods before executing the query.
...
- [**Query**](/docs/sdk/javascript/api/queries/query) - Execute raw SurrealQL with streaming and batch processing support
  - Returned by: [`SurrealQueryable.query()`](/docs/sdk/javascript/api/core/surreal-queryable#query)
  - Key methods: `.collect()`, `.stream()`, `.responses()`, `.json()`

### Record Operations

- [**SelectPromise**](/docs/sdk/javascript/api/queries/select-promise) - Configure SELECT queries with filtering, pagination, and field selection
...
- [**CreatePromise**](/docs/sdk/javascript/api/queries/create-promise) - Configure CREATE operations for new records
...
- [**InsertPromise**](/docs/sdk/javascript/api/queries/insert-promise) - Configure INSERT operations for bulk record insertion
  - Returned by: [`SurrealQueryable.insert()`](/docs/sdk/javascript/api/core/surreal-queryable#insert)
  - Key methods: `.relation()`, `.ignore()`, `.output()`

- [**UpdatePromise**](/docs/sdk/javascript/api/queries/update-promise) - Configure UPDATE operations with various update strategies
...
- [**UpsertPromise**](/docs/sdk/javascript/api/queries/upsert-promise) - Configure UPSERT operations (insert or replace)
...
- [**DeletePromise**](/docs/sdk/javascript/api/queries/delete-promise) - Configure DELETE operations
  - Returned by: [`SurrealQueryable.delete()`](/docs/sdk/javascript/api/core/surreal-queryable#delete)
  - Key methods: `.output()`, `.timeout()`

### Graph Operations

- [**RelatePromise**](/docs/sdk/javascript/api/queries/relate-promise) - Configure RELATE operations for creating graph relationships
...
- [**LivePromise**](/docs/sdk/javascript/api/queries/live-promise) - Subscribe to live query updates for real-time data changes
...
- [**ApiPromise**](/docs/sdk/javascript/api/queries/api-promise) - Execute user-defined API endpoint calls
  - Returned by: Methods on [`SurrealApi`](/docs/sdk/javascript/api/core/surreal-api)
...
- [SurrealQueryable](/docs/sdk/javascript/api/core/surreal-queryable) - Methods that return query builders
- [SelectPromise](/docs/sdk/javascript/api/queries/select-promise) - Detailed SELECT documentation
- [CreatePromise](/docs/sdk/javascript/api/queries/create-promise) - Detailed CREATE documentation
- [Expression Builders](/docs/sdk/javascript/api/utilities/#expr) - Building query conditions
