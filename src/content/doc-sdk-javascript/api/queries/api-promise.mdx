...
- [SurrealApi](/docs/sdk/javascript/api/core/surreal-api) - API instance methods
- [SurrealQueryable.api](/docs/sdk/javascript/api/core/surreal-queryable#api) - Creating API instances
- [User-Defined APIs](/docs/surrealdb/surrealql/statements/define/api) - Defining APIs in SurrealDB
