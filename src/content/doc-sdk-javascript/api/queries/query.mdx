...
#### Returns
`Promise<Responses<T, J>>` - Array of [`QueryResponse`](/docs/sdk/javascript/api/types/#queryresponse) objects
...
- [SurrealQueryable.query()](/docs/sdk/javascript/api/core/surreal-queryable#query) - Method that returns Query
- [BoundQuery](/docs/sdk/javascript/api/utilities/#boundquery) - Parameterized queries
