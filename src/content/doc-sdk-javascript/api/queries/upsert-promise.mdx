...
> [!WARNING]
> UPSERT replaces the entire record if it exists. Use [`update().merge()`](/docs/2.x/sdk/javascript/api/queries/update-promise#merge) for partial updates.
...
- [SurrealQueryable.upsert()](/docs/2.x/sdk/javascript/api/core/surreal-queryable#upsert) - Method that returns UpsertPromise
- [CreatePromise](/docs/2.x/sdk/javascript/api/queries/create-promise) - Create only
- [UpdatePromise](/docs/2.x/sdk/javascript/api/queries/update-promise) - Update only
