...
- [SurrealQueryable.update()](/docs/2.x/sdk/javascript/api/core/surreal-queryable#update) - Method that returns UpdatePromise
- [UpsertPromise](/docs/2.x/sdk/javascript/api/queries/upsert-promise) - Insert or update
- [CreatePromise](/docs/2.x/sdk/javascript/api/queries/create-promise) - Create records
