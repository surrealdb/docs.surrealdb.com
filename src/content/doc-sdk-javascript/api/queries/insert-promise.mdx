...
- [SurrealQueryable.insert()](/docs/sdk/javascript/api/core/surreal-queryable#insert) - Method that returns InsertPromise
- [CreatePromise](/docs/sdk/javascript/api/queries/create-promise) - Single record creation
