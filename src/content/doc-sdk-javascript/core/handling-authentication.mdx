...
<TabItem value="V2" label="Root user" >
```ts
...
<TabItem value="V2" label="Namespace user" >
```ts
...
<TabItem value="V2" label="Database user" >
```ts
...
<TabItem value="V2" label="Record Access" >
```ts
