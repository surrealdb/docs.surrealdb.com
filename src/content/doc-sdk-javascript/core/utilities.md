...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" scope="row">
                A class containing a query and it's variables, which can be passed to the [`.query()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#query) method.
            </td>
        </tr>
        <tr>
            <td colspan="1" scope="row">
...
A class containing a query and it's bindings, which can be passed to the [`.query()`](/docs/2.x/sdk/javascript/api/core/surreal-queryable#query) method.
