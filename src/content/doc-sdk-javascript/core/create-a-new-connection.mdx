...
```
  ...
  <TabItem value="JS" label="Remote endpoint">
  ```ts
  // Connect to a remote endpoint
await db.connect('https://cloud.surrealdb.com/rpc');
```
</TabItem>
<TabItem value="JS" label="Namespace and database">
```ts
...
<TabItem value="JS" label="Credentials">
```ts
...
<TabItem value="JS" label="Custom logic">
```ts
