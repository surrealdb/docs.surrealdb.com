...
In order to be able to create a support ticket, you need to add a support plan to your Organisation. You can add a support plan by clicking the **Support** tab in the Surrealist sidebar. If you do not have a support plan, you will see the **Add support plan** option
