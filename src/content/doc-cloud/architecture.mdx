...
<img src="~/assets/img/image/cloud/light/start-single-node-light.avif" darkSrc="~/assets/img/image/cloud/start-single-node.avif" alt="SurrealDB Cloud architecture" />
...
<img src="~/assets/img/image/cloud/light/enterprise-multi-node-light.avif" darkSrc="~/assets/img/image/cloud/enterprise-multi-node.avif" alt="SurrealDB Cloud architecture" />
