...
From the overview page, you can delete an Instance by clicking the **Delete** button on the Instance card. This will bring up a confirmation modal. Once confirmed, the Instance will be deleted and you will be redirected to the Instances page.
