...
Network access is a type of [Instance capability](/docs/cloud/advanced-topics/configure-an-instance#instance-capabilities) that allows you to control and manage how your Surreal Cloud Instance connects to external services and networks through [HTTP functions and requests](/docs/surrealql/functions/database/http). This capability enables you to make HTTP calls to external APIs and services directly from your database queries while maintaining control over which endpoints can be accessed.
