...
<div class="flex gap-4 items-center justify-center">
    ...
    <a href="/docs/cloud/getting-started/" class="group inline-flex w-full gap-1.5 items-center justify-center px-6 py-3 font-medium bg-gradient-to-r from-surreal-pink to-surreal-purple rounded-lg border-white/30 border bg-origin-border transition-colors hover:text-white">
