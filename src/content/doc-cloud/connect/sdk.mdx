...
with SurrealDB(url="wss://cloud-docs-068rp16e0hsnl62vgooa7omjks.aws-euw1.staging.surrealdb.cloud") as db:
    db.use("Cloud Namespace", "Cloud Database")
    auth_token = db.sign_in(username="<created root user>", password="<created root password>")
