...
> [!NOTE]
> AWS PrivateLink is an enterprise feature. Onboarding is a manual process handled by the SurrealDB Cloud team, and requires coordinated setup on both sides. Contact [support](https://surrealdb.com/contact) to get started.
...
Since the onboarding process is manual, it is important to contact the SurrealDB Cloud team to request PrivateLink access for your organisation and region. You can contact the SurrealDB Cloud team by [emailing us](mailto:support@surrealdb.com) or by [opening a support ticket](https://surrealdb.com/contact).
