...
4. Select an Instance type: Instance type defines the resources allocated to your cloud Instance. The Instance types are in three different categories - **Burstable**, **General purpose**, and **Free Tier**. You can choose between the following configurations:

> [!NOTE]
> To use a General purpose or Burstable Instance, you need to enter your billing and payment information.
