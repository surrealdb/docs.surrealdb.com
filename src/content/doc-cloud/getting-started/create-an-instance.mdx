...
title: Create an Instance | Surreal Cloud (Beta)
description: In this section, you will learn how to create an Instance in Surreal Cloud (Beta).
---
...
Surreal Cloud (Beta) allows you to create a new Instance with a few clicks. You can create an Instance in your personal account or in an organization. 
...
Now that you have created an Instance, you can [connect to your Surreal Cloud (Beta) Instance](/docs/cloud/connect). You can also [configure your Instance](/docs/cloud/advanced-topics/configure-an-instance) to change the Instance type, number of nodes, and capabilities.