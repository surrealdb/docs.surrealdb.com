...
> [!IMPORTANT]
> You can only have one Individual organisation per account. If you already have an Individual organisation, you will need to delete it before you can create a new Individual organisation. However, you can have multiple other organisations per account. 
