...
Surreal Cloud offers a flexible pricing model that allows you to pay only for the resources you use. The pricing is based on used compute and storage provisioned to each instance. For detailed pricing information, please refer to the [pricing](/pricing) page.
