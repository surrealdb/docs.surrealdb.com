...
We are offering community support at launch.  You can get help via our [Discord channel](https://discord.gg/surrealdb) `#surreal-cloud`.
...
Yes. You can move your current application built in SurrealDB to SurrealDB Cloud . You can find more information in the [migrate your existing data](/docs/cloud/operate-and-manage/migrating-data) documentation.
