...
After installing the SDK, check out the quick start guide to build a simple application with the SDK. You can also learn more about carrying out common tasks with the SDK in the following sections:
- [Quick Start](/docs/1.x/sdk/java/start)
- [Creating a new connection](/docs/1.x/sdk/java/core/create-a-new-connection)
- [Authenticating users](/docs/1.x/sdk/java/core/handling-authentication)
- [SurrealQL documentation](/docs/surrealql) for the query language reference
