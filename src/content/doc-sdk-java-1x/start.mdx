...
You can learn more about supported SurrealDB data types on the [data types](/docs/1.x/sdk/java/data-types) page. See also the [SurrealQL data model](/docs/surrealql/datamodel) for the full list of data types available in SurrealDB.
...
Now that you have learned the basics of the SurrealDB SDK for Java, you can learn more about the API in the [API documentation](/docs/1.x/sdk/java/api-documentation) or explore the [data types](/docs/1.x/sdk/java/data-types) supported by the SDK. You can also refer to the [SurrealQL documentation](/docs/surrealql) for the full query language reference.
