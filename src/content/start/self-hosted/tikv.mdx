...
In this example, we will start a local [TiKV](https://tikv.org/) cluster with a single node for development and testing purposes. To install TiKV on your development machine, run the following command. This will install the [`tiup`](https://github.com/pingcap/tiup) command-line tool, which enables deploying and managing TiKV clusters of any size.
