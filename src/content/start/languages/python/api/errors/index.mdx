...
- [Error handling concept](/docs/start/languages/python/concepts/error-handling) for patterns and best practices
- [Surreal API reference](/docs/start/languages/python/api/core/surreal) for methods that may throw errors
- [Python types](/docs/start/languages/python/api/types/) for the `Value` and `Tokens` types
