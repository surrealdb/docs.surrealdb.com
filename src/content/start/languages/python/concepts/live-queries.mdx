...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/python/api/core/surreal#live"><code>db.live(table, diff?)</code></a></td>
			<td scope="row" data-label="Description">Starts a live query on a table and returns a query UUID</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/python/api/core/surreal#subscribe-live"><code>db.subscribe_live(query_uuid)</code></a></td>
			<td scope="row" data-label="Description">Subscribes to notifications from a live query</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/python/api/core/surreal#kill"><code>db.kill(query_uuid)</code></a></td>
...
You can also initiate a live query using a [`LIVE SELECT`](/docs/reference/query-language/statements/live) statement through the `.query()` method. The query returns a UUID that can be passed to `.subscribe_live()` in the same way as a UUID returned by `.live()`.
...
- [Surreal API reference](/docs/start/languages/python/api/core/surreal) for method signatures and parameters
- [Connecting to SurrealDB](/docs/start/languages/python/concepts/connecting-to-surrealdb) for WebSocket connection setup
- [SurrealQL LIVE SELECT](/docs/reference/query-language/statements/live) for the query language syntax
