...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/python/api/core/surreal#new-session"><code>db.new_session()</code></a></td>
			<td scope="row" data-label="Description">Creates a new isolated session on the current connection</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/python/api/core/surreal-session#close-session"><code>session.close_session()</code></a></td>
			<td scope="row" data-label="Description">Closes the session and detaches it from the connection</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/python/api/core/surreal-session#use"><code>session.use(namespace, database)</code></a></td>
...
- [SurrealSession API reference](/docs/start/languages/python/api/core/surreal-session) for session method signatures
- [Transactions](/docs/start/languages/python/concepts/transactions) for transaction support within sessions
- [Authentication](/docs/start/languages/python/concepts/authentication) for signing in within sessions
