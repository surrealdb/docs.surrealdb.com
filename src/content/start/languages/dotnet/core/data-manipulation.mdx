    ...
    <tbody>
        <tr>
            ...
            <td colspan="2" scope="col" scope="row" data-label="Description">
                The table name or a [`RecordId`](/docs/start/languages/dotnet/data-types#recordid) to select.
            </td>
        </tr>
        <tr>
            <td colspan="2" scope="col" scope="row" data-label="Arguments">
    ...
    <tbody>
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                The table name or a [`RecordId`](/docs/start/languages/dotnet/data-types#recordid) to create.
            </td>
        </tr>
        <tr>
            <td colspan="2" scope="col" scope="row" data-label="Arguments">
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                The table name or the specific [`RecordId`](/docs/start/languages/dotnet/data-types#recordid) to update.
            </td>
        </tr>
        <tr>
            <td colspan="2" scope="row" data-label="Arguments">
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                The table name or the specific [`RecordId`](/docs/start/languages/dotnet/data-types#recordid) to merge.
            </td>
        </tr>
        <tr>
            <td colspan="2" scope="col" scope="row" data-label="Arguments">
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                The table name or a [`RecordId`](/docs/start/languages/dotnet/data-types#recordid) to delete.
            </td>
        </tr>
        <tr>
            <td colspan="2" scope="col" scope="row" data-label="Arguments">
