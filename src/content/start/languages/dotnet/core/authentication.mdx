...
In your SurrealDB database, you can create authentication login using the [`DEFINE ACCESS`](/docs/reference/query-language/statements/define/access) statement which supports [JWT](/docs/reference/query-language/statements/define/access/jwt) and [Record](/docs/reference/query-language/statements/define/access/record) Access methods.
...
The .NET SDK has a [`.Query()` method](/docs/start/languages/dotnet/core/writing-surrealql) which allows you to write secure SurrealQL statements from within your application. Using this method, you can define access for your users and securely manage authentication. See the code example below:
...
> [!NOTE]
> Depending on the connection protocol you choose, authentication tokens and sessions lifetime work differently. Refer to the [connection options](/docs/start/languages/dotnet/core/create-a-new-connection#connection-options) documentation for more information.
