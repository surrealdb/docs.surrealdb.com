...
`Session` satisfies the [`sendable`](/docs/start/languages/golang/api/types#sendable) constraint, so all generic functions like [`Query`](/docs/start/languages/golang/api/core/db#query), [`Select`](/docs/start/languages/golang/api/core/db#select), [`Create`](/docs/start/languages/golang/api/core/db#create), etc. accept `*Session` directly.
...
Returns [`ErrSessionClosed`](/docs/start/languages/golang/api/errors#sentinel-errors) if the session has already been detached.
...
**Returns:** [`(*Tokens, error)`](/docs/start/languages/golang/api/types#tokens)
...
**Returns:** [`(*VersionData, error)`](/docs/start/languages/golang/api/types#versiondata)
...
- [DB](/docs/start/languages/golang/api/core/db) for the main client reference
- [Transaction](/docs/start/languages/golang/api/core/transaction) for session-scoped transactions
- [Multiple sessions](/docs/start/languages/golang/concepts/multiple-sessions) for session usage patterns
- [Errors](/docs/start/languages/golang/api/errors) for `ErrSessionClosed` and `ErrSessionsNotSupported`
