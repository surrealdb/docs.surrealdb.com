...
- [RecordID](/docs/start/languages/golang/api/values/record-id) for targeting specific records
- [Data manipulation](/docs/start/languages/golang/concepts/data-manipulation) for using tables in CRUD operations
