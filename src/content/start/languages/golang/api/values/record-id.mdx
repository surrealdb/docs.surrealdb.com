...
- [Table](/docs/start/languages/golang/api/values/table) for the table name type
- [Value types](/docs/start/languages/golang/concepts/value-types) for the full type mapping
- [Data manipulation](/docs/start/languages/golang/concepts/data-manipulation) for using record IDs in CRUD operations
- [SurrealQL record IDs](/docs/reference/query-language/language-primitives/data-types/record-ids) for the underlying data model
