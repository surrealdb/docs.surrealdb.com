...
- [Core Classes](/docs/start/languages/javascript/api/core/) - Classes that may throw errors
- [Surreal](/docs/start/languages/javascript/api/core/surreal) - Connection methods that may throw errors
- [SurrealSession](/docs/start/languages/javascript/api/core/surreal-session) - Session methods that may throw errors
