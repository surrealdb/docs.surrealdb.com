...
**Returned by:** [`SurrealQueryable.query()`](/docs/start/languages/javascript/api/core/surreal-queryable#query)
...
#### Returns
`Promise<Responses<T, J>>` - Array of [`QueryResponse`](/docs/start/languages/javascript/api/types/#queryresponse) objects
...
- [SurrealQueryable.query()](/docs/start/languages/javascript/api/core/surreal-queryable#query) - Method that returns Query
- [BoundQuery](/docs/start/languages/javascript/api/utilities/#boundquery) - Parameterized queries
- [surql](/docs/start/languages/javascript/api/utilities/#surql) - Template tag for queries
