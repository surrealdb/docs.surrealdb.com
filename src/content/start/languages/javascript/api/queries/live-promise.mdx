...
**Returned by:** [`SurrealQueryable.live()`](/docs/start/languages/javascript/api/core/surreal-queryable#live), [`SurrealQueryable.liveOf()`](/docs/start/languages/javascript/api/core/surreal-queryable#liveof)
...
**Returned by:** [`SurrealQueryable.live()`](/docs/start/languages/javascript/api/core/surreal-queryable#live)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Condition expression to filter updates (string or <a href="/docs/start/languages/javascript/api/utilities/expr">Expression</a> object).</td>
        </tr>
    </tbody>
</table>
...
**Returned by:** [`SurrealQueryable.liveOf()`](/docs/start/languages/javascript/api/core/surreal-queryable#liveof)
...
Each update message conforms to the [`LiveMessage<T>`](/docs/start/languages/javascript/api/types/#livemessage) interface with `action`, `result`, and optional `diff` properties.
...
- [SurrealQueryable.live()](/docs/start/languages/javascript/api/core/surreal-queryable#live) - Create managed live subscription
- [SurrealQueryable.liveOf()](/docs/start/languages/javascript/api/core/surreal-queryable#liveof) - Subscribe to existing live query
- [Live Queries Guide](/docs/reference/query-language/statements/live) - SurrealQL LIVE documentation
