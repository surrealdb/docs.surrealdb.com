...
**Returned by:** [`SurrealQueryable.delete()`](/docs/start/languages/javascript/api/core/surreal-queryable#delete)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/start/languages/javascript/api/values/duration">Duration</a></code></td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/start/languages/javascript/api/values/datetime">DateTime</a></code></td>
...
> [!NOTE: Tip]
> For conditional deletions, use [`db.query()`](/docs/start/languages/javascript/api/core/surreal-queryable#query) with a DELETE statement including a WHERE clause.
...
- [SurrealQueryable.delete()](/docs/start/languages/javascript/api/core/surreal-queryable#delete) - Method that returns DeletePromise
- [UpdatePromise](/docs/start/languages/javascript/api/queries/update-promise) - Update records
- [Query](/docs/start/languages/javascript/api/queries/query) - Raw SurrealQL for conditional deletes
