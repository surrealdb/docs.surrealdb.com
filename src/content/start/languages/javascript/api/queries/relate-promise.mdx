...
**Returned by:** [`SurrealQueryable.relate()`](/docs/start/languages/javascript/api/core/surreal-queryable#relate)
...
- [SurrealQueryable.relate()](/docs/start/languages/javascript/api/core/surreal-queryable#relate) - Method that returns RelatePromise
- [Graph Relationships](/docs/reference/query-language/statements/relate) - SurrealQL RELATE documentation
- [RecordId](/docs/start/languages/javascript/api/values/#recordid) - Record identifier type
