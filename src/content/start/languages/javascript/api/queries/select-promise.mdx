...
**Returned by:** [`SurrealQueryable.select()`](/docs/start/languages/javascript/api/core/surreal-queryable#select)
...
- [SurrealQueryable.select()](/docs/start/languages/javascript/api/core/surreal-queryable#select) - Method that returns SelectPromise
- [Query Overview](/docs/start/languages/javascript/api/queries/) - All query builder classes
- [Expression Builders](/docs/start/languages/javascript/api/utilities/#expr) - Building complex conditions
