...
**Returned by:** [`SurrealQueryable.update()`](/docs/start/languages/javascript/api/core/surreal-queryable#update)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>The condition expression (string or <a href="/docs/start/languages/javascript/api/utilities/expr">Expression</a> object).</td>
        </tr>
    </tbody>
</table>
...
- [SurrealQueryable.update()](/docs/start/languages/javascript/api/core/surreal-queryable#update) - Method that returns UpdatePromise
- [UpsertPromise](/docs/start/languages/javascript/api/queries/upsert-promise) - Insert or update
- [CreatePromise](/docs/start/languages/javascript/api/queries/create-promise) - Create records
