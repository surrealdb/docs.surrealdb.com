...
**Returned by:** [`SurrealQueryable.insert()`](/docs/start/languages/javascript/api/core/surreal-queryable#insert)
...
- [SurrealQueryable.insert()](/docs/start/languages/javascript/api/core/surreal-queryable#insert) - Method that returns InsertPromise
- [CreatePromise](/docs/start/languages/javascript/api/queries/create-promise) - Single record creation
