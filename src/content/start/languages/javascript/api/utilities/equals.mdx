...
- [Data Types](/docs/start/languages/javascript/api/values/) - SurrealDB data types
- [RecordId.equals()](/docs/start/languages/javascript/api/values/record-id#equals) - RecordId-specific comparison
- [DateTime.equals()](/docs/start/languages/javascript/api/values/datetime#equals) - DateTime-specific comparison
