...
- [expr](/docs/start/languages/javascript/api/utilities/expr) - Expression builder
- [Query](/docs/start/languages/javascript/api/queries/query) - Executing queries
- [SurrealQueryable.query()](/docs/start/languages/javascript/api/core/surreal-queryable#query) - Query method
