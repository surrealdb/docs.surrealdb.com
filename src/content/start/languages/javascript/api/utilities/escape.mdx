...
> [!NOTE: Tip]
> Prefer using [`surql`](/docs/start/languages/javascript/api/utilities/surql) or [`BoundQuery`](/docs/start/languages/javascript/api/utilities/bound-query) for automatic parameterization. Use escape functions only when absolutely necessary.
...
- **For values:** Use [`surql`](/docs/start/languages/javascript/api/utilities/surql) or [`BoundQuery`](/docs/start/languages/javascript/api/utilities/bound-query)
- **For tables:** Use [`Table`](/docs/start/languages/javascript/api/values/table) class
- **For record IDs:** Use [`RecordId`](/docs/start/languages/javascript/api/values/record-id) class
- **For conditions:** Use [`expr`](/docs/start/languages/javascript/api/utilities/expr)
...
- [surql](/docs/start/languages/javascript/api/utilities/surql) - Recommended for parameterized queries
- [BoundQuery](/docs/start/languages/javascript/api/utilities/bound-query) - Parameterized query class
- [Table](/docs/start/languages/javascript/api/values/table) - Type-safe table references
- [RecordId](/docs/start/languages/javascript/api/values/record-id) - Type-safe record identifiers
