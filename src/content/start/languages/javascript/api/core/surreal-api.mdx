...
API instances are created through the [`api`](/docs/start/languages/javascript/api/core/surreal-queryable#api) property on [`Surreal`](/docs/start/languages/javascript/api/core/surreal), [`SurrealSession`](/docs/start/languages/javascript/api/core/surreal-session), or [`SurrealTransaction`](/docs/start/languages/javascript/api/core/surreal-transaction):
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><code><a href="/docs/start/languages/javascript/api/types/#apirequest">ApiRequest</a>&lt;Req&gt;</code></td>
...
#### Returns
[`ApiPromise<Req, Res>`](/docs/start/languages/javascript/api/queries/api-promise) - A promise for the API response
...
#### Returns
[`ApiPromise<void, ResponseBody>`](/docs/start/languages/javascript/api/queries/api-promise) - A promise for the GET response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/start/languages/javascript/api/queries/api-promise) - A promise for the POST response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/start/languages/javascript/api/queries/api-promise) - A promise for the PUT response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/start/languages/javascript/api/queries/api-promise) - A promise for the DELETE response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/start/languages/javascript/api/queries/api-promise) - A promise for the PATCH response
...
#### Returns
[`ApiPromise<RequestBody, ResponseBody>`](/docs/start/languages/javascript/api/queries/api-promise) - A promise for the TRACE response
...
- [ApiPromise](/docs/start/languages/javascript/api/queries/api-promise) - API response handling
