...
Transactions are created using the [`beginTransaction()`](/docs/start/languages/javascript/api/core/surreal-session#begintransaction) method on a [`SurrealSession`](/docs/start/languages/javascript/api/core/surreal-session) instance.
...
The constructor is not called directly. Use [`SurrealSession.beginTransaction()`](/docs/start/languages/javascript/api/core/surreal-session#begintransaction) to create transactions.
...
As `SurrealTransaction` extends [`SurrealQueryable`](/docs/start/languages/javascript/api/core/surreal-queryable), it inherits all query execution methods. All queries executed on a transaction instance are part of the transaction scope:
...
- [SurrealSession.beginTransaction()](/docs/start/languages/javascript/api/core/surreal-session#begintransaction) - Creating transactions
- [SurrealQueryable](/docs/start/languages/javascript/api/core/surreal-queryable) - Available query methods
- [Query Builders](/docs/start/languages/javascript/api/queries/) - Query builder classes
