...
The `SurrealQueryable` class is an abstract base class that provides all query execution methods for interacting with SurrealDB. It is the foundation for executing database operations and is extended by [`SurrealSession`](/docs/start/languages/javascript/api/core/surreal-session) and [`SurrealTransaction`](/docs/start/languages/javascript/api/core/surreal-transaction).

**Extended by:** [`SurrealSession`](/docs/start/languages/javascript/api/core/surreal-session), [`SurrealTransaction`](/docs/start/languages/javascript/api/core/surreal-transaction)
...
Access user-defined API endpoints. This property returns a [`SurrealApi`](/docs/start/languages/javascript/api/core/surreal-api) instance for invoking custom database APIs.

You can provide type definitions for type-safe API calls.

**Type:** [`SurrealApi<TPaths>`](/docs/start/languages/javascript/api/core/surreal-api)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>string | <a href="/docs/start/languages/javascript/api/utilities/bound-query">BoundQuery</a></code></td>
...
#### Returns
[`Query<R>`](/docs/start/languages/javascript/api/queries/query) - A query instance that can be configured and executed
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/start/languages/javascript/api/values/record-id">RecordId</a></code></td>
            <td>A specific record ID to select.</td>
        </tr>
        <tr>
            <td><code>range</code> <label label="required" /></td>
            <td><code><a href="/docs/start/languages/javascript/api/values/record-id">RecordIdRange</a></code></td>
            <td>A range of record IDs to select.</td>
        </tr>
        <tr>
            <td><code>table</code> <label label="required" /></td>
            <td><code><a href="/docs/start/languages/javascript/api/values/table">Table</a></code></td>
...
#### Returns
[`SelectPromise<T>`](/docs/start/languages/javascript/api/queries/select-promise) - A promise with chainable configuration methods
...
#### Returns
[`CreatePromise<T>`](/docs/start/languages/javascript/api/queries/create-promise) - A promise with chainable configuration methods
...
#### Returns
[`InsertPromise<T>`](/docs/start/languages/javascript/api/queries/insert-promise) - A promise with chainable configuration methods
...
#### Returns
[`UpdatePromise<T>`](/docs/start/languages/javascript/api/queries/update-promise) - A promise with chainable configuration methods
...
#### Returns
[`UpsertPromise<T>`](/docs/start/languages/javascript/api/queries/upsert-promise) - A promise with chainable configuration methods
...
#### Returns
[`DeletePromise<T>`](/docs/start/languages/javascript/api/queries/delete-promise) - A promise with chainable configuration methods
...
#### Returns
[`RelatePromise<T>`](/docs/start/languages/javascript/api/queries/relate-promise) - A promise for the relationship operation
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/start/languages/javascript/api/types/#liveresource">LiveResource</a></code></td>
...
#### Returns
[`ManagedLivePromise<T>`](/docs/start/languages/javascript/api/queries/live-promise) - A managed live query subscription
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/start/languages/javascript/api/values/uuid">Uuid</a></code></td>
...
#### Returns
[`UnmanagedLivePromise`](/docs/start/languages/javascript/api/queries/live-promise) - An unmanaged live query subscription
...
#### Returns
[`RunPromise<T>`](/docs/start/languages/javascript/api/queries/run-promise) - A promise for the function result
...
- [SurrealSession](/docs/start/languages/javascript/api/core/surreal-session) - Session management extending this class
- [SurrealTransaction](/docs/start/languages/javascript/api/core/surreal-transaction) - Transaction support extending this class
- [Query Builders](/docs/start/languages/javascript/api/queries/) - Detailed query builder documentation
- [SelectPromise](/docs/start/languages/javascript/api/queries/select-promise) - SELECT query configuration
- [CreatePromise](/docs/start/languages/javascript/api/queries/create-promise) - CREATE query configuration
