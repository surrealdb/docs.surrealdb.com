...
The `SurrealSession` class represents a scoped contextual session attached to a SurrealDB connection. It provides authentication, session configuration, and inherits all query execution methods from [`SurrealQueryable`](/docs/start/languages/javascript/api/core/surreal-queryable).
...
**Extends:** [`SurrealQueryable`](/docs/start/languages/javascript/api/core/surreal-queryable)

**Extended by:** [`Surreal`](/docs/start/languages/javascript/api/core/surreal)

**Source:** [api/session.ts](https://github.com/surrealdb/surrealdb.js/blob/main/packages/sdk/src/api/session.ts)

## Constructor

The constructor is typically not called directly. Use [`Surreal.newSession()`](/docs/start/languages/javascript/api/core/surreal#newsession) or [`forkSession()`](#forksession) to create new sessions.
...
**Type:** [`Uuid`](/docs/start/languages/javascript/api/values/uuid) `| undefined`
...
#### Returns
[`Promise<SurrealSession>`](/docs/start/languages/javascript/api/core/surreal-session) - A new session instance
...
Call [`commit()`](/docs/start/languages/javascript/api/core/surreal-transaction#commit) on the transaction to apply changes, or [`cancel()`](/docs/start/languages/javascript/api/core/surreal-transaction#cancel) to discard them.
...
#### Returns
`Promise<SurrealTransaction>` - A new [`SurrealTransaction`](/docs/start/languages/javascript/api/core/surreal-transaction) instance
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/start/languages/javascript/api/types/#namespacedatabase">NamespaceDatabase</a> | null</code></td>
...
#### Returns
[`Promise<NamespaceDatabase>`](/docs/start/languages/javascript/api/types/#namespacedatabase) - The newly selected namespace and database
...
> [!NOTE]
> When this method is called, the `authentication` property passed to [`connect()`](/docs/start/languages/javascript/api/core/surreal#connect) will be ignored. You are responsible for handling session invalidation by listening to the [`auth`](#event-auth) event.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/start/languages/javascript/api/types/#accessrecordauth">AccessRecordAuth</a></code></td>
...
#### Returns
[`Promise<Tokens>`](/docs/start/languages/javascript/api/types/#tokens) - The authentication tokens (access and refresh tokens)
...
<table>
    ...
    <tbody>
        <tr>
            <td><code>auth</code> <label label="required" /></td>
            <td><code><a href="/docs/start/languages/javascript/api/types/#anyauth">AnyAuth</a></code></td>
...
#### Returns
[`Promise<Tokens>`](/docs/start/languages/javascript/api/types/#tokens) - The authentication tokens
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>string | <a href="/docs/start/languages/javascript/api/types/#tokens">Tokens</a></code></td>
...
#### Returns
[`Promise<Tokens>`](/docs/start/languages/javascript/api/types/#tokens) - The authentication tokens (may include new refresh token)
...
**Payload:** `[tokens:` [`Tokens`](/docs/start/languages/javascript/api/types/#tokens) `| null]` - The new authentication tokens, or `null` if invalidated
...
**Payload:** `[using:` [`NamespaceDatabase`](/docs/start/languages/javascript/api/types/#namespacedatabase)`]` - Object containing the new namespace and database
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>keyof <a href="/docs/start/languages/javascript/api/types/#sessionevents">SessionEvents</a></code></td>
...
As `SurrealSession` extends [`SurrealQueryable`](/docs/start/languages/javascript/api/core/surreal-queryable), it inherits all query execution methods:

- [`query()`](/docs/start/languages/javascript/api/core/surreal-queryable#query) - Execute raw SurrealQL
- [`select()`](/docs/start/languages/javascript/api/core/surreal-queryable#select) - Select records
- [`create()`](/docs/start/languages/javascript/api/core/surreal-queryable#create) - Create records
- [`insert()`](/docs/start/languages/javascript/api/core/surreal-queryable#insert) - Insert records
- [`update()`](/docs/start/languages/javascript/api/core/surreal-queryable#update) - Update records
- [`upsert()`](/docs/start/languages/javascript/api/core/surreal-queryable#upsert) - Upsert records
- [`delete()`](/docs/start/languages/javascript/api/core/surreal-queryable#delete) - Delete records
- [`relate()`](/docs/start/languages/javascript/api/core/surreal-queryable#relate) - Create graph relationships
- [`live()`](/docs/start/languages/javascript/api/core/surreal-queryable#live) - Subscribe to live queries
- [`run()`](/docs/start/languages/javascript/api/core/surreal-queryable#run) - Execute functions
- [`api`](/docs/start/languages/javascript/api/core/surreal-queryable#api) - Access user-defined APIs
...
- [Surreal](/docs/start/languages/javascript/api/core/surreal) - Main connection class
- [SurrealQueryable](/docs/start/languages/javascript/api/core/surreal-queryable) - Query execution methods
- [SurrealTransaction](/docs/start/languages/javascript/api/core/surreal-transaction) - Transaction support
- [Authentication Types](/docs/start/languages/javascript/api/types/#anyauth) - Authentication type definitions
