...
- [RecordIdRange](/docs/start/languages/javascript/api/values/record-id#recordidrange) - Range of record IDs
- [DateTime](/docs/start/languages/javascript/api/values/datetime) - Datetime values for date ranges
- [Decimal](/docs/start/languages/javascript/api/values/decimal) - Precise numbers for price ranges
- [Data Types Overview](/docs/start/languages/javascript/api/values/) - All custom data types
