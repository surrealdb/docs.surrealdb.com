...
The `FileRef` class represents a reference to a file stored in SurrealDB. File references are returned when querying records that contain [file fields](/docs/reference/query-language/language-primitives/data-types/files) and provide access to file metadata such as the bucket, key, and media type.
...
- [Value types](/docs/start/languages/javascript/concepts/value-types) - Overview of all value types
- [File uploads](/docs/reference/query-language/language-primitives/data-types/files) - Working with files in SurrealDB
- [Data Types](/docs/start/languages/javascript/api/values/) - All custom data types
