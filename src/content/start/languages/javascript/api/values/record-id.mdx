...
- [Table](/docs/start/languages/javascript/api/values/table) - Table references
- [Query Builders](/docs/start/languages/javascript/api/queries/) - Using RecordId in queries
