...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/javascript/api/core/surreal-session#begintransaction"> <code> db.beginTransaction() </code></a></td>
			<td scope="row" data-label="Description">Starts a new transaction</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/javascript/api/core/surreal-transaction#commit"> <code> txn.commit() </code></a></td>
			<td scope="row" data-label="Description">Commits the transaction, applying all changes</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/javascript/api/core/surreal-transaction#cancel"> <code> txn.cancel() </code></a></td>
...
Call `.beginTransaction()` on any [`Surreal`](/docs/start/languages/javascript/api/core/surreal) or [`SurrealSession`](/docs/start/languages/javascript/api/core/surreal-session) instance to start a new transaction. The returned [`SurrealTransaction`](/docs/start/languages/javascript/api/core/surreal-transaction) object provides all the same [query methods](/docs/start/languages/javascript/concepts/executing-queries) as a regular session, but every operation is executed within the transaction scope.
...
- [SurrealTransaction API reference](/docs/start/languages/javascript/api/core/surreal-transaction) for the complete transaction interface
- [Executing queries](/docs/start/languages/javascript/concepts/executing-queries) for the query methods available on transactions
- [Multiple sessions](/docs/start/languages/javascript/concepts/multiple-sessions) for running transactions on isolated sessions
