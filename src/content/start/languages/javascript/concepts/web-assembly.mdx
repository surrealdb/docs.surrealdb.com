...
Before installing the WASM engine, you need the core [JavaScript SDK](/docs/start/languages/javascript/installation) installed. Then add the `@surrealdb/wasm` package.
...
- [WebAssembly engine reference](/docs/start/languages/javascript/engines/wasm) for additional engine configuration
