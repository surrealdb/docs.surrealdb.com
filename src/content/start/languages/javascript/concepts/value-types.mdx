...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/start/languages/javascript/api/values/record-id"> <code> RecordId </code></a></td>
			<td scope="row" data-label="Description">Type-safe record identifiers with table and ID components</td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/start/languages/javascript/api/values/table"> <code> Table </code></a></td>
			<td scope="row" data-label="Description">Type-safe table references for query methods</td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/start/languages/javascript/api/values/datetime"> <code> DateTime </code></a></td>
			<td scope="row" data-label="Description">Datetime values with nanosecond precision</td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/start/languages/javascript/api/values/duration"> <code> Duration </code></a></td>
			<td scope="row" data-label="Description">Time duration values with multiple unit support</td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/start/languages/javascript/api/values/decimal"> <code> Decimal </code></a></td>
			<td scope="row" data-label="Description">Arbitrary precision decimal numbers</td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/start/languages/javascript/api/values/uuid"> <code> Uuid </code></a></td>
			<td scope="row" data-label="Description">Universally unique identifiers (v4 and v7)</td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/start/languages/javascript/api/values/range"> <code> Range </code></a></td>
			<td scope="row" data-label="Description">Bounded or unbounded range values</td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/start/languages/javascript/api/values/file-ref"> <code> FileRef </code></a></td>
			<td scope="row" data-label="Description">References to files stored in SurrealDB</td>
		</tr>
		<tr>
			<td scope="row" data-label="Class"><a href="/docs/start/languages/javascript/api/values/geometry"> <code> Geometry* </code></a></td>
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="/docs/start/languages/javascript/api/values/record-id"><code>RecordId</code></a></td>
			<td><code>new RecordId('users', 'john')</code></td>
		</tr>
		<tr>
			<td>—</td>
			<td><a href="/docs/start/languages/javascript/api/values/table"><code>Table</code></a></td>
			<td><code>new Table('users')</code></td>
		</tr>
		<tr>
			<td><code>datetime</code></td>
			<td><a href="/docs/start/languages/javascript/api/values/datetime"><code>DateTime</code></a></td>
			<td><code>DateTime.now()</code></td>
		</tr>
		<tr>
			<td><code>duration</code></td>
			<td><a href="/docs/start/languages/javascript/api/values/duration"><code>Duration</code></a></td>
			<td><code>Duration.parse('1h30m')</code></td>
		</tr>
		<tr>
			<td><code>decimal</code></td>
			<td><a href="/docs/start/languages/javascript/api/values/decimal"><code>Decimal</code></a></td>
			<td><code>new Decimal('19.99')</code></td>
		</tr>
		<tr>
			<td><code>uuid</code></td>
			<td><a href="/docs/start/languages/javascript/api/values/uuid"><code>Uuid</code></a></td>
			<td><code>Uuid.v7()</code></td>
		</tr>
		<tr>
			<td><code>geometry</code></td>
			<td><a href="/docs/start/languages/javascript/api/values/geometry"><code>Geometry*</code></a></td>
			<td><code>new GeometryPoint([1, 2])</code></td>
		</tr>
		<tr>
			<td><code>range</code></td>
			<td><a href="/docs/start/languages/javascript/api/values/range"><code>Range</code></a></td>
			<td><code>new Range(1, 10)</code></td>
		</tr>
		<tr>
			<td><code>file</code></td>
			<td><a href="/docs/start/languages/javascript/api/values/file-ref"><code>FileRef</code></a></td>
...
A [`DateTime`](/docs/start/languages/javascript/api/values/datetime) represents a point in time with nanosecond precision. Unlike JavaScript's native `Date` which is limited to millisecond precision, `DateTime` preserves the full precision of SurrealDB timestamps. A [`Duration`](/docs/start/languages/javascript/api/values/duration) represents a span of time using SurrealQL duration syntax.
...
A [`Decimal`](/docs/start/languages/javascript/api/values/decimal) represents an arbitrary-precision decimal number. This avoids the floating-point precision issues that occur with JavaScript's `number` type.
...
A [`Uuid`](/docs/start/languages/javascript/api/values/uuid) represents a universally unique identifier. The class supports generating both v4 (random) and v7 (time-ordered) UUIDs.
...
A [`Range`](/docs/start/languages/javascript/api/values/range) represents a bounded or unbounded range of values. Ranges are used in SurrealQL for selecting slices of records by ID or filtering numeric and temporal values. A `RecordIdRange` is a specialization for querying a range of records from a table.
...
A `FileRef` represents a reference to a file stored in SurrealDB. File references are returned when working with [file uploads](/docs/reference/query-language/language-primitives/data-types/files) and contain metadata about the stored file.
...
- [Data Types API reference](/docs/start/languages/javascript/api/values/) for the full list of value class documentation
- [SurrealQL data model](/docs/reference/query-language/datamodel) for the database-level type system
- [Utilities](/docs/start/languages/javascript/concepts/utilities) for comparing and converting values
