...
- [WebAssembly engine reference](/docs/start/languages/javascript/engines/wasm)
- [Node.js engine reference](/docs/start/languages/javascript/engines/node)
- [Connecting to SurrealDB](/docs/start/languages/javascript/concepts/connecting-to-surrealdb) for connection options and reconnection behaviour
