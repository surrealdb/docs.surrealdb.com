...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/javascript/api/core/surreal#connect"> <code> db.connect(url, options) </code></a></td>
			<td scope="row" data-label="Description">Connects to a local or remote database endpoint</td>
		</tr>
        <tr>
            <td scope="row" data-label="Method"><a href="/docs/start/languages/javascript/api/core/surreal#close"> <code> db.close() </code></a></td>
            <td scope="row" data-label="Description">Closes the persistent connection to the database</td>
        </tr>
        <tr>
            <td scope="row" data-label="Method"><a href="/docs/start/languages/javascript/api/core/surreal#ready"> <code> db.ready </code></a></td>
			<td scope="row" data-label="Description">Waits for the connection to the database to succeed</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/javascript/api/core/surreal-session#use"> <code> db.use(namespace, database)</code></a></td>
...
- **Embedded** protocols using the [WebAssembly engine](/docs/start/languages/javascript/engines/wasm) or [Node.js engine](/docs/start/languages/javascript/engines/node)
...
- [Surreal API reference](/docs/start/languages/javascript/api/core/surreal) for the complete connection interface
- [ConnectOptions type reference](/docs/start/languages/javascript/api/types/#connectoptions) for all connection options
- [Authentication](/docs/start/languages/javascript/concepts/authentication) for signing in and managing credentials
- [WebAssembly engine](/docs/start/languages/javascript/concepts/web-assembly) for embedded browser databases
- [Node.js engine](/docs/start/languages/javascript/concepts/nodejs) for embedded server-side databases
- [Error handling](/docs/start/languages/javascript/concepts/error-handling) for connection and reconnection errors
