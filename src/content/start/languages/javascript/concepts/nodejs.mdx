...
Before installing the Node.js engine, you need the core [JavaScript SDK](/docs/start/languages/javascript/installation) installed. Then add the `@surrealdb/node` package.
...
| `rocksdb://` | Persistent database backed by [RocksDB](/docs/start/architecture) |
| `surrealkv://` | Persistent database backed by [SurrealKV](/docs/start/architecture) |
...
- [Node.js engine reference](/docs/start/languages/javascript/engines/node) for additional engine configuration
