...
* [Actix](/docs/start/languages/rust/frameworks/actix)
* [Axum](/docs/start/languages/rust/frameworks/axum)
* [Rocket](/docs/start/languages/rust/frameworks/rocket)
* [Egui](/docs/start/languages/rust/frameworks/egui)

Learn more about authentication in SurrealDB in our [security best practices](/docs/learn/security/best-practices/security-best-practices#authentication) documentation and in the [security](/docs/learn/security/authentication/authentication#expiration) section of the SurrealDB documentation.
