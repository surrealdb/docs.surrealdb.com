...
The quickest way to retrieve vector embeddings is to use the [fastembed crate](/docs/build/integrations/embeddings-providers/fastembed#language-specific-examples), which does not require a user key or calling into an external service.
