...
The `FileRef` class represents a reference to a [file stored in SurrealDB](/docs/reference/query-language/language-primitives/data-types/files). A file reference consists of a storage bucket name and a unique file key within that bucket.
...
- [SurrealQL files](/docs/reference/query-language/language-primitives/data-types/files) — File storage in SurrealDB
