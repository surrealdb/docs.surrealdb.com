...
| `getGeometry()` | [`Geometry`](/docs/start/languages/java/api/values/geometry) |
| `getDateTime()` | `ZonedDateTime` |
| `getDuration()` | `Duration` |
| `getBytes()` | `byte[]` |
| `getRecordId()` | [`RecordId`](/docs/start/languages/java/api/values/record-id) |
| `getFile()` | [`FileRef`](/docs/start/languages/java/api/values/file-ref) |
...
- [RecordId](/docs/start/languages/java/api/values/record-id) — Record identifiers
