...
SurrealDB is a [multi-model database](/blog/what-are-multi-model-databases) built in Rust designed to unify multiple data models into a single, powerful engine. It combines [document](/docs/learn/data-models/document/using-as-document-database), [graph](/docs/learn/data-models/graph/using-as-graph-database), [time-series](/docs/learn/data-models/time-series/using-as-time-series-database), [relational](/docs/explore/tutorials/tutorials/define-a-schema), [geospatial](/docs/learn/data-models/geospatial/using-as-geospatial-database) and key-value data types into one query language, [SurrealQL](/docs/reference/query-language), with powerful search and retrieval ([vector](/docs/learn/data-models/vector-search/using-as-vector-database), [full-text](/docs/learn/data-models/full-text-search/using-as-full-text-search-database), hybrid), and [real-time and event-driven capabilities](/docs/learn/querying/real-time/real-time-best-practices), enabling developers to build applications faster and more efficiently.
