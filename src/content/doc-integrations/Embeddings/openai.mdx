...
We will then put this into a separate function called `test_embed()` which uses the embedding retrieved from OpenAI to query the database against existing documents.
