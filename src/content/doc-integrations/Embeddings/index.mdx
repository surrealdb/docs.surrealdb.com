...
Find an example in [Minimal LangChain chatbot example with vector and graph](https://surrealdb.com/blog/minimal-langchain-chatbot-example-with-vector-and-graph).
...
{/* TODO: add link to Dave's example */}
