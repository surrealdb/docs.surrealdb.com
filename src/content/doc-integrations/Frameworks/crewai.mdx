...
[1]: https://surrealdb.com/docs/surrealdb/reference-guide/vector-search?utm_source=chatgpt.com "Vector Search | Reference guides - SurrealDB"
[2]: https://surrealdb.com/docs/surrealdb/models/vector?utm_source=chatgpt.com "Using SurrealDB as a Vector Database | Introduction"
[3]: https://surrealdb.com/docs/sdk/python?utm_source=chatgpt.com "Python SDKs | Integration - SurrealDB"
[4]: https://surrealdb.com/docs/surrealql/statements/define/indexes?utm_source=chatgpt.com "DEFINE INDEX statement | SurrealQL - SurrealDB"
