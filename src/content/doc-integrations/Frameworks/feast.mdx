...
<table>
    ...
    <tbody>
        <tr>
            <td><strong><code>DEFINE INDEX … HNSW</code></strong> – build an approximate-NN index in one DDL line (<a href="/docs/surrealql/statements/define/indexes" rel="noopener noreferrer">SurrealDB</a>)</td>
