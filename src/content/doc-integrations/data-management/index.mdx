...
<table>
    ...
    <tbody>
        {/* <tr>
            <td><a href="/docs/integrations/data-managaement/airbyte">Airbyte</a></td>
            <td>Data integration platform specialising in ELT pipelines.</td>
        </tr> */}
        <tr>
            <td><a href="/docs/integrations/data-managaement/fivetran">Fivetran</a></td>
            <td>Data integration platform to manage data transfer between different sources and destination systems.</td>
        </tr>
        <tr>
            <td><a href="/docs/integrations/data-managaement/unstructured">Unstructured</a></td>
