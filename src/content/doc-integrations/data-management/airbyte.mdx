...
- A token or user credentials with [`DEFINE TABLE`](/docs/surrealql/statements/define/table), [`DEFINE INDEX`](/docs/surrealql/statements/define/index), [`UPSERT`](/docs/surrealql/statements/upsert), [`SELECT`](/docs/surrealql/statements/select), and [`REMOVE`](/docs/surrealql/statements/remove) permissions.
