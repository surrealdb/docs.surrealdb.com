...
description: The Fivetran integration for SurrealDB.
---
...
2. Browse the [Instances page](/docs/cloud/getting-started/create-an-instance) and select your chosen Instance.
...
Fivetran [tests and validates](https://fivetran.com/docs/destinations/newdestination/setup-guide#setuptests) the SurrealDB connection. Upon successfully completing the setup tests, you can sync your data using Fivetran connectors to the SurrealDB destination.
