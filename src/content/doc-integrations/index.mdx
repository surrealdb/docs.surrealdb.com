...
Equip your AI coding agent with SurrealDB knowledge using [Agent Skills](/docs/integrations/agent-skills) and [Agent Rules](/docs/integrations/agent-rules). Skills provide on-demand context for SurrealQL, vector search, and the Python SDK, while rules give your agent persistent guidelines for writing better SurrealDB code.
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>ETL and data pipeline automation</td>
    </tr>
    <tr>
      <td><a href="/docs/integrations/data-management/n8n">n8n</a></td>
      <td>Workflow automation platform for custom event-driven automations</td>
    </tr>
    <tr>
      <td><a href="/docs/integrations/data-management/qyrus">Qyrus</a></td>
      <td>Data quality assurance and validation (Compare and Evaluate jobs)</td>
    </tr>
  </tbody>
</table>
