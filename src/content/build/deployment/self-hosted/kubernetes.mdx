...
For **multi-node HA**, use [SurrealDB Cloud Scale](https://surrealdb.com/pricing/scale) (SurrealDS) or [SurrealDB Enterprise](https://surrealdb.com/enterprise) on managed Kubernetes — see the [Amazon EKS](/docs/build/deployment/self-hosted/amazon-eks), [Google GKE](/docs/build/deployment/self-hosted/google-gke), and [Azure AKS](/docs/build/deployment/self-hosted/azure-aks) option pages. Do not use TiKV for production HA.
