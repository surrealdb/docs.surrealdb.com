...
- [`helm`](https://helm.sh/docs/intro/install/) to install SurrealDB and the data store operator
...
> [!NOTE]
> This guide was tested in <code>westeurope</code> region and follows best practices for scalability and high availability.
...
3. Create a data store node pool:
