...
Once it is installed, you can connect to your SurrealDB Cloud Instance using the [`surreal sql`](/docs/reference/cli/surrealdb-cli/sql) command. This command connects to your SurrealDB Cloud Instance using the specified endpoint and token. 
