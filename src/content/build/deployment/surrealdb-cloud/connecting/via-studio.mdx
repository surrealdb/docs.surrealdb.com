...
description: "Query your SurrealDB Cloud instance using SurrealDB Studio."
---

# Querying in SurrealDB Studio

Once you have created a SurrealDB Cloud Instance, you can start querying it in SurrealDB Studio in the [query view](/docs/explore/studio).

In the query view, and before you can run queries in SurrealDB Studio, you need to select a [Namespace](/docs/concepts) and a [Database](/docs/concepts) to work in.
...
Learn more about [SurrealDB Studio](/docs/explore/studio) and SurrealQL in the [SurrealDB documentation](/docs/reference/query-language).
