...
Learn more about [namespaces and databases](/docs/concepts#system-structure) in the SurrealDB documentation.
...
If you want to create a Namespace and Database authentication for record-level access, you will need to first create a Namespace and Database. Learn more about [namespaces and databases](/docs/concepts#system-structure) in the SurrealDB documentation.
