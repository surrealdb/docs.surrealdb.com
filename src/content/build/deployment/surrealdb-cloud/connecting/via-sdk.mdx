...
Once you have created a SurrealDB Cloud Instance, you can connect to it using any of the [available SDKs](/docs/start). This allows you to interact with your SurrealDB Cloud Instance programmatically.
...
Learn more about [namespaces and databases](/docs/start/concepts#system-structure) in the SurrealDB documentation.

### Create a root authentication

> [!NOTE]
> This step is only required if you are authenticating using the `signin` method on your initial connection. Learn more about [access methods](/docs/reference/query-language/statements/define/access) and [system Users](/docs/reference/query-language/statements/define/user) in the SurrealDB documentation.
...
If you want to create a Namespace and Database authentication for record-level access, you will need to first create a Namespace and Database. Learn more about [namespaces and databases](/docs/start/concepts#system-structure) in the SurrealDB documentation.
...
> [!NOTE]
>If you are using a non-root user, depending on the access method you have created, you will need to fill in the `access` details to sign in to your SurrealDB Cloud Instance. Please refer to the [documentation for your specific SDK](/docs/start) for more information.
...
Learn more about the [SurrealDB SDKs](/docs/start) in the SurrealDB documentation.
