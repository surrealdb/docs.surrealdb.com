...
See [Cloud architecture](/docs/build/deployment/surrealdb-cloud/architecture) for diagrams and [Deployment](/docs/build/deployment) for how Cloud fits alongside self-hosted and embedded options.
      ...
      <TabItem label="Create an instance">
        <div className="flex flex-col md:flex-row items-start justify-between">
          <div className="flex-1">
            ...
            <h4>4. Finalise and connect to your Instance.</h4>
