...
- **Start** — one compute node with dedicated storage; scale vertically by resizing the instance. Includes a free tier for getting started.
- **Scale** — multi-node, highly available clusters on [SurrealDS](https://surrealdb.com/platform/surrealds) for production workloads that need horizontal scale and fault tolerance.
