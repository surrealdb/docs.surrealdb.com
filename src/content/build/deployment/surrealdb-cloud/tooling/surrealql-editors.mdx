...
description: "SurrealQL editor shortcuts in SurrealDB Studio when working with SurrealDB Cloud for indentation, comments, multi-cursor edits, run query, record inspection, and JSON formatting for values."
---
