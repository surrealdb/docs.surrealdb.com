...
This will take you to the [create a new Instance](/docs/build/deployment/surrealdb-cloud/getting-started/create-an-instance#create-an-instance) page with the backup option already selected.
