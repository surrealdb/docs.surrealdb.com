...
After you create a new Organisation, you will be automatically added as [the owner of the Organisation](/docs/build/deployment/surrealdb-cloud/getting-started/create-an-organisation#manage-organisation-permissions). As an Organisation owner, you can manage your Organisation instances, team, usage and billing information from the overview page. 

To create a new Instance, click on the **Deploy Instance** button and follow the steps in the [create an instance](/docs/build/deployment/surrealdb-cloud/getting-started/create-an-instance) documentation.
...
Depending on your permissions, the overview page will show different sections. More information about the different roles and permissions can be found in the [manage Organisation permissions](/docs/build/deployment/surrealdb-cloud/getting-started/create-an-organisation#manage-organisation-permissions) section.

## Invite members to your organisation

To invite members to your Organisation, click on the **Team** tab and then the **Invite member** button. This will open a modal where you can invite a new member to your Organisation and the role of the member. Learn more about what each role does in the [manage Organisation permissions](/docs/build/deployment/surrealdb-cloud/getting-started/create-an-organisation#manage-organisation-permissions) section.
...
<table style={{ width: '100%' }}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>Can do everything an owner can do except for managing the [billing information](/docs/build/deployment/surrealdb-cloud/billing-and-support/billing) or update other users permissions</li>
        </ul>
      </td>
    </tr>
    <tr>
...
- [Create an Instance](/docs/build/deployment/surrealdb-cloud/getting-started/create-an-instance)
