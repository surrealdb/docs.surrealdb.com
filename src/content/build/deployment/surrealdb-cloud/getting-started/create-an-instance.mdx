...
SurrealDB Cloud allows you to create a new Instance with a few clicks. You can create an Instance in your personal account or in an organisation. 
...
> [!IMPORTANT]
> Learn more about configuring [network access](/docs/build/deployment/surrealdb-cloud/operations/network-access) in the advanced topics section.
...
Now that you have created an Instance, you can [connect to your SurrealDB Cloud Instance](/docs/build/deployment/surrealdb-cloud/connecting).