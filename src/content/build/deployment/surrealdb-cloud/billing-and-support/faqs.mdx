...
### What kind of support is available for SurrealDB Cloud?

For details on the types of support offered for SurrealDB Cloud, see [this page](/docs/build/deployment/surrealdb-cloud/billing-and-support/support).
...
- [JavaScript/TypeScript](/docs/reference/javascript/overview)
- [Python](/docs/reference/python)
- [Go](/docs/reference/golang)
- [Java](/docs/reference/java)
- [Rust](/docs/reference/rust/overview)
...
SurrealDB Cloud allows users to authenticate directly into their instances from SurrealDB Studio using a pre-defined access method. Once connected to your Instance, you may [define users](/docs/reference/query-language/statements/define/user) or [access methods](/docs/reference/query-language/statements/define/access) that users can use to access your Instance or specific namespaces or databases using any of the available [interfaces](/docs/reference/rest-api), the [SurrealDB CLI](/docs/reference/cli/surrealdb-cli/overview) or [SurrealDB Studio](https://app.surrealdb.com/query).
...
- [SurrealDB Docs](/docs/): Comprehensive guides and references for all features, including docs to accompany [SurrealDB Studio](/docs/explore/studio)
