...
For managed multi-node clusters, use the [Scale](https://surrealdb.com/pricing/scale) plan on [SurrealDB Cloud](/docs/build/deployment/surrealdb-cloud/what-is-surrealdb-cloud). For self-hosted SurrealDS on Kubernetes, use [SurrealDB Enterprise](https://surrealdb.com/enterprise); the [Amazon EKS](/docs/build/deployment/self-hosted/amazon-eks), [Google GKE](/docs/build/deployment/self-hosted/google-gke), and [Azure AKS](/docs/build/deployment/self-hosted/azure-aks) pages summarise options per cloud. For a local Community playground against open-source distributed storage (TiKV), see [Run a multi-node cluster](/docs/running/multi-node) — that path is not SurrealDS.
...
**IndexedDB (browser)** — Browser-native persistence with binary serialisation for PWAs and local-first web apps. See [Embedding SurrealDB](/docs/build/embedding) and the [Wasm engine](/docs/reference/javascript/engines/wasm).
...
For managed clusters, use [SurrealDB Cloud Scale](https://surrealdb.com/pricing/scale). For self-hosted SurrealDS, see [SurrealDB Enterprise](https://surrealdb.com/enterprise) and the [EKS](/docs/build/deployment/self-hosted/amazon-eks), [GKE](/docs/build/deployment/self-hosted/google-gke), or [AKS](/docs/build/deployment/self-hosted/azure-aks) option pages.
