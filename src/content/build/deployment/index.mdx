...
Cloud plans range from **Start** (single-node, vertically scalable instances) to **Scale** (multi-node, highly available clusters on [SurrealDS](https://surrealdb.com/platform/surrealds)). See [Cloud architecture](/docs/build/deployment/surrealdb-cloud/architecture) and [Pricing](https://surrealdb.com/pricing).

For more detail, see [What is SurrealDB Cloud?](/docs/build/deployment/surrealdb-cloud/what-is-surrealdb-cloud).
...
For managed multi-node clusters, use the [Scale](https://surrealdb.com/pricing/scale) plan on [SurrealDB Cloud](/docs/build/deployment/surrealdb-cloud/what-is-surrealdb-cloud). For self-hosted highly available setups on Kubernetes with SurrealDB Enterprise, see [Amazon EKS](/docs/build/deployment/self-hosted/amazon-eks), [Google GKE](/docs/build/deployment/self-hosted/google-gke), and [Azure AKS](/docs/build/deployment/self-hosted/azure-aks). For local development against distributed storage, see [Run a multi-node cluster](/docs/running/multi-node).
...
For managed clusters, use [SurrealDB Cloud Scale](https://surrealdb.com/pricing/scale). For self-hosted Kubernetes with Enterprise, follow the [EKS](/docs/build/deployment/self-hosted/amazon-eks), [GKE](/docs/build/deployment/self-hosted/google-gke), or [AKS](/docs/build/deployment/self-hosted/azure-aks) guides.
