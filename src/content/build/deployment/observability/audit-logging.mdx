...
The full set of configuration variables lives on the [configuration reference](/docs/build/deployment/observability/configuration#audit-log-knobs).
...
The slow-query pipeline exposes the same shape under the `surrealdb_slow_query_*` prefix — see [slow-query logging](/docs/build/deployment/observability/slow-query-logging#pipeline-self-metrics).

## Related references

- [Configuration → Audit log knobs](/docs/build/deployment/observability/configuration#audit-log-knobs) — every audit-log environment variable.
- [Configuration → Compliance checklist](/docs/build/deployment/observability/configuration#compliance-checklist) — the minimum tamper-evident configuration.
- [Slow-query logging](/docs/build/deployment/observability/slow-query-logging) — the sister pipeline for triage data.
- [Metrics reference → Audit log pipeline self-metrics](/docs/build/deployment/observability/metrics#audit-log-pipeline-self-metrics) — the five gauges in the metric catalogue.
