...
The assistant lists your organisations, picks the one you meant or asks which, and reports every instance with its region, size, version, and state. This is a good first prompt, because it confirms the connection is working.
...
The assistant creates the [SurrealDB Agent Memory](/docs/agent-memory) context, registers a scope path for the project, and stores the decision in it.
