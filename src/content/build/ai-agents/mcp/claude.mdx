...
Claude lists your organisations, picks the one you meant, and reports each instance with its state. [Example usages](/docs/build/ai-agents/mcp/examples) has more to try, including deploying an instance and querying its data.
