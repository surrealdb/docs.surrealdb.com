...
Use a token when your client cannot open a browser, or when something runs unattended. Create one in the [account portal](https://account.surrealdb.com), tick the permissions it should carry, and pass it to your client as a header:
