...
This requires an index to be created beforehand. Refer to the [vector search cheat sheet](/docs/learn/data-models/vector-search/using-as-vector-database#vector-search-cheat-sheet).
