...
- **Deduplication** - Deterministic record IDs derived from content hashes prevent duplicate records across ingestion runs.
...
pub fn connector_schema(table: &str) -> String {
    format!(
        ...
        DEFINE INDEX IF NOT EXISTS idx_doc_content ON TABLE {table} FIELDS content FULLTEXT ANALYZER doc_analyzer BM25 HIGHLIGHTS;"
        )
}
