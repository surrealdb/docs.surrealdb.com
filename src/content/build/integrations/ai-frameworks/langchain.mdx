...
This unified system adeptly handles structured and unstructured data, incorporating vector search, [graph traversal](/docs/learn/data-models/graph/using-as-graph-database), [relational queries](/docs/learn/data-models), [full-text search](/docs/learn/data-models/full-text-search/using-as-full-text-search-database), [document storage](/docs/learn/data-models/document/using-as-document-database), and [time-series data](/docs/learn/data-models/time-series/using-as-time-series-database) all within one ACID-compliant engine. 
...
1. [Install SurrealDB](/docs/start/self-hosted/installation) and run [SurrealDB](/docs/start/self-hosted/in-memory). Run in-memory with:

    ```sh
    surreal start -u root -p root
    ```

2. [Run with Docker](/docs/start/self-hosted/docker).
...
* `surrealdb` → [SurrealDB Python SDK](/docs/start/languages/python/)
...
* Explore the [SurrealDB vector-search reference](/docs/learn/data-models/vector-search/using-as-vector-database) for detailed technical information
