...
Install the adapter alongside `better-auth` and the [SurrealDB JavaScript SDK](/docs/languages/javascript):
...
For a full reference of connection options, see [Connecting to SurrealDB](/docs/languages/javascript/concepts/connecting-to-surrealdb) in the JavaScript SDK documentation.
