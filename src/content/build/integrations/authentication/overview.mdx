...
By default, Better Auth generates string identifiers in JavaScript. The adapter stores them as SurrealDB [record IDs](/docs/surrealql/datamodel/ids) and deserialises them back to strings when reading, so a record round-trips to your application as the plain string `id`.
