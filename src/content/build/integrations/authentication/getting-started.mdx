...
- [Overview](/docs/build/integrations/authentication/overview): adapter capabilities and prerequisites
- [Plugins](/docs/build/integrations/authentication/plugins): use any Better Auth plugin and the SurrealQL helper functions generated for the organisation plugin.
- [Transactions & limitations](/docs/build/integrations/authentication/transactions-and-limitations): how transactions behave and what to be aware of.
