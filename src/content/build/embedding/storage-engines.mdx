...
Typical options you will see in SurrealDB deployments include RocksDB for mature local disk storage and SurrealKV where you want SurrealDB’s own LSM-backed path (including features that evolve with the product). In-memory modes are ideal for tests and scratch work, not durability.
