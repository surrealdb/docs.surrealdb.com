...
How to choose: start from your hosting model (embedded, single server, cluster) and read the architecture overview for [storage layers](/docs/architecture#storage-layer). Then follow the embedding guides for your language under [embedding SurrealDB](/docs/build/embedding) for what your SDK supports today—capabilities vary by platform and release.
