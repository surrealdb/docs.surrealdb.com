...
SurrealDB can be run [as an embedded database](/docs/start/languages/golang/embedding) within your Go application, allowing you to use SurrealDB without running a separate server process. This is ideal for desktop applications, testing, local development, and edge computing scenarios.
...
For complete documentation, installation instructions, examples, best practices, and troubleshooting, see the [Go SDK embedding guide](/docs/start/languages/golang/embedding).
