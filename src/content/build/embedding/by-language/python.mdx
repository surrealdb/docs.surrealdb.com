...
```
 ...
 For complete documentation, installation instructions, examples, best practices, and troubleshooting, see the [embedding in Python](/docs/build/embedding/by-language/python) guide.
