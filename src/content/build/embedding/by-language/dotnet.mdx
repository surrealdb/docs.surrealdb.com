...
For complete documentation, installation instructions, examples, best practices, and troubleshooting, see the [.NET SDK embedding guide](/docs/reference/dotnet/embedding).