...
For the full list of available options for each command, see the [export command](/docs/reference/cli/surrealdb-cli/export) and [import command](/docs/reference/cli/surrealdb-cli/import) documentation.
