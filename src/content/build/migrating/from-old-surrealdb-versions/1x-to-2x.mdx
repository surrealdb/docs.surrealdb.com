...
- The `DEFINE SCOPE` statement has been dropped in favour for the new [`DEFINE ACCESS TYPE RECORD`](/docs/reference/query-language/statements/define/access/record) statement
