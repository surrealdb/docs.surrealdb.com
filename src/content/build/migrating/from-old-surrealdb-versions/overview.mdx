...
Upgrading the SurrealDB server itself is done through a single command: [`surreal upgrade`](/docs/reference/cli/surrealdb-cli/upgrade). For minor versions, a read through the [release notes](/releases) will suffice to see which breaking changes may exist.
