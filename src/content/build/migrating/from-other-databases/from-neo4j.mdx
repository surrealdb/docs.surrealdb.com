...
As Neo4j is schemaless, only the SurrealQL schemaless approach is shown below. For a schemafull option see the [`DEFINE TABLE`](/docs/reference/query-language/statements/define/table) page.

For more SurrealQL examples, see the [`CREATE`](/docs/reference/query-language/statements/create), [`INSERT`](/docs/reference/query-language/statements/insert) and [`RELATE`](/docs/reference/query-language/statements/relate) pages.
...
Graph relations via the [RELATE](/docs/reference/query-language/statements/relate) statement:
