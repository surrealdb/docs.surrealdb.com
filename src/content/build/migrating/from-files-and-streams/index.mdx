...
The sources in this section of the documentation can be automatically imported to SurrealDB using the [Surreal Sync](https://github.com/surrealdb/surreal-sync/) tool. In addition, [CSV data](/docs/build/migrating/csv) can be automatically imported into SurrealDB Studio using its own [built-in functionality](/docs/explore/studio).
