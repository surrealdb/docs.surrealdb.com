...
One account gets you into [SurrealDB Studio](https://app.surrealdb.com), where you manage [organisations](/docs/manage/organisations) and [instances](/docs/manage/instances).
