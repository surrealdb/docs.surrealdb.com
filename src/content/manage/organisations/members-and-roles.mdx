...
> [!NOTE]
> Each role is a fixed set of permissions. An [enterprise](/docs/manage/organisations/enterprise) adds roles you compose yourself, which govern the administration of members, domains, and single sign-on rather than of instances.
