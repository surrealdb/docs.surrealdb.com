...
- **SurrealDS cluster instruments** (`surrealdb.ds.*`) — consensus, networking, recovery, and garbage collection when SurrealDS is the active storage backend ([SurrealDB Cloud](https://surrealdb.com/pricing) Scale tiers and self-hosted Enterprise).
