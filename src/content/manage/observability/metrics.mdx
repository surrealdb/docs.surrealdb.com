...
> [!NOTE]
> SurrealDS as a deployable distributed storage layer is **coming soon**. These instruments apply when an Enterprise build runs the DS runtime and are documented here for reference ahead of general availability.
