...
4. [Enterprise observability](/docs/manage/observability/enterprise-observability) - cluster metrics, audit and slow-query file pipelines, pipeline self-metrics, and OTLP log export opt-ins.
...
<Boxes>
    ...
    <IconBox
        ...
        description="Cluster metrics, audit and slow-query pipelines, and OTLP log export opt-ins."
...
For async runtime introspection (tasks, poll histograms), use the [Tokio console](/docs/manage/observability/tokio-console) on trusted hosts only. It complements OTLP and `/metrics` rather than replacing them.
