...
> [!NOTE]
> **SurrealDS is coming soon.** The `SURREAL_DS_*` variables below apply when the distributed datastore runtime is deployed; they are documented ahead of general availability for Enterprise operators planning cluster rollouts.
