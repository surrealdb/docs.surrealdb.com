...
When OTLP is enabled, audit and slow-query records can also flow as OpenTelemetry logs. Severity mapping and dual paths (file sink versus OTLP) are summarised on [Prometheus (pull)](/docs/build/deployment/observability/observability) and in [OBSERVABILITY.md](https://github.com/surrealdb/surrealdb/blob/main/doc/OBSERVABILITY.md) on GitHub.