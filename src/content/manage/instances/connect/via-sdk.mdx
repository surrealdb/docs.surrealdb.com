...
Reach an instance from application code through one of the [SurrealDB SDKs](/docs/languages).
...
> [!NOTE]
> With a non-root user, the sign-in call also needs the `access` details for the access method you defined. The [SDK reference](/docs/languages) for your language shows the exact call.
...
- **[SDK reference](/docs/languages):** the full API for each language, including live queries and transactions.
