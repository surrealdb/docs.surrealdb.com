...
Instances build on [the layered architecture of SurrealDB](/docs/architecture), which separates storage from compute. That separation lets an instance grow, replicate, and recover without you sharding or resharding the database yourself.
