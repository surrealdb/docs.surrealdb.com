...
Both commands come from the [SurrealDB CLI](/docs/reference/cli/surrealdb-cli/overview), which you install once and point at any instance. The connection URL, namespace, and database are on the **Connect** menu of the instance in [SurrealDB Studio](https://app.surrealdb.com).
