...
Changing instance type **within** Start is in place, and that includes leaving the free type: pick a Burstable or General purpose type under [Compute and storage](/docs/manage/instances/configure#compute-and-storage) and the instance keeps its data, its name, and its endpoint. Only the move to Scale needs a new instance, because the node layout changes. Resume a paused instance before changing its type.
