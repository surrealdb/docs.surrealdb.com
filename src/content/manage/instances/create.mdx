...
The region selector shows what is available to your organisation, and that list is the authoritative one. [AWS PrivateLink](/docs/manage/instances/private-connectivity) is offered in a subset of AWS regions.
...
Storage is provisioned per instance, and the available range depends on the plan and the instance type. On Start, the range grows with the memory of the type: see the [Storage limits on Start](/docs/manage/instances/scaling#storage-limits-on-start) page for more details.
