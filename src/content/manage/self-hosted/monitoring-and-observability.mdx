...
For **server logs** (levels, JSON, files, sockets), see [Logging](/docs/manage/observability/logging). For **metrics and distributed traces**, use the [Observability overview](/docs/manage/observability). There you can find details on how to configure a collector with [Telemetry (OTLP)](/docs/manage/observability/telemetry) (`SURREAL_TELEMETRY_PROVIDER=otlp` and your endpoint), and use [Observability (metrics and Prometheus)](/docs/manage/observability/observability) for `/metrics`, naming, and scrape authentication.
