...
The CLI provides logical backups of a self-hosted server as SurrealQL using [`surreal export`](/docs/reference/cli/surrealdb-cli/commands/export), which dumps namespaces, databases, schemas, and data in a form you can version, diff, and store outside the database.
