...
> [!NOTE]
> Package manager entries track the release channel and can lag a new version by a few hours. If a command below does not find the version you expect, [download the binary](#download-a-binary) from `download.surrealdb.com/surrealctl/`, which always has it.
