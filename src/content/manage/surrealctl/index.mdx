...
position: 1
title: surrealctl
description: "The control-plane CLI for SurrealDB Cloud: what surrealctl does, when to reach for it instead of Studio or the surreal binary, and a sixty-second quickstart."
---
