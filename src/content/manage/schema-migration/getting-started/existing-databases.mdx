...
See the [Rollouts](/docs/manage/schema-migration/rollouts) page for the full reference.
...
- [Rollouts](/docs/manage/schema-migration/rollouts): full reference for the phased migration workflow
- [Sync vs Rollouts](/docs/manage/schema-migration/getting-started/sync-vs-rollouts): a side-by-side comparison
