...
Place `surrealkit.toml` in the root of your project. It is read automatically. The same file also holds the [`[typegen]` section](/docs/manage/schema-migration/typegen) when TypeScript generation is enabled.
