...
<img src="~/assets/img/image/cloud/aws-privatelink-surrealist-light.png" darkSrc="~/assets/img/image/cloud/aws-privatelink-surrealist-light.png" alt="SurrealDB Studio instance creation screen with the Network Access panel highlighted, showing the Public and Private toggle used to enable AWS PrivateLink connectivity." />
