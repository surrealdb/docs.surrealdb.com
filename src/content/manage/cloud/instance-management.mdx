...
<img src="~/assets/img/image/cloud/light/architecture-light.png" darkSrc="~/assets/img/image/cloud/architecture-dark.png" alt="A SurrealDB Cloud instance: the [instance-id].surreal.cloud endpoint fronts multiple compute nodes that share centralised storage on Amazon S3." />
