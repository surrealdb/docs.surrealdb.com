...
See [Cloud architecture](/docs/manage/cloud/architecture) for how Start and Scale differ.
...
Change the **instance type**, **compute units**, or **storage** from the Cloud console or SurrealDB Studio, following any confirmation steps for your plan. After scaling, **re-check metrics** and query performance to validate the new size.
