...
* Adding some interesting behaviour to the database such as [changefeeds](https://surrealdb.com/docs/surrealql/statements/define/table#example-usage) or [events](https://surrealdb.com/docs/surrealql/statements/define/event).