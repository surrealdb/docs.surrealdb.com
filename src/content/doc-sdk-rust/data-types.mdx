...
The Rust SDK translates all datatypes native to SurrealQL into either datatypes native to Rust, or a custom implementation. This document describes all datatypes, and links to their respective documentation.
    ...
    <tbody>
        <tr>
            ...
            <td colspan="2" scope="row">
                <a href="https://doc.rust-lang.org/std/string/struct.String.html">
                    <code>String</code>
                </a>
            </td>
        </tr>
