...
The Python SDK has a [`.query()` method](/docs/1.x/sdk/python/concepts/writing-surrealql) which allows you to write secure SurrealQL statements from within your application. Using this method, you can define access for your users and securely manage authentication. See the code example below:
...
> [!NOTE]
> Depending on the connection protocol you choose, authentication tokens and sessions lifetime work differently. Refer to the [connection options](/docs/1.x/sdk/python/concepts/create-a-new-connection#effect-of-connection-protocol-on-token--session-duration) documentation for more information.
