...
![Surrealist designer view showing four schemaless tables without a specified connection between them.](~/assets/img/surrealdb/models/schema1.avif)
...
![Surrealist designer view showing three schemaless tables together with a likes table that has been defined as a relation.](~/assets/img/surrealdb/models/schema2.avif)
...
![Surrealist designer view showing four schemafull tables: three regular tables and one relation table linking them.](~/assets/img/surrealdb/models/schema3.avif)
