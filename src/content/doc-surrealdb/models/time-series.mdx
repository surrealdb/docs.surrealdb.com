...
### Complex record IDs
A more optimised way of working with the `sensor_readings` table in a time series context would however be using either array-based or object-based record IDs, otherwise known as complex record IDs.
