...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td colspan="2" scope="row" data-label="MQL">
        db.review\.aggregate(\[\{ "$lookup": \{ "from": "person", "localField": "person", "foreignField": "\_id", "as": "person\_detail" } }])
      </td>
...
<table>
  ...
  <tbody>
    <tr>
      <td colspan="2" scope="row" data-label="MQL">
        db.person.updateMany(\{ name: "Jane" }, \{ $set: \{ last\_name: "Doe" } })
      </td>
    ...
    <tr>
      <td colspan="2" scope="row" data-label="MQL">
        db.person.updateMany(\{ name: "Jane" }, \{ $unset: \{ last\_name: 1 } })
      </td>
