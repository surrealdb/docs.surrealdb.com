...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td scope="row" data-label="Function"><a href="#insert"><code>insert [ thing, data, update ]</code></a></td>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
            One or multiple update(s) for all records
            </td>
        </tr>
    </tbody>
</table>
