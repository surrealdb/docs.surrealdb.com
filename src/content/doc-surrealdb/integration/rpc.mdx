...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#insert_relation"><code>insert\_relation \[ table, data ]</code></a></td>
    ...
    <tr>
      <td scope="row" data-label="Function"><a href="#run"><code>run \[ func\_name, version, args ]</code></a></td>
