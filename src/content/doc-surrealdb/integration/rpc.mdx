...
This method allows you to signin as a root, namespace, or database user, or with a record access method
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                Specifies any variables to pass to the `SIGNIN` query. Only required for `RECORD` authentication
            </td>
        </tr>
    </tbody>
</table>
