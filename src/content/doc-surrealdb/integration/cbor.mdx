...
A [Future](/docs/surrealql/datamodel/futures) represented as a string containing the uncomputed SurrealQL query or expression, to access the future value you need to surround it with `{}, when returned the trasported value will also be of type object. 
