...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td scope="row" data-label="Value">
                [Included Bound](/docs/surrealql/datamodel/ranges#included-bound)
            </td>
        </tr>
        <tr>
            <td scope="row" data-label="Tag">
            ...
            <td scope="row" data-label="Value">
                [Excluded Bound](/docs/surrealql/datamodel/ranges#excluded-bound)
            </td>
        </tr>
        <tr>
            <td scope="row" data-label="Tag">
...
A [Future](/docs/surrealql/datamodel/futures) represented as a string containing the uncomputed SurrealQL query or expression. The future will be computed when accessed or used within a query.
