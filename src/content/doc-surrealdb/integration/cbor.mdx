...
A [UUID](/docs/surrealql/datamodel/uuid) represented in a binary format. Please reference ([https://docs.rs/uuid/latest/uuid/struct.Uuid.html#method.as\_bytes](https://docs.rs/uuid/latest/uuid/struct.Uuid.html#method.as_bytes)).
