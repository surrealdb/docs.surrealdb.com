...
> [!NOTE]
> For Python `3.9`, `3.10`, `3.11`, `3.12`, and `3.13`. For source builds, you'll need a [Rust toolchain](/docs/sdk/rust/installation) and [maturin](https://github.com/PyO3/maturin).
...
Once the file provider is configured, you can use the Python SDK the same way you would with a remote database. Please refer to the [Python SDK documentation](/docs/sdk/python) to get started.
