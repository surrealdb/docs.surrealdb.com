...
import LightEmbed from '@img/icon/light/embedded.png';
...
<Boxes wider class="pt-2">
                    ...
                    description="Surreal Sidekick is your personal assistant that helps you learn SurrealDB by providing you with a set of questions and answers that cover SurrealDB, SurrealQL and all the other products we offer."
