...
import LightUniversity from '@img/icon/light/univserity-light.png';
...
import EmbeddingLight from '@img/icon/light/embedding-light.png';
import EmbeddingDark from '@img/icon/dark/embedding.png';

import CLIlight from '@img/icon/light/cli-light.png';
import CLIdark from '@img/icon/dark/cli.png';
...
<div class="flex gap-4 items-center justify-center">
    <a href="/docs/surrealdb/installation" class="group inline-flex w-1/2 gap-1.5 items-center justify-center px-6 py-3 font-medium bg-gradient-to-r from-surreal-pink to-surreal-purple rounded-lg border-white/30 border bg-origin-border transition-colors hover:text-white">
    ...
    <a href="/docs/surrealdb/introduction/start" class="group inline-flex w-1/2 gap-1.5 items-center justify-center px-6 py-3 font-medium bg-gradient-to-r from-surreal-pink to-surreal-purple rounded-lg border-white/30 border bg-origin-border transition-colors hover:text-white">
