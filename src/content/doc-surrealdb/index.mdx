...
<Boxes columns={3} wider class="pt-2">
	...
	<IconBox
		title="JavaScript"
		status="available"
		description="Connect to SurrealDB over WebSocket or HTTP, with additional embedded engines available."
	...
	<IconBox
		title="Node.js"
		status="available"
		description="Pluggable adapter for the JavaScript SDK, providing support for SurrealDB embedded in-memory and on-disk."
	...
	<IconBox
		title="WASM"
		status="available"
		description="Pluggable adapter for the JavaScript SDK, providing support for SurrealDB embedded in-memory and indexedDB."
