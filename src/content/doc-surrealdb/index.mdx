...
SurrealDB is a native, open-source, [multi-model database](/features) that lets you store and manage data across relational, document, graph, time-series, vector & search, and geospatial models—all in one place.
