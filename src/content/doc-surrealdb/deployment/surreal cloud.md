...
<div class="flag-title">
	<img src="~/assets/img/image/cloud/surrealcloud.png" alt="SurrealDB Cloud " style="width: 42px; height: 42px" />
...
<img src="~/assets/img/image/cloud/create-an-instance.png" alt="Querying Instance" />
...
<img src="~/assets/img/image/cloud/open-in-surrealist.png" alt="Open in Surrealist" />

To create a [namespace](/docs/surrealdb/introduction/concepts#namespaces-and-databases), click on the **Create Namespace** button. This will open a modal to input the name of the namespace. Once you've input the name, click on the **Create** button. 
...
To create a [database](/docs/surrealdb/introduction/concepts#namespaces-and-databases), click on the **Create Database** button. This will open a modal to input the name of the database. Once you've input the name, click on the **Create** button. This will create the database.
...
<img src="~/assets/img/image/cloud/querying-instance.png" alt="Write queries in Surrealist" />
...
<img src="~/assets/img/image/cloud/open-in-sdk.png" alt="Open in SDK" />
