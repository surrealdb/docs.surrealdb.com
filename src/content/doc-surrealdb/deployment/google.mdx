...
2. Run the following command to create a cluster replacing the REGION and PROJECT\_ID for your desired values:
...
2. Install the SurrealDB Helm chart with the TIKV\_URL defined above and with auth disabled so we can create the initial credentials:
