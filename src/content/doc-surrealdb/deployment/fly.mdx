...
We will store the username and password for the root user in secrets. Feel free to pass on any other options here. You can use `surreal start -help` to see which [environment variables](/docs/surrealdb/cli/env_vars) can be passed to surreal.
