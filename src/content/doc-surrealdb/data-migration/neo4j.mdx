...
Neo4J data types are either fully supported via direct conversion, or partially supported via an object that maintains the information in the original type. For more on these data types, see [this page](https://github.com/surrealdb/surreal-sync/blob/main/docs/neo4j-data-types.md).
