...
import LightLogo from "@img/light/ql.png";
import DarkLogo from "@img/ql-icon.png";
...
- [Select Statement](/docs/surrealdb/surrealql/statements/select): Learn how to retrieve data from your SurrealDB database using the `SELECT` statement and explore various querying options:
