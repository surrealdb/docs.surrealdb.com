...
import LightOverview from "@img/light/surreal-deal-store-light.png";
import LightSchema from "@img/light/surreal_deal_light.png";

import DarkOverview from "@img/surreal-deal-store.png";
import DarkSchema from "@img/surreal_deal_dark.png";
