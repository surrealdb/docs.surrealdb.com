...
![A flowchart showing the steps involved to turn regular Rust code into a compiled WASM binary that can be accessed from a running SurrealDB instance.](~/assets/img/surrealdb/extensions/surrealism_flow.avif)
