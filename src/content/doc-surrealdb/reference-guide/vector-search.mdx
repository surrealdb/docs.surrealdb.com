...
- Brute force: when you don’t define an index, or when you provide a distance function to the query
...
| LM            | 0.40242960438184466f |              | multiplier for level generation
