...
- Brute force: when you don’t define an index, or you want exact nearest neighbour, or when you provide a distance function to the query
...
-- We suggest to not set an LM value. It is computed based on other parameters. Users should only change this value if they know what they are doing
```
