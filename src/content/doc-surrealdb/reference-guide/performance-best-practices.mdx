...
Read more about running SurrealDB [using Surreal Cloud](https://surrealdb.com/cloud).
...
Read more about [running SurrealDB embedded in Rust.](http://localhost:4321/docs/surrealdb/embedding/rust)
