...
It will provide you with a solid foundation of the core concepts and features of SurrealDB, and help you understand how different features and concepts are related to each other and how you can use them together to build powerful applications.

If you are new to SurrealDB, we recommend that you start with the [Getting Started](/docs/surrealdb/introduction/start) or [SurrealQL](/docs/surrealql) sections of the documentation.
