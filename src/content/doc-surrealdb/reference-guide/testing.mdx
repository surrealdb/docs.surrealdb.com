...
The main advantage to the language tests tool is that it can be configured for a variety of options and situations, including (among many other parameters):
