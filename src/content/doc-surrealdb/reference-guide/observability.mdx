...
![A screenshot of the tokio console showing active SurrealDB tasks.](~/assets/img/surrealdb/reference-guide/tokio_console_1.avif)

![A screenshot of the tokio console showing poll times by percentile.](~/assets/img/surrealdb/reference-guide/tokio_console_2.avif)
