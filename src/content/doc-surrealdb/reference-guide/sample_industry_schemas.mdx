...
title: Simple sample schemas by industry to get startedUsing SurrealDB as a Vector Database
...
Traditional bank-customer schema plus record references and events for cent values and historical interest rates:
