...
Note that you will need to use the [--allow-net](https://surrealdb.com/docs/surrealdb/security/capabilities#network) flag when starting up a SurrealDB instance to allow functions like `http::post()` to work, as they are disabled by default.
