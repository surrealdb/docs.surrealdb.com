...
- [Tutorial: Integrate Auth0 as an authentication provider](/docs/surrealdb/tutorials/integrate-auth0-as-authentication-provider)
- [Tutorial: Integrate AWS Cognito as an authentication provider](/docs/surrealdb/tutorials/integrate-aws-cognito-as-authentication-provider)
