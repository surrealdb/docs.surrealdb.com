...
For more SurrealQL examples, see the [select](/docs/surrealql/statements/select), [live select](/docs/surrealql/statements/live_select) and [return](/docs/surrealql/statements/return) pages.
