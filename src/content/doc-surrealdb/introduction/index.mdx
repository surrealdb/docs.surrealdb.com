...
SurrealDB is open-source (see our [GitHub](https://github.com/surrealdb/surrealdb) page) and is also available as a cloud managed service through [SurrealDB Cloud](https://surrealdb.com/cloud).
