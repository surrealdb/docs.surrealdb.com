...
SurrealDB is a [multi-model database](https://surrealdb.com/blog/what-are-multi-model-databases) built in Rust designed to unify multiple data models into a single, powerful engine. It combines [document](https://surrealdb.com/docs/surrealdb/models/document), [graph](https://surrealdb.com/docs/surrealdb/models/graph), [time-series](https://surrealdb.com/docs/surrealdb/models/time-series), [relational](https://surrealdb.com/docs/tutorials/define-a-schema), [geospatial](https://surrealdb.com/docs/surrealdb/models/geospatial) and key-value data types in one query language, [SurrrealQL](https://surrealdb.com/docs/surrealql), with powerful search and retrieval ([vector](https://surrealdb.com/docs/surrealdb/models/vector), [full-text](https://surrealdb.com/docs/surrealdb/models/full-text-search), hybrid), and real-time and event-driven capabilities, enabling developers to build applications faster and more efficiently.
