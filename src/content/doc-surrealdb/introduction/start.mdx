...
When we say [multi-model](/blog/what-are-multi-model-databases), we mean that SurrealDB can store and query data in a variety of ways. You can use SurrealDB as a [Graph](/docs/surrealdb/reference-guide/graph_relations), [Document](/docs/surrealdb/reference-guide/graph_relations), [Time-Series](/blog/its-about-time-time-series-in-surrealdb), or [Vector](/docs/surrealdb/reference-guide/vector-search) database and it is all designed to be queried with our [SurrealQL](/docs/surrealql) query language. 
