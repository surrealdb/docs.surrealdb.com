...
After inserting records into your database, you can now use the [SELECT statement](/docs/surrealql/statements/select) to retrieve data. While this statement will be familiar to anyone who has used traditional SQL before, SurrealDB's SELECT statement includes additional powerful features inspired by NoSQL databases.
...
You can also delete records from your database using the [DELETE statement](/docs/surrealql/statements/delete). This statement allows you to remove records from your database, either by specifying the record ID, or by using specific conditions.
...
- [Connect to your SurrealDB Cloud instance](/docs/cloud/connect)
...
- [Running an in-memory server](/docs/surrealdb/installation/running/memory)
