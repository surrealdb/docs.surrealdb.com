...
This makes deploying SurrealDB really convenient, since your fault tolerance is equal to the number of replicas (minus 1, the bare minimum number of instances). Though we do have bootstrapping, by design nodes can come and go as they please without much interference.
