...
<tr>
    ...
    <tr>
      ...
      <td scope="row" data-label="Default">false</td>
      <td scope="row" data-label="Allowed values">true, false</td>
      <td scope="row" data-label="Notes">Whether strict mode is enabled on this database instance. Ignored since SurrealDB 3.0 after which strictness is defined [per database](/docs/surrealql/statements/define/database#defining-a-strict-database) instead of instance.</td>
    </tr>
    <tr>
