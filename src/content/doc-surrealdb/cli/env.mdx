...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td scope="row" data-label="Notes"><Since v="v3.0.0-alpha.17" /> The default database to use when starting a SurrealDB instance.</td>
    </tr>
    <tr>
      <td scope="row" data-label="Env var"><code>SURREAL_DEFAULT_NAMESPACE</code></td>
      <td scope="row" data-label="Default">main</td>
      <td scope="row" data-label="Notes"><Since v="v3.0.0-alpha.17" /> The default namespace to use when starting a SurrealDB instance.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td scope="row" data-label="Default">false</td>
      <td scope="row" data-label="Notes"><Since v="v3.0.0-alpha.17" /> Whether to disable default namespace and database creation. Conflicts with SURREAL_DEFAULT_DATABASE and SURREAL_DEFAULT_NAMESPACE, which set a default value for namespace and database for a new instance.</td>
    </tr>
    <tr>
