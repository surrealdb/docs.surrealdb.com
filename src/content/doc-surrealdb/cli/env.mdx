...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td scope="row" data-label="Details"><Since v="v3.0.0-alpha.7" /> Send logs to the specified host:port</td>
    </tr>
    <tr>
      ...
      <td scope="row" data-label="Details"><Since v="v3.0.0-alpha.7" /> Set the format of the logs to the unix socket ("text" or "json"; default: "text")</td>
    </tr>
    <tr>
      ...
      <td scope="row" data-label="Details"><Since v="v3.0.0-alpha.7" /> Override the logging level for unix socket logs</td>
    </tr>
    <tr>
