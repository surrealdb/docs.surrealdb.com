...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td scope="row" data-label="Notes">Number of concurrent tasks that can be handled on each WebSocket.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td scope="row" data-label="Default">Number of CPU cores (minimum 12)</td>
