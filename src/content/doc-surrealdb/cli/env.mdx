...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Env var"><code>SURREAL_ASYNC_EVENT_PROCESSING_INTERVAL</code><Since v="v3.0.0-beta" /> </td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td scope="row" data-label="Command">`start`</td>
      <td scope="row" data-label="Default">none</td>
      <td scope="row" data-label="Allowed values">graphql, define_api, files, surrealism (comma-separated)</td>
...
<tr>
    ...
    <tr>
      <td scope="row" data-label="Env var"><code>SURREAL_INDEX_COMPACTION_INTERVAL</code><Since v="v3.0.0-beta" /></td>
    ...
    <tr>
      <td scope="row" data-label="Env var"><code>SURREAL_LOG_SOCKET</code><Since v="v3.0.0-beta" /></td>
    ...
    <tr>
      <td scope="row" data-label="Env var"><code>SURREAL_LOG_SOCKET_FORMAT</code><Since v="v3.0.0-beta" /></td>
    ...
    <tr>
      <td scope="row" data-label="Env var"><code>SURREAL_LOG_SOCKET_LEVEL</code><Since v="v3.0.0-beta" /></td>
...
>>>>>>> 97a83f70f2a9580ca3f060d80232d5bf0335ab74
    </tr>
    <tr>
