...
To import data from other sources besides `.surql` files (such as PostgreSQL, MonngoDB, CSV data, Kafka, etc.), see the [migrations](/docs/surrealdb/migrating) section of the documentation.
