...
To start a SurrealDB server, run the surreal start command, using the options below. This example serves the database at the default location ([http://localhost:8000](http://localhost:8000)), with a username and password.
