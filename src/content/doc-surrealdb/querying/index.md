...
The easiest way to get started with SurrealQL is to use the [Surrealist](https://app.surrealdb.com/) UI. This interactive environment allows you to experiment with SurrealQL statements and see the results in a tabular format. You can begin with the built-in Sandbox, or connect to a remote or local instance.

You can use Surrealist to learn about the syntax and features of SurrealQL and to develop your queries and scripts.

To familiarize yourself with SurrealQL, explore the various [statements](/docs/surrealql/statements) and their syntax. The statements pages provides comprehensive examples and explanations for each statement type, helping you understand how to construct queries and interact with SurrealDB effectively.
...
<div class="flag-title mt-14">
	<img src="~/assets/img/icon/light/gql.png" darkSrc="~/assets/img/icon/dark/gql.png" alt="GraphQL" style="width: 42px; height: 42px" />
	# GraphQL
</div>
