...
```bash
SURREAL_CAPS_ALLOW_EXPERIMENTAL=true surreal start --log debug --user root --password root
```
</TabItem>
<TabItem value="Windows" label="Windows">
```bash
$env:SURREAL_CAPS_ALLOW_EXPERIMENTAL=true surreal start --log debug --user root --password root
```
</TabItem>
</Tabs>
