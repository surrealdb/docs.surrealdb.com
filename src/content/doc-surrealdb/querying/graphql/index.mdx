...
If you prefer using a GraphQL Client such as GraphiQL or Postman, you can use the GraphQL integration at the [`/graphql`](/docs/surrealdb/integration/http#graphql) endpoint.
