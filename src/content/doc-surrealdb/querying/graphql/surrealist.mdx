...
<Image alt="Surrealist connection settings" src={ImageConnection} />
...
<Image alt="Surrealist GraphQL query" src={ImageQuerying} />

and to get the person with the email "[Jon.Doe@surrealdb.com](mailto:Jon.Doe@surrealdb.com)", you can write the following GraphQL query:
...
<Image alt="Surrealist GraphQL type inference" src={ImageTypeInference} />
