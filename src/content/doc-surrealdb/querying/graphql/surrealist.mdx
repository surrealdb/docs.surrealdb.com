...
import ImageConnection from "@img/surrealist-connection.png";
import ImageQuerying from "@img/graphql-querying-fields.png";
import ImageTypeInference from "@img/graphql-type-inference.png";
