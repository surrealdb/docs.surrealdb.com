...
Surrealism is a plugin feature introduced that allows users to write code that can then be compiled to Web Assembly and accessed inside a running SurrealDB instance.
