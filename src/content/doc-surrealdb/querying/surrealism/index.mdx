...
Surrealism is a plugin feature introduced in SurrealDB 3.0 which allows users to write code that can then be compiled to Web Assembly and accessed inside a SurrealDB instance.
