---
sidebar_position: 6
sidebar_label: Run with TiKV (multi-node)
...
Environment variables such as `SURREAL_TIKV_REQUEST_TIMEOUT` can be set to modify the behaviour of a TiKV instance. For more details on these, see [this section](/docs/surrealdb/cli/env#tikv-environment-variables) of the page dedicated to environment variables.