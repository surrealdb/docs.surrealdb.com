...
<img src="~/assets/img/image/dark/migration-diagnostics.avif" alt="Surrealist migration diagnostics" />
...
<img src="~/assets/img/image/dark/surrealist-migration-report.avif" alt="Surrealist migration report" />
...
<img src="~/assets/img/image/dark/surrealist-deploy-instance.avif" alt="Surrealist deploy instance" />
...
For the full list of available options for each command, see the [export command](/docs/surrealdb/cli/export) and [import command](/docs/surrealdb/cli/import) documentation.
