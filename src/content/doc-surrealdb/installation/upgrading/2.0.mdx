...
- Some breaking changes were made to the SurrealQL language.
    -  Behaviour of the `UPDATE` statement which no longer allows to update a record that does not exist. In favor of the [`UPSERT`](/docs/surrealdb/concepts/upsert) statement.
