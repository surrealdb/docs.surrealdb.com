...
If you are upgrading to the `2.0.0-beta` release of SurrealDB, you will need to follow the steps outlined in the [upgrading to `2.0.0-beta`](/docs/surrealdb/installation/upgrading/beta) guide.