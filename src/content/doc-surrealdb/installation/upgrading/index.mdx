...
If you are upgrading to the `2.0.0` release of SurrealDB, you will need to follow the steps outlined in the [upgrading to `2.0.0`](/docs/surrealdb/installation/upgrading/20) guide.