...
To automatically migrate Neo4J data to SurrealDB, see the [Neo4J page](/docs/surrealdb/migrating/surreal-sync/neo4j) in the section for the Surreal Sync tool.
...
- [Neo4J page on Surreal Sync](/docs/surrealdb/migrating/surreal-sync), a tool to automatically import existing data into a running SurrealDB instance
