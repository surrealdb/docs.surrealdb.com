...
<table>
	...
	<tbody>
		...
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/sdk/java/api/core/surreal#export"><code>db.export(path)</code></a></td>
			<td scope="row" data-label="Description">Exports the database to a file</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/sdk/java/api/core/surreal#import"><code>db.import_(path)</code></a></td>
...
The [`.export()`](/docs/sdk/java/api/core/surreal#export) method writes the current database contents to a SurrealQL file. The [`.import_()`](/docs/sdk/java/api/core/surreal#import) method reads a SurrealQL file and applies it to the database. The underscore in `import_` avoids a conflict with the Java `import` keyword.
