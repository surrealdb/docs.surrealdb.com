...
Much like other methods you can also pass a class reference as first argument to control the return and value type. This class must be a subclass of `Relation`, or simply `Relation` itself.
