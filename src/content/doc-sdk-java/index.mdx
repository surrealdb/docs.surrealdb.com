...
<Boxes>
  <IconBox title="Java Starter" description="A simple starter project demonstrating the power of the SurrealDB Java SDK" href="https://github.com/surrealdb/examples/tree/main/java-starter" />
</Boxes>
