...
sidebar_position: 3
sidebar_label: Value
title: Java | SDK | API Reference | Value
...
| `getGeometry()` | [`Geometry`](/docs/sdk/java/api/values/geometry) |
| `getDateTime()` | `ZonedDateTime` |
| `getDuration()` | `Duration` |
| `getBytes()` | `byte[]` |
| `getRecordId()` | [`RecordId`](/docs/sdk/java/api/values/record-id) |
| `getFile()` | [`FileRef`](/docs/sdk/java/api/values/file-ref) |
...
- [RecordId](/docs/sdk/java/api/values/record-id) — Record identifiers
- [Value types concept](/docs/sdk/java/concepts/value-types) — Usage patterns and examples
