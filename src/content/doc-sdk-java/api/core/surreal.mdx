...
title: Java | SDK | API Reference | Surreal
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><code>target</code> <Label label="required" /></td>
            <td><code>String</code>, <code>RecordId</code>, or <code>RecordId...</code></td>
            <td>The table name, a single record ID, or multiple record IDs.</td>
        </tr>
    </tbody>
</table>

**Returns:** `Iterator<T>` (table), `Optional<T>` (single ID), or `List<T>` (multiple IDs)
...
Updates existing records. Use `UpType.CONTENT` to replace the entire record or `UpType.MERGE` to merge fields into the existing record.
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><code>target</code> <Label label="required" /></td>
            <td><code>RecordId</code> or <code>String</code></td>
            <td>The record ID or table name to update.</td>
        </tr>
        <tr>
            <td><code>upType</code> <Label label="required" /></td>
            <td><code>UpType</code></td>
            <td>The update strategy: <code>UpType.CONTENT</code> (replace) or <code>UpType.MERGE</code> (merge).</td>
        </tr>
        <tr>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><code>target</code> <Label label="required" /></td>
            <td><code>RecordId</code> or <code>String</code></td>
            <td>The record ID or table name to upsert.</td>
        </tr>
        <tr>
            <td><code>upType</code> <Label label="required" /></td>
            <td><code>UpType</code></td>
...
Deletes a specific record or all records in a table.
...
<table>
    ...
    <tbody>
        <tr>
            <td><code>target</code> <Label label="required" /></td>
            <td><code>RecordId</code> or <code>String</code></td>
            <td>The record ID to delete, or a table name to delete all records from.</td>
        </tr>
    </tbody>
</table>
...
```java title="Example"
boolean success = db.export("/tmp/backup.surql");
```
...
```java title="Example"
boolean success = db.import_("/tmp/backup.surql");
```
