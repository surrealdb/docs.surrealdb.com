...
<Image alt="Surrealist Embed" src={ImageEmbed} />
...
<iframe width="100%" src="https://www.youtube.com/embed/AzQBvyg9Awc?si=JuiRap8L_2x43rja" title="Embed Surrealist in your projects" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" style={{ aspectRatio: 1.7 }} allowfullscreen />
