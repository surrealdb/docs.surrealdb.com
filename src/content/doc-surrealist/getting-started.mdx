...
import ImageStart from "@img/surrealist-start.png";
import ImageHttpConnection from "@img/new-http-connection.png";
import ImageSidebar from "@img/surrealist-sidebar.png";
