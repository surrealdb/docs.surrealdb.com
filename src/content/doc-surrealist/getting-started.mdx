...
<img src="~/assets/img/image/surrealist/surrealist-overview-page.avif" alt="Start screen" />
...
<img src="~/assets/img/image/surrealist/new-http-connection.avif" alt="Http connection" />
