...
Let's go ahead and list info about the SurrealDB instance and also about the current namespace from the [`demo dataset`](/docs/explore/tutorials/demos/surreal-deal-store).
