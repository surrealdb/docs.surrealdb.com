...
<Boxes>
	...
	<IconBox
		...
		description="Learn how to use SurrealDB Agent Memory, the memory context for AI agents."
...
Beyond the official clients above, [community SDKs](/docs/languages/community) cover further languages and runtimes.

For mobile, the [Expo](/docs/frameworks/expo) and [React Native](/docs/frameworks/react-native) guides cover connecting from a React Native app.
