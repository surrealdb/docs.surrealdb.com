...
For managed production clusters, see [SurrealDB Cloud](/docs/build/deployment/surrealdb-cloud/what-is-surrealdb-cloud). For self-hosted highly available setups on Kubernetes, see [Amazon EKS](/docs/build/deployment/self-hosted/amazon-eks), [Google GKE](/docs/build/deployment/self-hosted/google-gke), and [Azure AKS](/docs/build/deployment/self-hosted/azure-aks).
