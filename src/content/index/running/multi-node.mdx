...
For managed production clusters, see the [Scale](https://surrealdb.com/pricing/scale) plan on [SurrealDB Cloud](/docs/build/deployment/surrealdb-cloud/what-is-surrealdb-cloud), which runs on **SurrealDS**. For self-hosted highly available setups on Kubernetes, see [Amazon EKS](/docs/build/deployment/self-hosted/amazon-eks), [Google GKE](/docs/build/deployment/self-hosted/google-gke), and [Azure AKS](/docs/build/deployment/self-hosted/azure-aks).
