...
[SurrealDB Cloud](/docs/build/deployment/surrealdb-cloud/what-is-surrealdb-cloud) is a managed service: SurrealDB runs in our environment, and you connect from SurrealDB Studio, the SDKs, or the HTTP and WebSocket APIs. Compared to the [SurrealDB Studio Sandbox](/docs/running/sandbox), you sign in (typically with an email) and your **data persists** in a proper cloud instance.
