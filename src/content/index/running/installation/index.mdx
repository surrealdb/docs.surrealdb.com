...
If you are not ready to install anything yet, start with the [Surrealist Sandbox](/docs/running/sandbox) or [SurrealDB Cloud](/docs/running/cloud) as described in the [Running overview](/docs/running/overview).
