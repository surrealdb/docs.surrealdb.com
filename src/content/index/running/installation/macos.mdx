...
position: 3
title: macOS
description: "Install SurrealDB on macOS with Homebrew or the install script."
priority: 1
---

# Install on macOS

Both the SurrealDB database server and the [command-line tool](/docs/reference/cli/surrealdb-cli/overview) are packaged as a single executable file. You can install via the [install script](https://github.com/surrealdb/install.surrealdb.com) or the [Homebrew](https://brew.sh/) package manager.
