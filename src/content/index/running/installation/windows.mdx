...
position: 4
title: Windows
description: "Install SurrealDB on Windows with Chocolatey or the install script."
priority: 1
---

# Install on Windows

Both the SurrealDB database server and the [command-line tool](/docs/reference/cli/surrealdb-cli/overview) are packaged as a single executable file. You can install via the [install script](#installing-surrealdb-using-the-install-script), [Chocolatey](https://chocolatey.org/), or [Scoop](https://scoop.sh/).
