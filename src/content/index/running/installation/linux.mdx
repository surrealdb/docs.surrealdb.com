...
position: 2
title: Linux
description: "Install SurrealDB on Linux or Unix with the install script."
priority: 1
---

# Install on Linux

Both the SurrealDB database server and the [command-line tool](/docs/reference/cli/surrealdb-cli/overview) are packaged as a single executable file.
