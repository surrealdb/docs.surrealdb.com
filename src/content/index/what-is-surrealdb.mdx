...
- **Native ACID compliance:** [snapshot isolation](/docs/transactions-and-isolation) on every transaction, with immediate consistency after a commit. Opt in to eventual consistency in certain cases if desired.
