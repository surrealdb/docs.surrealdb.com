...
Connects the instance to a SurrealDB server using the specified URL. The URL scheme determines the connection protocol. See the [start command](/docs/reference/cli/surrealdb-cli/start) documentation for server configuration options.
