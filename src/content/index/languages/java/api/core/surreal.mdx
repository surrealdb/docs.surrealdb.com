...
**Returns:** [`LiveStream`](/docs/languages/java/api/core/live-stream)
...
**Returns:** [`Transaction`](/docs/languages/java/api/core/transaction)
...
- [Transaction](/docs/languages/java/api/core/transaction) — Transaction reference
- [Response](/docs/languages/java/api/core/response) — Query response reference
- [LiveStream](/docs/languages/java/api/core/live-stream) — Live query reference
- [Connecting to SurrealDB](/docs/languages/java/concepts/connecting-to-surrealdb) — Connection protocols and patterns
- [Authentication](/docs/languages/java/concepts/authentication) — Authentication concepts
