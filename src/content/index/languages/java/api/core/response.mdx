...
- [Executing queries](/docs/languages/java/concepts/executing-queries), Query concepts and patterns
- [Value types](/docs/languages/java/concepts/value-types), Working with the Value class
