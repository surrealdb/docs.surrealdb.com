...
- [Executing queries](/docs/start/languages/java/concepts/executing-queries), Query concepts and patterns
- [Value types](/docs/start/languages/java/concepts/value-types), Working with the Value class
