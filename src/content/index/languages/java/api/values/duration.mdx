...
SurrealDB [`duration`](/docs/reference/query-language/language-primitives/data-types/datetimes#durations-and-datetimes) values map to Java's `java.time.Duration`. The SDK handles conversion automatically when deserializing query results into [`Value`](/docs/languages/java/api/values/value) objects or POJOs.
