...
The SDK provides several supporting types for authentication, update operations, and relation modeling. These types are used as parameters to methods on the [`Surreal`](/docs/languages/java/api/core/surreal) class.
...
Interface. Base type for all credentials passed to [`signin()`](/docs/languages/java/api/core/surreal#signin) and [`signup()`](/docs/languages/java/api/core/surreal#signup).
...
Represents authentication tokens returned by [`signin()`](/docs/languages/java/api/core/surreal#signin) and [`signup()`](/docs/languages/java/api/core/surreal#signup).
...
Enum for [`update()`](/docs/languages/java/api/core/surreal#update) and [`upsert()`](/docs/languages/java/api/core/surreal#upsert) operation types.
...
POJO base class for graph relations. Contains the standard relation fields. Used with [`relate()`](/docs/languages/java/api/core/surreal#relate).
...
POJO for inserting relations. Uses `Id` instead of `RecordId` for the `id` field. Used with [`insertRelation()`](/docs/languages/java/api/core/surreal#insert-relation).
...
- [Authentication](/docs/languages/java/concepts/authentication) — Authentication concepts and patterns
- [Data manipulation](/docs/languages/java/concepts/data-manipulation) — CRUD operation patterns
