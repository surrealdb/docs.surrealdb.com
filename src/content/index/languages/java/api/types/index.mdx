...
The SDK provides several supporting types for authentication, update operations, and relation modeling. These types are used as parameters to methods on the [`Surreal`](/docs/start/languages/java/api/core/surreal) class.
...
Interface. Base type for all credentials passed to [`signin()`](/docs/start/languages/java/api/core/surreal#signin) and [`signup()`](/docs/start/languages/java/api/core/surreal#signup).
...
Implements `Credential`. Authenticates as a record user via an access method defined with [`DEFINE ACCESS`](/docs/reference/query-language/statements/define/access).
...
Represents authentication tokens returned by [`signin()`](/docs/start/languages/java/api/core/surreal#signin) and [`signup()`](/docs/start/languages/java/api/core/surreal#signup).
...
Enum for [`update()`](/docs/start/languages/java/api/core/surreal#update) and [`upsert()`](/docs/start/languages/java/api/core/surreal#upsert) operation types.
...
POJO base class for graph relations. Contains the standard relation fields. Used with [`relate()`](/docs/start/languages/java/api/core/surreal#relate).
...
POJO for inserting relations. Uses `Id` instead of `RecordId` for the `id` field. Used with [`insertRelation()`](/docs/start/languages/java/api/core/surreal#insert-relation).
...
- [Surreal](/docs/start/languages/java/api/core/surreal) — Connection and method reference
- [Authentication](/docs/start/languages/java/concepts/authentication) — Authentication concepts and patterns
- [Data manipulation](/docs/start/languages/java/concepts/data-manipulation) — CRUD operation patterns
- [DEFINE USER](/docs/reference/query-language/statements/define/user) — System user definition for root, namespace, and database credentials
- [DEFINE ACCESS](/docs/reference/query-language/statements/define/access) — Access method definition for record-level authentication
