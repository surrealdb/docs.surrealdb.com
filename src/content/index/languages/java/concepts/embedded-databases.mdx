...
- [SurrealDB CLI start](/docs/reference/cli/surrealdb-cli/start) for server configuration and storage backends
- [SurrealDB CLI import](/docs/reference/cli/surrealdb-cli/import) and [export](/docs/reference/cli/surrealdb-cli/export) for command-line data management
