...
<table>
	...
	<tbody>
		...
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/java/api/core/surreal#export-sql"><code>db.exportSql(path)</code></a></td>
			<td scope="row" data-label="Description">Exports the database to a file</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/java/api/core/surreal#import-sql"><code>db.importSql(path)</code></a></td>
...
The [`.exportSql()`](/docs/languages/java/api/core/surreal#export-sql) method writes the current database contents to a SurrealQL file. The [`.importSql()`](/docs/languages/java/api/core/surreal#import-sql) method reads a SurrealQL file and applies it to the database.
...
- [Connecting to SurrealDB](/docs/languages/java/concepts/connecting-to-surrealdb) for all connection protocols
