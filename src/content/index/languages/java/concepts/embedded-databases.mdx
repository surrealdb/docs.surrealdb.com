...
<table>
	...
	<tbody>
		...
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/java/api/core/surreal#export-sql"><code>db.exportSql(path)</code></a></td>
			<td scope="row" data-label="Description">Exports the database to a file</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/java/api/core/surreal#import-sql"><code>db.importSql(path)</code></a></td>
...
The [`.exportSql()`](/docs/start/languages/java/api/core/surreal#export-sql) method writes the current database contents to a SurrealQL file. The [`.importSql()`](/docs/start/languages/java/api/core/surreal#import-sql) method reads a SurrealQL file and applies it to the database.
...
- [Connecting to SurrealDB](/docs/start/languages/java/concepts/connecting-to-surrealdb) for all connection protocols
- [SurrealDB deployment](/docs/build/deployment) for production server deployment
- [SurrealDB CLI start](/docs/reference/cli/surrealdb-cli/commands/start) for server configuration and storage backends
- [SurrealDB CLI import](/docs/reference/cli/surrealdb-cli/commands/import) and [export](/docs/reference/cli/surrealdb-cli/commands/export) for command-line data management
