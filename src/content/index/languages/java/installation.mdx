...
- [Quickstart](/docs/languages/java/start) for a complete working example
- [Connecting to SurrealDB](/docs/languages/java/concepts/connecting-to-surrealdb) for connection options and protocols
- [Authentication](/docs/languages/java/concepts/authentication) for signing in and managing credentials
