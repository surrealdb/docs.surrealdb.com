...
Follow the [installation guide](/docs/reference/python/installation) to install the SDK as a dependency in your project. Once installed, import the SDK to start using it.
...
For more advanced use cases, you can use the `.query()` method to run [SurrealQL](/docs/reference/query-language) statements directly. Use the `vars` parameter to safely pass dynamic values.
...
<Boxes>
	...
	<IconBox
		...
		href="/docs/reference/python/concepts/authentication"
	/>
	<IconBox
		title="Data manipulation"
		description="Learn how to create, read, update, and delete records using the SDK."
		href="/docs/reference/python/concepts/data-manipulation"
	/>
	<IconBox
		title="API Reference"
...
> [!NOTE]
> This getting-started guide covers the essentials. For the complete methods, API, and concept reference, see the [Python SDK reference](/docs/reference/python).
