...
The wire format is configurable. CBOR is the default and the most compact on the wire; JSON is useful when you want to inspect traffic or proxy through a JSON-only gateway. See [Connecting to SurrealDB](/docs/languages/mojo/concepts/connecting-to-surrealdb) for the full set of options.

## Get started

- [Installation](/docs/languages/mojo/installation) to add the SDK to your project.
...
To contribute to the SDK code, submit an Issue or Pull Request in the [Mojo SDK](https://github.com/surrealdb/surrealdb.mojo) repository. To contribute to this documentation, submit an Issue or Pull Request in the [docs.surrealdb.com](https://github.com/surrealdb/docs.surrealdb.com) repository.
