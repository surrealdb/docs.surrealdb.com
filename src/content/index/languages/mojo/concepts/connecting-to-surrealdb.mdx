...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">The credential placed in the <code>Authorization</code> header. See <a href="/docs/languages/mojo/concepts/authentication">Authentication</a>.</td>
        </tr>
        <tr>
...
For the build flags required to connect over `https://` or `wss://`, see [Build with HTTPS](/docs/languages/mojo/installation#build-with-https).
