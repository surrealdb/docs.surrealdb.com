...
See the method reference for [`signin`](/docs/languages/mojo/methods/signin), [`signup`](/docs/languages/mojo/methods/signup), [`authenticate`](/docs/languages/mojo/methods/authenticate), and [`invalidate`](/docs/languages/mojo/methods/invalidate).
