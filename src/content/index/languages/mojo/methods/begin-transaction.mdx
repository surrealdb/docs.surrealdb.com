...
> [!NOTE]
> Session transactions run over a stateful WebSocket session. WebSocket support is rolling out. For atomic transactions over HTTP, use [`transaction_multi()`](/docs/languages/mojo/methods/transaction-multi).

### See also

- [Transactions](/docs/languages/mojo/concepts/transactions)
- [`transaction_multi()`](/docs/languages/mojo/methods/transaction-multi)
