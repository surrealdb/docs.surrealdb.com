...
- [JavaScript and TypeScript](/docs/start/languages/javascript/start)
- [Python](/docs/start/languages/python/start)
- [Rust](/docs/start/languages/rust/start)
- [Java](/docs/start/languages/java/start)
- [Go](/docs/start/languages/golang/start)
- [.NET (C#)](/docs/start/languages/dotnet/index)
- [PHP](/docs/start/languages/php/setup)
