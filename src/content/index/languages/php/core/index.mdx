...
- [Initialize SurrealDB](/docs/start/languages/php/core/initialization)
- [Handle authentication](/docs/start/languages/php/core/authentication)
- [Data Quering](/docs/start/languages/php/core/data-querying)