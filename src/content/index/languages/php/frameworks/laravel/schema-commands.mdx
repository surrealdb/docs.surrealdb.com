...
The integration adds two Artisan commands for managing your [Surqlize schema](/docs/languages/php/ecosystem/surqlize/schema). Both read the model list from `config('surqlize.models')`.
...
- [Schema](/docs/languages/php/ecosystem/surqlize/schema) for defining tables and fields
- [Configuration](/docs/languages/php/frameworks/laravel/configuration#orm-configuration) for the model list
- [Surqlize CLI](/docs/languages/php/ecosystem/surqlize/code-generation-and-cli) for the framework-agnostic commands
