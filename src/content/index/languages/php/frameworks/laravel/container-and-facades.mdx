...
| `query($query, $connection?)` | Run a [`BoundQuery`](/docs/languages/php/v2/api/utilities#boundquery) |
...
| `fake()` / `assertSurrealQuerySent()` / `resetFakes()` | [Testing](/docs/languages/php/frameworks/laravel/testing) helpers |
...
Resolves the underlying SDK [`Surreal`](/docs/languages/php/v2/api/core) client for direct, lower-level access.
...
| `transaction($callback, $executor?, $connection?)` | Run a [transaction](/docs/languages/php/frameworks/laravel/queries-and-transactions#transactions) |
...
- [Configuration](/docs/languages/php/frameworks/laravel/configuration) for the settings these bindings read
- [Queries and transactions](/docs/languages/php/frameworks/laravel/queries-and-transactions) for using the facades
- [Testing](/docs/languages/php/frameworks/laravel/testing) for the fake executor
