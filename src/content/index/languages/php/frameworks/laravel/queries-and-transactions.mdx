...
Define [Surqlize models](/docs/languages/php/ecosystem/surqlize/models) and query them directly. They run through the Laravel-managed connection.
...
See [Querying](/docs/languages/php/ecosystem/surqlize/querying) and [Mutations](/docs/languages/php/ecosystem/surqlize/mutations) for the full model API.
...
- [Container and facades](/docs/languages/php/frameworks/laravel/container-and-facades) for the facade method reference
- [Surqlize transactions](/docs/languages/php/ecosystem/surqlize/transactions) for the batching mechanism
- [Testing](/docs/languages/php/frameworks/laravel/testing) for asserting the queries your code sends
