...
Surqlize is installed with [Composer](https://getcomposer.org/download/). It requires PHP `8.4` or later and depends on the alpha [v2 SurrealDB PHP SDK](/docs/languages/php/v2).
...
The WebSocket transport uses PHP's native stream functions and needs no extra packages. See the [SDK installation guide](/docs/languages/php/v2/installation) for details.
