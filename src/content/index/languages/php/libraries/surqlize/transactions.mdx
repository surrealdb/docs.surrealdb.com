...
- [Connections](/docs/languages/php/ecosystem/surqlize/connections) for executor injection
- [Mutations](/docs/languages/php/ecosystem/surqlize/mutations) for the queries you batch
- [Transactions in the SDK](/docs/languages/php/v2/concepts/transactions) for the underlying mechanism
