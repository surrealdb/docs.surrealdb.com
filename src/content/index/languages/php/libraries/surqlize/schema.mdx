...
Apply the schema for a set of models with the `SchemaManager`. Pass an [executor](/docs/languages/php/ecosystem/surqlize/connections), or rely on the registered one.
...
Use `definitions()` instead of `apply()` to inspect the statements without running them. You can also apply schemas from the [CLI](/docs/languages/php/ecosystem/surqlize/code-generation-and-cli#schema-apply).

## Learn more

- [Models](/docs/languages/php/ecosystem/surqlize/models) for the `#[Schema]` attribute
- [Code generation and CLI](/docs/languages/php/ecosystem/surqlize/code-generation-and-cli) to apply schemas from the command line
