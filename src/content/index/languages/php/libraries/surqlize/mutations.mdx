...
| `toBoundQuery()` | An SDK [`BoundQuery`](/docs/languages/php/v2/api/utilities#boundquery) |
...
- [Querying](/docs/languages/php/ecosystem/surqlize/querying) for reading records
- [Transactions](/docs/languages/php/ecosystem/surqlize/transactions) for grouping mutations atomically
- [Connections](/docs/languages/php/ecosystem/surqlize/connections) for per-query executor injection
