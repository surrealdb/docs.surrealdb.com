...
- [Quickstart](/docs/languages/php/v2/start) to connect and run your first queries
- [Connecting to SurrealDB](/docs/languages/php/v2/concepts/connecting-to-surrealdb) for connection options and reconnection
- [Migration guide](/docs/languages/php/v2/migration) if you are coming from v1
