...
See [Observability](/docs/languages/php/v2/concepts/observability#runtime-presets) for the full setup and options.
...
> [!NOTE]
> For Laravel applications, [Laravel Octane](https://laravel.com/docs/octane) runs your app on Swoole, FrankenPHP, or RoadRunner with a configurable `--workers` count. See the [Laravel integration](/docs/languages/php/frameworks/laravel).
