...
- [Surreal API reference](/docs/languages/php/v2/api/core) for the methods that raise these errors
- [Connecting to SurrealDB](/docs/languages/php/v2/concepts/connecting-to-surrealdb) for version and reconnection settings
- [Authentication](/docs/languages/php/v2/concepts/authentication) for handling sign-in failures
