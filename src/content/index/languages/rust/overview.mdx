...
<Boxes>
    <IconBox
        title="Actix"
        href="/docs/start/languages/rust/frameworks/actix"
        icon={{
    ...
    <IconBox
        title="Axum"
        href="/docs/start/languages/rust/frameworks/axum"
        icon={{
                light: LightAxumLogo,
                dark: DarkAxumLogo,
        }}
    ...
    <IconBox
        title="Egui"
        href="/docs/start/languages/rust/frameworks/egui"
        icon={{
    ...
    <IconBox
        title="Rocket"
        href="/docs/start/languages/rust/frameworks/rocket"
        icon={{
