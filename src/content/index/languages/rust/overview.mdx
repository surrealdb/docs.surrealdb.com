...
<Boxes>
    <IconBox
        title="Actix"
        href="/docs/languages/rust/frameworks/actix"
        icon={{
    ...
    <IconBox
        title="Axum"
        href="/docs/languages/rust/frameworks/axum"
        icon={{
                light: LightAxumLogo,
                dark: DarkAxumLogo,
        }}
    ...
    <IconBox
        title="Egui"
        href="/docs/languages/rust/frameworks/egui"
        icon={{
    ...
    <IconBox
        title="Rocket"
        href="/docs/languages/rust/frameworks/rocket"
        icon={{
