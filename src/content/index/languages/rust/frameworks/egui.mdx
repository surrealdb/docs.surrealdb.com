...
* Compiling to WASM (and even deploying to a website). Egui can be compiled to WASM, and SurrealDB can use IndexedDB as [one of its backends](/docs/reference/cli/surrealdb-cli/start#positional-argument).
