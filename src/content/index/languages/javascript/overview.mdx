...
<Boxes>
    <IconBox
        title="JavaScript"
        status="available"
        href="/docs/languages/javascript/installation"
        icon={{
...
<Boxes>
    <IconBox
        title="React"
        href="/docs/languages/javascript/frameworks/react"
        status="available"
        icon={{
            light: LightReact,
            dark: DarkReact,
    ...
    <IconBox
        title="Solid.js"
        href="/docs/languages/javascript/frameworks/solidjs"
        status="available"
        icon={{
            light: LightSolid,
            dark: DarkSolid,
	...
	<IconBox
        title="Vue.js"
		href="/docs/languages/javascript/frameworks/vuejs"
        status="available"
        icon={{
            light: LightVue,
            dark: DarkVue,
