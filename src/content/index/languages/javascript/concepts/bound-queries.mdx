...
The [expressions API](/docs/languages/javascript/api/utilities/expr) provides functions for building dynamic conditions in a type-safe way. Expressions integrate with both `surql` and query builder methods like `.where()`.
...
- [expr API reference](/docs/languages/javascript/api/utilities/expr) for the full expressions API
- [Executing queries](/docs/languages/javascript/concepts/executing-queries) for running queries against the database
