...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-queryable#query"> <code> db.query(query, bindings?) </code></a></td>
			<td scope="row" data-label="Description">Executes raw SurrealQL statements</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-queryable#select"> <code> db.select(target) </code></a></td>
			<td scope="row" data-label="Description">Selects records from the database</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-queryable#create"> <code> db.create(target) </code></a></td>
			<td scope="row" data-label="Description">Creates new records</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-queryable#insert"> <code> db.insert(target, data) </code></a></td>
			<td scope="row" data-label="Description">Inserts one or multiple records</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-queryable#update"> <code> db.update(target) </code></a></td>
			<td scope="row" data-label="Description">Updates existing records</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-queryable#upsert"> <code> db.upsert(target) </code></a></td>
			<td scope="row" data-label="Description">Inserts or replaces records</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-queryable#delete"> <code> db.delete(target) </code></a></td>
			<td scope="row" data-label="Description">Deletes records from the database</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-queryable#relate"> <code> db.relate(from, edge, to) </code></a></td>
			<td scope="row" data-label="Description">Creates graph relationships between records</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-queryable#run"> <code> db.run(name, args?) </code></a></td>
			<td scope="row" data-label="Description">Executes a SurrealDB function or SurrealML model</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-session#set"> <code> db.set(key, value) </code></a></td>
			<td scope="row" data-label="Description">Defines a parameter on the session</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/languages/javascript/api/core/surreal-session#unset"> <code> db.unset(key) </code></a></td>
...
The `.select()` method reads records from the database. You can pass a [`Table`](/docs/languages/javascript/api/values/table) to select all records, a [`RecordId`](/docs/languages/javascript/api/values/record-id) to select a specific record, or a `RecordIdRange` to select a range.
...
In the above example, we use the `gt()` function to create a greater than condition. This function is part of the [expression utilities](/docs/languages/javascript/api/utilities/expr) that are available in the SDK.
...
Learn more about the `jsonify` utility in the [Utilities](/docs/languages/javascript/concepts/utilities) concept page.
