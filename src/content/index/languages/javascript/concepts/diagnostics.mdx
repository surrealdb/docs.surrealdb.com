...
- [Connecting to SurrealDB](/docs/languages/javascript/concepts/connecting-to-surrealdb) for engine configuration
- [Error handling](/docs/languages/javascript/concepts/error-handling) for handling SDK errors
