...
- [Connecting to SurrealDB](/docs/start/languages/javascript/concepts/connecting-to-surrealdb) for engine configuration
- [Error handling](/docs/start/languages/javascript/concepts/error-handling) for handling SDK errors
