...
Follow the [installation guide](/docs/languages/javascript/installation) to install the SDK as a dependency in your project.
...
- Embedded protocols using the [WebAssembly engine](/docs/languages/javascript/engines/wasm) or [Node.js engine](/docs/languages/javascript/engines/node)
...
In addition to the `.eq()` function in the above example, we offer a comprehensive set of [expression utilities](/docs/languages/javascript/api/utilities/expr) for building type-safe SurrealQL conditions.
