...
Follow the [installation guide](/docs/start/languages/javascript/installation) to install the SDK as dependency in your project.
...
This approach is suitable when connecting as [record user](/docs/learn/security/authentication/authentication#record-users) from a frontend application.
...
In addition to the `.eq()` function in the above example, we offer a comprehensive set of [expression utilities](/docs/start/languages/javascript/api/utilities/expr) for building type-safe SurrealQL conditions.
