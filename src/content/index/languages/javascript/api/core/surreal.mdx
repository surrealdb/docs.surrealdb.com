...
The `Surreal` class is the primary interface for connecting to a SurrealDB instance, managing connections, executing queries, and handling database sessions. It extends [`SurrealSession`](/docs/languages/javascript/api/core/surreal-session) and inherits all session management and query execution capabilities.
...
**Extends:** [`SurrealSession`](/docs/languages/javascript/api/core/surreal-session) → [`SurrealQueryable`](/docs/languages/javascript/api/core/surreal-queryable)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/languages/javascript/api/types/#driveroptions">DriverOptions</a></code></td>
...
**Type:** [`ConnectionStatus`](/docs/languages/javascript/api/types/#connectionstatus)
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><code><a href="/docs/languages/javascript/api/types/#connectoptions">ConnectOptions</a></code></td>
...
#### Returns
[`Promise<VersionInfo>`](/docs/languages/javascript/api/types/#versioninfo) - An object containing version information
...
#### Returns
`Promise<SurrealSession>` - A new [`SurrealSession`](/docs/languages/javascript/api/core/surreal-session) instance
...
<table>
    ...
    <tbody>
        <tr>
            <td><code>options</code> <label label="optional" /></td>
            <td><code>Partial&lt;<a href="/docs/languages/javascript/api/types/#sqlexportoptions">SqlExportOptions</a>&gt;</code></td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>keyof <a href="/docs/languages/javascript/api/types/#surrealevents">SurrealEvents</a></code></td>
