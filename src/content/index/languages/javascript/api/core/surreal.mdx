...
The `Surreal` class is the primary interface for connecting to a SurrealDB instance, managing connections, executing queries, and handling database sessions. It extends [`SurrealSession`](/docs/start/languages/javascript/api/core/surreal-session) and inherits all session management and query execution capabilities.
...
**Extends:** [`SurrealSession`](/docs/start/languages/javascript/api/core/surreal-session) → [`SurrealQueryable`](/docs/start/languages/javascript/api/core/surreal-queryable)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/start/languages/javascript/api/types/#driveroptions">DriverOptions</a></code></td>
...
**Type:** [`ConnectionStatus`](/docs/start/languages/javascript/api/types/#connectionstatus)
...
The `Surreal` class inherits all properties from [`SurrealSession`](/docs/start/languages/javascript/api/core/surreal-session), including:
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><code><a href="/docs/start/languages/javascript/api/types/#connectoptions">ConnectOptions</a></code></td>
...
#### Returns
[`Promise<VersionInfo>`](/docs/start/languages/javascript/api/types/#versioninfo) - An object containing version information
...
#### Returns
`Promise<SurrealSession>` - A new [`SurrealSession`](/docs/start/languages/javascript/api/core/surreal-session) instance
...
<table>
    ...
    <tbody>
        <tr>
            <td><code>options</code> <label label="optional" /></td>
            <td><code><a href="/docs/start/languages/javascript/api/types/#sqlexportoptions">SqlExportOptions</a></code></td>
...
The `Surreal` class also inherits and re-emits events from [`SurrealSession`](/docs/start/languages/javascript/api/core/surreal-session):
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>keyof <a href="/docs/start/languages/javascript/api/types/#surrealevents">SurrealEvents</a></code></td>
...
As `Surreal` extends [`SurrealSession`](/docs/start/languages/javascript/api/core/surreal-session), it inherits all authentication and query methods:

### Authentication methods
- [`signup()`](/docs/start/languages/javascript/api/core/surreal-session#signup) - Sign up a new user
- [`signin()`](/docs/start/languages/javascript/api/core/surreal-session#signin) - Sign in with credentials
- [`authenticate()`](/docs/start/languages/javascript/api/core/surreal-session#authenticate) - Authenticate with a token
- [`invalidate()`](/docs/start/languages/javascript/api/core/surreal-session#invalidate) - Invalidate the session

### Session configuration methods
- [`use()`](/docs/start/languages/javascript/api/core/surreal-session#use) - Set namespace and database
- [`set()`](/docs/start/languages/javascript/api/core/surreal-session#set) - Set a session parameter
- [`unset()`](/docs/start/languages/javascript/api/core/surreal-session#unset) - Remove a session parameter
- [`reset()`](/docs/start/languages/javascript/api/core/surreal-session#reset) - Reset the session

### Query methods

As `Surreal` extends [`SurrealQueryable`](/docs/start/languages/javascript/api/core/surreal-queryable) (via `SurrealSession`), it also inherits all query execution methods:
...
### Transaction method
- [`beginTransaction()`](/docs/start/languages/javascript/api/core/surreal-transaction) - Start a transaction
...
- [SurrealSession](/docs/start/languages/javascript/api/core/surreal-session) - Session management and authentication
...
- [Connection Engines](/docs/start/languages/javascript/engines/) - Engine-specific documentation
- [Data Types](/docs/start/languages/javascript/api/values) - Working with data types
