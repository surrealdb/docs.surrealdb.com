...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><code><a href="/docs/languages/javascript/api/types/#apirequest">ApiRequest</a>&lt;T&gt;</code></td>
...
#### Returns
[`ApiPromise<unknown>`](/docs/languages/javascript/api/queries/api-promise) - A promise for the API response
