...
Access user-defined API endpoints. This property returns a [`SurrealApi`](/docs/languages/javascript/api/core/surreal-api) instance for invoking custom database APIs.

You can provide type definitions for type-safe API calls.

**Type:** [`SurrealApi<TPaths>`](/docs/languages/javascript/api/core/surreal-api)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/languages/javascript/api/values/record-id">RecordId</a></code></td>
...
#### Returns
[`SelectPromise<T>`](/docs/languages/javascript/api/queries/select-promise) - A promise with chainable configuration methods
...
#### Returns
[`CreatePromise<T>`](/docs/languages/javascript/api/queries/create-promise) - A promise with chainable configuration methods
...
#### Returns
[`UnmanagedLivePromise`](/docs/languages/javascript/api/queries/live-promise) - An unmanaged live query subscription
