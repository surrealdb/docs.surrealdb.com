...
The `SurrealQueryable` class is an abstract base class that provides all query execution methods for interacting with SurrealDB. It is the foundation for executing database operations and is extended by [`SurrealSession`](/docs/languages/javascript/api/core/surreal-session) and [`SurrealTransaction`](/docs/languages/javascript/api/core/surreal-transaction).

**Extended by:** [`SurrealSession`](/docs/languages/javascript/api/core/surreal-session), [`SurrealTransaction`](/docs/languages/javascript/api/core/surreal-transaction)
...
Create a [`SurrealApi`](/docs/languages/javascript/api/core/surreal-api) instance for invoking user-defined API endpoints. You can provide type definitions for type-safe API calls and an optional path prefix.
...
#### Returns
[`SurrealApi<TPaths>`](/docs/languages/javascript/api/core/surreal-api) - An API instance for invoking custom database APIs
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>string | <a href="/docs/languages/javascript/api/utilities/bound-query">BoundQuery</a></code></td>
...
#### Returns
[`Query<R>`](/docs/languages/javascript/api/queries/query) - A query instance that can be configured and executed
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/languages/javascript/api/types/#anyrecordid">AnyRecordId</a></code></td>
            <td>A specific record ID to select.</td>
        </tr>
        <tr>
            <td><code>range</code> <label label="required" /></td>
            <td><code><a href="/docs/languages/javascript/api/values/record-id">RecordIdRange</a></code></td>
            <td>A range of record IDs to select.</td>
        </tr>
        <tr>
            <td><code>table</code> <label label="required" /></td>
            <td><code><a href="/docs/languages/javascript/api/values/table">Table</a></code></td>
...
#### Returns
- For `RecordId`: [`SelectPromise<T | undefined, T>`](/docs/languages/javascript/api/queries/select-promise) - A promise resolving to a single record or `undefined`
...
#### Returns
[`CreatePromise<RecordResult<T>, T>`](/docs/languages/javascript/api/queries/create-promise) - A promise with chainable configuration methods
...
#### Returns
[`UpdatePromise<T>`](/docs/languages/javascript/api/queries/update-promise) - A promise with chainable configuration methods
...
#### Returns
[`UpsertPromise<T>`](/docs/languages/javascript/api/queries/upsert-promise) - A promise with chainable configuration methods
...
#### Returns
[`DeletePromise<T>`](/docs/languages/javascript/api/queries/delete-promise) - A promise with chainable configuration methods
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/languages/javascript/api/types/#anyrecordid">AnyRecordId</a> | AnyRecordId[]</code></td>
            <td>The source record(s) for the relationship.</td>
        </tr>
        <tr>
            <td><code>edge</code> <label label="required" /></td>
            <td><code>Table | <a href="/docs/languages/javascript/api/types/#anyrecordid">AnyRecordId</a></code></td>
...
#### Returns
[`RelatePromise<T>`](/docs/languages/javascript/api/queries/relate-promise) - A promise for the relationship operation
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/languages/javascript/api/types/#liveresource">LiveResource</a></code></td>
...
#### Returns
[`ManagedLivePromise<T>`](/docs/languages/javascript/api/queries/live-promise) - A managed live query subscription
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/languages/javascript/api/values/uuid">Uuid</a></code></td>
...
#### Returns
[`UnmanagedLivePromise<T>`](/docs/languages/javascript/api/queries/live-promise) - An unmanaged live query subscription
...
#### Returns
[`RunPromise<T>`](/docs/languages/javascript/api/queries/run-promise) - A promise for the function result
