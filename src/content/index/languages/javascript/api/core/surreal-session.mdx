...
The `SurrealSession` class represents a scoped contextual session attached to a SurrealDB connection. It provides authentication, session configuration, and inherits all query execution methods from [`SurrealQueryable`](/docs/languages/javascript/api/core/surreal-queryable).
...
**Extends:** [`SurrealQueryable`](/docs/languages/javascript/api/core/surreal-queryable)

**Extended by:** [`Surreal`](/docs/languages/javascript/api/core/surreal)

**Source:** [api/session.ts](https://github.com/surrealdb/surrealdb.js/blob/main/packages/sdk/src/api/session.ts)

## Constructor

The constructor is typically not called directly. Use [`Surreal.newSession()`](/docs/languages/javascript/api/core/surreal#newsession) or [`forkSession()`](#forksession) to create new sessions.
...
**Type:** [`Uuid`](/docs/languages/javascript/api/values/uuid) `| undefined`
...
#### Returns
[`Promise<SurrealSession>`](/docs/languages/javascript/api/core/surreal-session) - A new session instance
...
Call [`commit()`](/docs/languages/javascript/api/core/surreal-transaction#commit) on the transaction to apply changes, or [`cancel()`](/docs/languages/javascript/api/core/surreal-transaction#cancel) to discard them.
...
#### Returns
`Promise<SurrealTransaction>` - A new [`SurrealTransaction`](/docs/languages/javascript/api/core/surreal-transaction) instance
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>Nullable&lt;<a href="/docs/languages/javascript/api/types/#namespacedatabase">NamespaceDatabase</a>&gt;</code></td>
...
#### Returns
[`Promise<NamespaceDatabase>`](/docs/languages/javascript/api/types/#namespacedatabase) - The current or newly selected namespace and database
...
> [!NOTE]
> When this method is called, the `authentication` property passed to [`connect()`](/docs/languages/javascript/api/core/surreal#connect) will be ignored. You are responsible for handling session invalidation by listening to the [`auth`](#event-auth) event.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/languages/javascript/api/types/#accessrecordauth">AccessRecordAuth</a></code></td>
...
#### Returns
[`Promise<Tokens>`](/docs/languages/javascript/api/types/#tokens) - The authentication tokens (access and refresh tokens)
...
<table>
    ...
    <tbody>
        <tr>
            <td><code>auth</code> <label label="required" /></td>
            <td><code><a href="/docs/languages/javascript/api/types/#anyauth">AnyAuth</a></code></td>
...
#### Returns
[`Promise<Tokens>`](/docs/languages/javascript/api/types/#tokens) - The authentication tokens
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/languages/javascript/api/types/#token">Token</a> | <a href="/docs/languages/javascript/api/types/#tokens">Tokens</a></code></td>
...
#### Returns
[`Promise<Tokens>`](/docs/languages/javascript/api/types/#tokens) - The authentication tokens (may include new refresh token)
...
**Payload:** `[tokens:` [`Tokens`](/docs/languages/javascript/api/types/#tokens) `| null]` - The new authentication tokens, or `null` if invalidated
...
**Payload:** `[using:` [`NamespaceDatabase`](/docs/languages/javascript/api/types/#namespacedatabase)`]` - Object containing the new namespace and database
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>keyof <a href="/docs/languages/javascript/api/types/#sessionevents">SessionEvents</a></code></td>
...
- [`insert()`](/docs/languages/javascript/api/core/surreal-queryable#insert) - Insert records
- [`update()`](/docs/languages/javascript/api/core/surreal-queryable#update) - Update records
- [`upsert()`](/docs/languages/javascript/api/core/surreal-queryable#upsert) - Upsert records
- [`delete()`](/docs/languages/javascript/api/core/surreal-queryable#delete) - Delete records
- [`relate()`](/docs/languages/javascript/api/core/surreal-queryable#relate) - Create graph relationships
- [`live()`](/docs/languages/javascript/api/core/surreal-queryable#live) - Subscribe to live queries
- [`liveOf()`](/docs/languages/javascript/api/core/surreal-queryable#liveof) - Subscribe to existing live queries
...
- [Authentication Types](/docs/languages/javascript/api/types/#anyauth) - Authentication type definitions
