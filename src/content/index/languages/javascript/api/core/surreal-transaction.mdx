...
Transactions are created using the [`beginTransaction()`](/docs/languages/javascript/api/core/surreal-session#begintransaction) method on a [`SurrealSession`](/docs/languages/javascript/api/core/surreal-session) instance.
