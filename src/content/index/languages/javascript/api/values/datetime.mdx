...
- [Duration](/docs/start/languages/javascript/api/values/duration) - Time duration values
- [Data Types Overview](/docs/start/languages/javascript/api/values/) - All custom data types
- [Query Builders](/docs/start/languages/javascript/api/queries/) - Using DateTime in queries
