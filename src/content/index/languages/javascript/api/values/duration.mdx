...
- [DateTime](/docs/start/languages/javascript/api/values/datetime) - Datetime values
- [Data Types Overview](/docs/start/languages/javascript/api/values/) - All custom data types
- [Query Builders](/docs/start/languages/javascript/api/queries/) - Using Duration in queries
- [SurrealQL Duration](/docs/reference/query-language/language-primitives/data-types/datetimes#durations) - Database duration type
