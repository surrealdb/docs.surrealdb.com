...
- [RecordId](/docs/start/languages/javascript/api/values/record-id) - Record identifiers
- [Data Types Overview](/docs/start/languages/javascript/api/values/) - All custom data types
- [Query Builders](/docs/start/languages/javascript/api/queries/) - Using Table in queries
