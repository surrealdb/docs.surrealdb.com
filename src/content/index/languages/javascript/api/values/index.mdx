...
- [**DateTime**](/docs/languages/javascript/api/values/datetime) - Datetime values with nanosecond precision
...
- [**Range**](/docs/languages/javascript/api/values/range) - Generic range values for numeric and date ranges

- [**FileRef**](/docs/languages/javascript/api/values/file-ref) - References to files stored in SurrealDB
