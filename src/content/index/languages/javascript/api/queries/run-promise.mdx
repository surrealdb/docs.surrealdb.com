...
**Returned by:** [`SurrealQueryable.run()`](/docs/start/languages/javascript/api/core/surreal-queryable#run)
...
- [SurrealQueryable.run()](/docs/start/languages/javascript/api/core/surreal-queryable#run) - Method that returns RunPromise
