...
**Returned by:** [`SurrealQueryable.create()`](/docs/start/languages/javascript/api/core/surreal-queryable#create)
...
- [SurrealQueryable.create()](/docs/start/languages/javascript/api/core/surreal-queryable#create) - Method that returns CreatePromise
- [InsertPromise](/docs/start/languages/javascript/api/queries/insert-promise) - Bulk insertion
- [UpsertPromise](/docs/start/languages/javascript/api/queries/upsert-promise) - Insert or replace
