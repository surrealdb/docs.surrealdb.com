...
**Returned by:** [`SurrealQueryable.delete()`](/docs/languages/javascript/api/core/surreal-queryable#delete)
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/languages/javascript/api/values/duration">Duration</a></code></td>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code><a href="/docs/languages/javascript/api/values/datetime">DateTime</a></code></td>
