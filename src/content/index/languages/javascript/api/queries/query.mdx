...
**Returned by:** [`SurrealQueryable.query()`](/docs/languages/javascript/api/core/surreal-queryable#query)
...
#### Returns
`Promise<Responses<T, J>>` - Array of [`QueryResponse`](/docs/languages/javascript/api/types/#queryresponse) objects
