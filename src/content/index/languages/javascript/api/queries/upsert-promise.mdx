...
> [!WARNING]
> UPSERT replaces the entire record if it exists. Use [`update().merge()`](/docs/start/languages/javascript/api/queries/update-promise#merge) for partial updates.

**Returned by:** [`SurrealQueryable.upsert()`](/docs/start/languages/javascript/api/core/surreal-queryable#upsert)
...
- [SurrealQueryable.upsert()](/docs/start/languages/javascript/api/core/surreal-queryable#upsert) - Method that returns UpsertPromise
- [CreatePromise](/docs/start/languages/javascript/api/queries/create-promise) - Create only
- [UpdatePromise](/docs/start/languages/javascript/api/queries/update-promise) - Update only
