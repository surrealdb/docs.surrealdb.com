...
The [`select`](/docs/reference/rust/methods/select) method retrieves all records from a table. Deserialise the result into a `Vec` of a struct that derives `SurrealValue`.
