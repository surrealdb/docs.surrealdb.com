...
An enum of the features a transport may support. Inspect the active set via the [`features`](/docs/languages/kotlin/api/core/surreal-client#properties) property, or check a single feature with [`.supports()`](/docs/languages/kotlin/api/core/surreal-client#supports).
...
A sealed class emitted on the client's [`connectionEvents`](/docs/languages/kotlin/api/core/surreal-client#properties) [`SharedFlow`](https://kotlinlang.org/api/kotlinx.coroutines/kotlinx-coroutines-core/kotlinx.coroutines.flow/-shared-flow/).
