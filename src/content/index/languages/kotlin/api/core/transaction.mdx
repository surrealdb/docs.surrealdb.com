...
`SurrealTransaction` represents an in-progress [transaction](/docs/languages/kotlin/concepts/transactions). It is itself a queryable, so the [CRUD builders](/docs/languages/kotlin/api/core/query-builder) are available scoped to the transaction. Transactions are started with the extension functions on a [session](/docs/languages/kotlin/api/core/session) and require the **WebSocket** transport.
...
- [Transactions](/docs/languages/kotlin/concepts/transactions)
- [Session](/docs/languages/kotlin/api/core/session)
- [Query builders](/docs/languages/kotlin/api/core/query-builder)
