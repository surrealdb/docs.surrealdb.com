...
The CRUD methods on [`SurrealClient`](/docs/languages/kotlin/api/core/surreal-client) return fluent builders that compile to [SurrealQL](/docs/reference/query-language). Each builder is refined with chainable methods and terminated with [`await()`](#await) (raw [`JsonElement`](/docs/languages/kotlin/api/values/value)) or the typed [`awaitAs<T>()`](#await-as) extension.
...
Executes the builder and returns the unwrapped result of the first statement as a [`JsonElement`](/docs/languages/kotlin/api/values/value).
...
An inline extension that executes the builder and decodes the result into `T` using [`kotlinx.serialization`](/docs/languages/kotlin/concepts/serialization). Available on every builder.
...
Compiles the builder to a `BoundQuery` without executing it — useful for inspection or composing with [`.query()`](/docs/languages/kotlin/api/core/surreal-client#query).
...
Returned by [`.select(what)`](/docs/languages/kotlin/api/core/surreal-client#select).
...
[`CreateQuery`](/docs/languages/kotlin/api/core/surreal-client#create), [`UpdateQuery`](/docs/languages/kotlin/api/core/surreal-client#update), [`UpsertQuery`](/docs/languages/kotlin/api/core/surreal-client#upsert), and [`RelateQuery`](/docs/languages/kotlin/api/core/surreal-client#relate) accept content and a return mode.
...
Returned by [`.run(function)`](/docs/languages/kotlin/api/core/surreal-client#run).
...
- [SurrealClient API reference](/docs/languages/kotlin/api/core/surreal-client) for the CRUD methods
- [Data manipulation](/docs/languages/kotlin/concepts/data-manipulation) for the concepts
- [Serialization](/docs/languages/kotlin/concepts/serialization) for `awaitAs`
