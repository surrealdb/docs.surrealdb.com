...
`RecordIdRange` targets a contiguous range of records within a table by their IDs. Pass it to the [CRUD builders](/docs/languages/kotlin/concepts/data-manipulation) to operate on a [range of records](/docs/surrealql/datamodel/ids#record-ranges).
...
- [Record ranges](/docs/surrealql/datamodel/ids#record-ranges) in SurrealQL
