...
`RecordIdRange` targets a contiguous range of records within a table by their IDs. Pass it to the [CRUD builders](/docs/languages/kotlin/concepts/data-manipulation) to operate on a [range of records](/docs/reference/query-language/language-primitives/data-types/record-ids#record-ranges).
...
- [`RecordId`](/docs/languages/kotlin/api/values/record-id) and [`Table`](/docs/languages/kotlin/api/values/table)
