...
> [!NOTE]
> The SDK is distributed via [Swift Package Manager](/docs/languages/swift/installation) from the [surrealdb.swift](https://github.com/surrealdb/surrealdb.swift) repository, and will also be available on [Swift Package Index](https://swiftpackageindex.com).
