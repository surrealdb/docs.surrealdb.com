...
Live queries let you subscribe to changes on a table and receive events in real time. They require the [WebSocket client](/docs/languages/swift/concepts/connecting#websocket-client) and are delivered as an `AsyncStream<LiveEvent<T>>`.
...
See the [`live`](/docs/languages/swift/methods/live) and [`kill`](/docs/languages/swift/methods/kill) method references for more detail.
