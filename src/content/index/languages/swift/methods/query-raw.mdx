...
Executes a raw SurrealQL string with bound parameters and returns one [`RPCQueryResult`](/docs/languages/swift/data-types#rpcqueryresult) per statement.
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" scope="row" data-label="Description">
                A dictionary of [`SurrealValue`](/docs/languages/swift/data-types#surrealvalue) parameters referenced in the query.
            </td>
        </tr>
    </tbody>
</table>
