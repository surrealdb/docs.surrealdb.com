...
- [Table](/docs/languages/golang/api/values/table) for the table name type used in `RecordRangeID`
- [Value types](/docs/languages/golang/concepts/value-types) for the full type mapping
- [Data manipulation](/docs/languages/golang/concepts/data-manipulation) for using ranges in queries
