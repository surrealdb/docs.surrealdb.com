...
- [Duration](/docs/start/languages/golang/api/values/duration) for the duration type
- [Value types](/docs/start/languages/golang/concepts/value-types) for the full type mapping
- [Data manipulation](/docs/start/languages/golang/concepts/data-manipulation) for using datetime values in CRUD operations
- [SurrealQL datetime type](/docs/reference/query-language/language-primitives/data-types/datetimes) for the underlying data model
