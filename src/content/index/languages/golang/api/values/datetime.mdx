...
- [Duration](/docs/languages/golang/api/values/duration) for the duration type
- [Value types](/docs/languages/golang/concepts/value-types) for the full type mapping
- [Data manipulation](/docs/languages/golang/concepts/data-manipulation) for using datetime values in CRUD operations
