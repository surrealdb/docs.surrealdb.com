...
- [Live queries](/docs/languages/golang/concepts/live-queries) for live query UUIDs
- [Session](/docs/languages/golang/api/core/session#id) for session UUIDs
- [Transaction](/docs/languages/golang/api/core/transaction#id) for transaction UUIDs
- [Value types](/docs/languages/golang/concepts/value-types) for the full type mapping
