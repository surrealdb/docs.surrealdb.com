...
- [RecordID](/docs/languages/golang/api/values/record-id) for the record identifier type
- [CustomDateTime](/docs/languages/golang/api/values/datetime) for the datetime type
- [Value types](/docs/languages/golang/concepts/value-types) for the full type mapping
- [Data manipulation](/docs/languages/golang/concepts/data-manipulation) for using duration values in CRUD operations
