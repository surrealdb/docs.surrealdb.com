...
| `list` | `array` | |
| [`RecordID`](/docs/languages/python/api/values/record-id) | `record` | Table name + identifier |
| [`Table`](/docs/languages/python/api/values/table) | table reference | Table name wrapper |
| [`Duration`](/docs/languages/python/api/values/duration) | `duration` | Nanosecond precision |
| [`Datetime`](/docs/languages/python/api/values/datetime) | `datetime` | ISO 8601 string |
| [`Range`](/docs/languages/python/api/values/range) | `range` | Inclusive/exclusive bounds |
| [`Geometry*`](/docs/languages/python/api/values/geometry) | `geometry` | GeoJSON-compatible types |
...
- [`RecordID`](/docs/languages/python/api/values/record-id) — Record identifier with table name and ID components
- [`Table`](/docs/languages/python/api/values/table) — Table name wrapper for type-safe references
- [`Datetime`](/docs/languages/python/api/values/datetime) — Datetime wrapper for SurrealDB datetime values
- [`Duration`](/docs/languages/python/api/values/duration) — Duration with nanosecond precision and unit conversion
- [`Range`](/docs/languages/python/api/values/range) — Range type with inclusive and exclusive bounds
- [`Geometry`](/docs/languages/python/api/values/geometry) — GeoJSON-compatible geometry types for spatial data
