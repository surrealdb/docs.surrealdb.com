...
| `id` | [`Value`](/docs/languages/python/api/values/#value) | The identifier component of the record ID. |
...
Methods that accept a record or table reference use the `RecordIdType` alias, which accepts a plain string, a [`Table`](/docs/languages/python/api/values/table), or a `RecordID`.
