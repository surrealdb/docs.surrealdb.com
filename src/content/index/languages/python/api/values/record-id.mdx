...
| `id` | [`Value`](/docs/start/languages/python/api/values/#value) | The identifier component of the record ID. |
...
Methods that accept a record or table reference use the `RecordIdType` alias, which accepts a plain string, a [`Table`](/docs/start/languages/python/api/values/table), or a `RecordID`.

```python title="Type Definition"
RecordIdType = str | Table | RecordID
```

See the [Data Types overview](/docs/start/languages/python/api/values/#recordidtype) for details.

---

## See also

- [Data Types](/docs/start/languages/python/api/values) — All SDK data types
- [Table](/docs/start/languages/python/api/values/table) — Table name wrapper
