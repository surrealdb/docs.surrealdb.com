...
- [Error handling concept](/docs/languages/python/concepts/error-handling) for patterns and best practices
- [Surreal API reference](/docs/languages/python/api/core/surreal) for methods that may throw errors
- [Python types](/docs/languages/python/api/types/) for the `Value` and `Tokens` types
