...
<table>
	...
	<tbody>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/python/api/core/surreal#surreal"><code>Surreal(url)</code></a></td>
			<td scope="row" data-label="Description">Creates a synchronous connection based on the URL scheme</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/python/api/core/surreal#surreal"><code>AsyncSurreal(url)</code></a></td>
			<td scope="row" data-label="Description">Creates an asynchronous connection based on the URL scheme</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/python/api/core/surreal#connect"><code>db.connect(url?)</code></a></td>
			<td scope="row" data-label="Description">Opens the connection to the SurrealDB instance</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/python/api/core/surreal#close"><code>db.close()</code></a></td>
			<td scope="row" data-label="Description">Closes the active connection and releases resources</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/python/api/core/surreal#use"><code>db.use(namespace, database)</code></a></td>
			<td scope="row" data-label="Description">Switches to a specific namespace and database</td>
		</tr>
		<tr>
			<td scope="row" data-label="Method"><a href="/docs/start/languages/python/api/core/surreal#version"><code>db.version()</code></a></td>
...
The `.connect()` method optionally accepts a URL to override the one provided to the factory. See the [API reference](/docs/start/languages/python/api/core/surreal#connect) for parameter details.
...
WebSocket and HTTP are used to connect to remote SurrealDB instances, while the embedded protocols run the database engine directly in your Python process. See [Embedded databases](/docs/start/languages/python/concepts/embedded-databases) for more on in-process connections.
...
You can configure token and session durations using the `DURATION` clause in the [`DEFINE ACCESS METHOD`](/docs/reference/query-language/statements/define/access) or [`DEFINE USER`](/docs/reference/query-language/statements/define/user) statements.
...
- [Authentication](/docs/start/languages/python/concepts/authentication) for signing in and managing user sessions
- [Embedded databases](/docs/start/languages/python/concepts/embedded-databases) for running SurrealDB in-process
- [Error handling](/docs/start/languages/python/concepts/error-handling) for handling connection and authentication errors
