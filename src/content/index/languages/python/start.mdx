...
Follow the [installation guide](/docs/start/languages/python/installation) to install the SDK as a dependency in your project. Once installed, import the SDK to start using it.
...
<Boxes>
	...
	<IconBox
		...
		href="/docs/start/languages/python/concepts/authentication"
	/>
	<IconBox
		title="Data manipulation"
		description="Learn how to create, read, update, and delete records using the SDK."
		href="/docs/start/languages/python/concepts/data-manipulation"
	/>
	<IconBox
		title="API Reference"
