...
Follow the [installation guide](/docs/languages/python/installation) to install the SDK as a dependency in your project. Once installed, import the SDK to start using it.
