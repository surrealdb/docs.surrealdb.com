...
This approach is suitable for connecting to a SurrealDB instance as a [system user](/docs/learn/security/authentication/authentication#system-users), for example when connecting from a server-side application.
