...
The methods below are used to interact with the database and perform CRUD operations. You can also use the `query` method to run [SurrealQL statements](/docs/reference/query-language/statements/overview) against the database.
