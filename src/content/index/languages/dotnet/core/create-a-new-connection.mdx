...
After [installing the SDK](/docs/start/languages/dotnet/installation), you can initialize a new instance of a SurrealDB client.
...
> See the [Connection Strings](/docs/start/languages/dotnet/core/connection-strings) section for more information.
...
Learn more about the `.Use()` method [in the methods section](/docs/start/languages/dotnet/methods/use).
