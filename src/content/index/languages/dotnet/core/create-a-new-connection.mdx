...
After [installing the SDK](/docs/languages/dotnet/installation), you can initialize a new instance of a SurrealDB client.
...
> See the [Connection Strings](/docs/languages/dotnet/core/connection-strings) section for more information.
...
Learn more about the `.Use()` method [in the methods section](/docs/languages/dotnet/methods/use).
