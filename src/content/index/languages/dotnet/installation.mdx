...
The de facto initialization method is to create and [consume a SurrealDbClient created manually](/docs/languages/dotnet/core/create-a-new-connection).
Most .NET projects provide a way to configure services using [Dependency Injection](/docs/languages/dotnet/core/dependency-injection), which is the recommended way to use the SDK in your application.