...
Due to the [separation of the storage and compute](/docs/architecture) layers, SurrealDB can be run in embedded mode, from within a number of different language environments.
