...
Learn more about [Dependency Injection with SurrealDB in .NET](/docs/languages/dotnet/core/dependency-injection) in the SDK documentation.


Once the memory provider is configured, you can use the .NET SDK the same way you would with a remote database.
Please refer to the [.NET client SDK](/docs/languages/dotnet) documentation to get started with SurrealDB for .NET.
...
Please refer to the [.NET client SDK](/docs/languages/dotnet) documentation to get started.
