...
Now that you have learned the basics of the .NET SDK for SurrealDB, you can learn more about the SDK and its methods [in the methods section](/docs/languages/dotnet/methods) and [data types section](/docs/languages/dotnet/data-types).