...
| Storage backends | Available on SurrealMX, RocksDB, SurrealKV, TiKV and IndexedDB. A backend without a conflict-tracked read path rejects the clause rather than serving a read it cannot validate. |
