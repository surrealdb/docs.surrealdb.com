...
sidebar_position: 7
sidebar_label: Range
title: Golang | SDK | API Reference | Range
...
- [Table](/docs/sdk/golang/api/values/table) for the table name type used in `RecordRangeID`
- [Value types](/docs/sdk/golang/concepts/value-types) for the full type mapping
- [Data manipulation](/docs/sdk/golang/concepts/data-manipulation) for using ranges in queries
- [SurrealQL ranges](/docs/surrealql/datamodel/ids#record-ranges) for the underlying data model
