...
First, install the [SDK](https://pkg.go.dev/github.com/surrealdb/surrealdb.go) using the `go get` command:
...
- [Creating a new connection](/docs/sdk/golang/core/create-a-new-connection)
- [Authenticating users](/docs/sdk/golang/core/authenticating-users)
