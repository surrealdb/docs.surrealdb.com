...
like, err := surrealdb.Insert[Likes](db, models.Table("likes"), map[interface{}]interface{}{
...
likes, err := surrealdb.Insert[[]Likes](db, models.Table("likes"), []map[interface{}]interface{}{
	{
		"in":  models.NewRecordID("person", "tobie"),
		"out": models.NewRecordID("post", "123"),
	},
