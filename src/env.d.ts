...
declare module 'railroad-diagrams' {
  ...
  const mod: {
    ...
    MultipleChoice: new (index: number, mode: 'any' | 'all', ...children: unknown[]) => unknown;
    ...
    AlternatingSequence: new (option1: unknown, option2: unknown) => unknown;
    ZeroOrMore: new (child: unknown, repeat?: unknown, skip?: 'skip') => unknown;
    Group: new (child: unknown, label?: string) => unknown;
    Terminal: new (text: string, opts?: { href?: string; title?: string; cls?: string }) => unknown;
    NonTerminal: new (text: string, opts?: { href?: string; title?: string; cls?: string }) => unknown;
    Comment: new (text: string, opts?: { href?: string; title?: string; cls?: string }) => unknown;
    Start: new (opts?: { type?: 'simple' | 'complex'; label?: string }) => unknown;
