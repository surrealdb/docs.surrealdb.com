...
function buildLevel(
    ...
    for (const entry of entries) {
        ...
        const label = "sidebar_label" in entry.data ? entry.data.sidebar_label : entry.data.title;
        const position = "sidebar_position" in entry.data ? entry.data.sidebar_position : 0;
