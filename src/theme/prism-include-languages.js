...
export default function prismIncludeLanguages(PrismObject) {
  ...
  Prism.languages.surql = {
    ...
    variable: /[$][\w.]+/,
    function: /\b(?:fn|function|count|sleep|rand|(?:(array|crypto|duration|fn|geo|http|is|math|meta|parse|rand|search|session|sleep|string|time|type|vector)::[\w]+)(::[\w]+)?)(?=\s*\()/i,
