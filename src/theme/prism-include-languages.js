...
export default function prismIncludeLanguages(PrismObject) {
  ...
  Prism.languages.surql = {
    ...
    keyword: /\b(?:ACCESS|AFTER|ANALYZER|ASC|AS|ASSERT|BEFORE|BEGIN( TRANSACTION)?|BM25|BREAK|CANCEL( TRANSACTION)?|CAPACITY|COLUMNS|COMMENT|COMMIT( TRANSACTION)?|CONTENT|CREATE|CONTINUE|DATABASE|DB|DEFAULT|DEFINE|DELETE|DESC|DESCRIBE|DIFF|DIMENSION|DIST|DROP|EFC|ELSE|END|ES256|ES384|ES512|EUCLIDEAN|EVENT|EXISTS|EXPLAIN|FETCH|FIELD|FIELDS|FILTERS|FOR|FROM|FULL|FUNCTION|GROUP( BY)?|HIGHLIGHTS|HNSW|HS256|HS384|HS512|HSNW|IF|INDEX|INFO|INSERT(( IGNORE)? INTO)?|INTO|IN|KILL|LET|LIMIT( BY)?|LIVE|LOGIN|M|MERGE|MTREE|NAMESPACE|NOINDEX|NOT|NS|ON DUPLICATE KEY UPDATE|ON|ONLY|ORDER( BY)?|OUT|PASSHASH|PASSWORD|PERMISSIONS|PS256|PS384|PS512|REBUILD|RECORD|RELATE|REMOVE|REPLACE|RETURN|RS256|RS384|RS512|SCHEMAFULL|SCHEMALESS|SCOPE|SEARCH|SELECT|SESSION|SET|SIGNIN|SIGNUP|SPLIT( ON)?|START( AT)?|TABLE|TEMPFILES|THEN|THROW|TIMEOUT|TO|TOKEN|TOKENIZERS|TYPE|UNIQUE|UPDATE|USE|USER|VALUE|VALUES|VERSION|WITH|WHEN|WHERE)\b/,
