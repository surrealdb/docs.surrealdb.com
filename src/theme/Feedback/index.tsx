                ...
                <div className="feedbackform-container">
                    ...
                    >
                        <svg width="18" height="25" viewBox="0 0 18 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.3605 17.5625C16.1274 16.0272 18 13.076 18 9.6875C18 4.71694 13.9706 0.6875 9 0.6875C4.02944 0.6875 0 4.71694 0 9.6875C0 13.076 1.87265 16.0272 4.63949 17.5625H13.3605Z" fill="#24292F"/>
                            <rect x="4.5" y="18.6875" width="9" height="2.25" rx="0.5625" fill="#24292F"/>
                            <path d="M11.25 22.0625C11.25 23.3051 10.2426 24.3125 9 24.3125C7.75736 24.3125 6.75 23.3051 6.75 22.0625C6.75 22.0625 10.0074 22.0643 11.25 22.0643V22.0625Z" fill="#24292F"/>
                        </svg>
