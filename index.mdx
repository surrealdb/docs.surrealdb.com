...
After you have installed SurrealDB, you can start the database using the [`surreal start`](/docs/reference/cli/surrealdb-cli/commands/start) command provided by the [SurrealDB CLI](/docs/reference/cli/surrealdb-cli/overview).
