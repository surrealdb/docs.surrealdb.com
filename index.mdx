...
<div class="flex gap-4 pt-2 pb-2 flex-wrap">
	<IconLink
		href="/docs/languages/rust/setup"
		icon={{ light: LightRust, dark: DarkRust }}
	/>
	<IconLink
		href="/docs/languages/javascript/start"
		icon={{ light: LightJavascript, dark: DarkJavascript }}
	/>
	<IconLink
		href="/docs/languages/javascript/engines/node"
		icon={{ light: LightNodejs, dark: DarkNodejs }}
	/>
	<IconLink
		href="/docs/languages/javascript/engines/wasm"
	...
	/>
	<IconLink
		href="/docs/languages/golang/start"
	...
	/>
	<IconLink
		href="/docs/languages/dotnet/start"
		icon={{ light: LightDotnet, dark: DarkDotnet }}
	/>
	<IconLink
		href="/docs/languages/php/setup"
