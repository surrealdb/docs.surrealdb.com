...
SurrealDB uses [pre-defined parameters](/docs/surrealql/parameters) in its statements. Any parameters created with `LET` will be unaccessible during such statements.
