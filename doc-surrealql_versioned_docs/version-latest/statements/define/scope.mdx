...
:::note
<em> Warning: </em> This statement is deprecated in favor of `DEFINE ACCESS ... TYPE RECORD`. Learn more in the [DEFINE ACCESS](/docs/surrealdb/surrealql/statements/define/access).
:::
