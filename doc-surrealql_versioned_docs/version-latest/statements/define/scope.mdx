...
:::note
<em> Warning: </em> This statement is deprecated in favor of `DEFINE ACCESS ... TYPE RECORD`. Learn more in the [DEFINE ACCESS](/docs/surrealql/statements/define/access).
:::
