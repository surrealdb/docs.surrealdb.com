...
While [the ~ operator](/docs/surrealql/operators#matches) is a quick go-to to see if two strings are a fuzzy match, it returns a boolean that does not indicate relative similarity.
